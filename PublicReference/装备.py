...
class 装备21():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.技能冷却缩减(1,100,0.1)
        if 属性.职业名称 == '真龙星君' or 属性.职业名称 == '神龙天女':
...
class 装备261():
    ...
    def 城镇属性(self, 属性):
        ...
        pass
    def 进图属性(self, 属性):
        属性.物理攻击力 += 186 * 属性.获取改造(self.部位)
        属性.魔法攻击力 += 189 * 属性.获取改造(self.部位)
        属性.独立攻击力 += 115 * 属性.获取改造(self.部位)
        属性.力量 += 20 * 属性.获取改造(self.部位)
        属性.智力 += 20 * 属性.获取改造(self.部位)
        pass
...
class 装备267():
    ...
    def 城镇属性(self, 属性):
        ...
        pass
    def 进图属性(self, 属性):
        属性.物理攻击力 += 185 * 属性.获取改造(self.部位)
        属性.魔法攻击力 += 188 * 属性.获取改造(self.部位)
        属性.独立攻击力 += 115 * 属性.获取改造(self.部位)
        属性.力量 += 20 * 属性.获取改造(self.部位)
        属性.智力 += 20 * 属性.获取改造(self.部位)
        pass
