...
class 装备21():
    ...
    def 城镇属性(self, 属性):
        属性.百分比力智 += 0.34
        属性.伤害增加 += 0.2
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.34)
        属性.技能冷却缩减(1,100,0.1)
        if 属性.职业名称 in ['垂迹驱魔师', '真龙星君', '神龙天女']:
...
class 装备76():
    ...
    def 装备描述(self, 属性):
        ...
        temp += '力量 +' + str(self.力量[属性.防具类型]) + '<br>'
        temp += '智力 +' + str(self.智力[属性.防具类型]) + '<br>'
        temp += '伤害增加 +' + str(int(属性.技能栏空位 / 100)) + '%<br>'
        temp += '暴击伤害 +28%<br>'
        return temp      
...
class 装备105():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.04 - self.属性1选择 / 100)
        if 属性.职业名称 == '缔造者':
            属性.技能等级加成('所有', 50, 50, 2)
        else:
            属性.技能等级加成('所有', 45, 45, 2)
...
class 装备111():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.05 - self.属性4选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备181():
    ...
    def 城镇属性(self, 属性):
        属性.最终伤害 += 0.06
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.04 + 0.01 * min(13, 属性.获取强化(self.部位)))
        属性.所有属性强化(28)
        pass
    def 进图属性(self, 属性):
        属性.技能等级加成('所有', 1, 48, 1)
...
class 装备188():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.附加伤害 += 0.12
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.20 )
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.06  - self.属性2选择 / 100)
        属性.所有属性强化(25)
        pass
    def 进图属性(self, 属性):
        pass
...
class 装备194():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.最终伤害 += 0.23
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.03 - self.属性1选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备236():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.10 )
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.04 - self.属性3选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备237():
    ...
    def 城镇属性(self, 属性):
        ...
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.04 - self.属性2选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备246():
    ...
    def 城镇属性(self, 属性):
        ...
        if 属性.获取改造(self.部位) >= 4:
            if 属性.先知者的预言 == 0:
                属性.属性附加 += 0.05 * 0.35
                属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0 + (0.10 * 0.35 + 0.15 * 0.3))
            if 属性.先知者的预言 == 1:
                属性.属性附加 += 0.05
            if 属性.先知者的预言 == 2:
                属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.10)
...
class 原初之梦武器():
    ...
    def 装备描述(self, 属性):
        ...
        if 改造等级 > 0:
            ...
            temp += '魔法攻击力 +' + str(self.物攻成长 * 改造等级) + '<br>'
...
class 装备253():
    ...
    类型 = '布甲'
    def 城镇属性(self, 属性):
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.0 + 0.04 * 属性.获取改造(self.部位))
        if 属性.获取改造(self.部位) >= 1:
            属性.技能倍率加成(50, 0.30)
            属性.技能倍率加成(85, 0.25)
            属性.技能倍率加成(100, 0.16)
...
class 装备362():
    ...
    def 进图属性(self, 属性):
        属性.力量 += 25 * 属性.获取改造(self.部位)
        属性.智力 += 25 * 属性.获取改造(self.部位)
        属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.02 * 属性.获取改造(self.部位))
        pass
    def 其它属性(self, 属性):
        pass
    def 装备描述(self, 属性):
...
class 装备429():
    ...
    品质 = '史诗'
    部位 = '头肩'
    力量 = {'布甲':83, '皮甲':117, '轻甲':124, '重甲':120, '板甲':117}	
    智力 = {'布甲':123, '皮甲':116, '轻甲':110, '重甲':110, '板甲':116}
    类型 = '重甲'
    def 城镇属性(self, 属性):
        属性.物理攻击力 += 116
        属性.魔法攻击力 += 116
...
class 装备440():
    ...
    品质 = '史诗'
    部位 = '上衣'
    力量 = {'布甲':93, '皮甲':136, '轻甲':144, '重甲':139, '板甲':136}	
    智力 = {'布甲':145, '皮甲':137, '轻甲':128, '重甲':128, '板甲':137}
    类型 = '轻甲'
    def 城镇属性(self, 属性):
        属性.物理攻击力 += 149
        属性.魔法攻击力 += 149
...
class 装备452():
    ...
    品质 = '史诗'
    部位 = '上衣'
    力量 = {'布甲':49, '皮甲':92, '轻甲':100, '重甲':95, '板甲':92}	
    智力 = {'布甲':100, '皮甲':92, '轻甲':83, '重甲':83, '板甲':92}
    类型 = '皮甲'
    def 城镇属性(self, 属性):
...
class 套装效果2():
    ...
    def 城镇属性(self, 属性):
        属性.百分比三攻 += 0.22
        if 属性.贫瘠沙漠的遗产 != 0:
            属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0 + 属性.技能栏空位 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 套装效果75():
    ...
    def 城镇属性(self, 属性):
        if 属性.幸运三角 == 0:
            属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.2915)
        if 属性.幸运三角 == 1:
            属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.27)
        if 属性.幸运三角 == 2:
            属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.31)
        if 属性.幸运三角 == 3:
            属性.技能攻击力 *= 1 + 属性.技能攻击力倍率 * (0.34)
