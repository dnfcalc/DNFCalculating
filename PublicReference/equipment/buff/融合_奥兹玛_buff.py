...
def Astaroth(self):
    return BUFF增加(self, BUFF三攻per=1.01)+觉醒增加(self, 一觉力智=22) + 被动增加(self, 守护恩赐体精=55, 转职被动智力=55)
...
def Redmayne(self):
    return BUFF增加(self,BUFF力智per=1.02)+觉醒增加(self,一觉力智=25)+被动增加(self,守护恩赐体精=46, 转职被动智力=46)
