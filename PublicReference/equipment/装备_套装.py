...
class 套装效果26(套装):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFFLv=2)
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.09)
...
class 套装效果32(套装):
    ...
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.BUFF增加(BUFFLv=2)
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.14)
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.14)
        self.属性描述 += 属性.被动增加(一觉被动Lv=2)
        self.属性描述 += 属性.觉醒增加(一觉Lv=2)
...
class 套装效果68(套装):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=171)
        self.属性描述 += 属性.被动增加(转职被动智力=158)
        self.属性描述 += 属性.BUFF增加(BUFFLv=1)
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.1)
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.1)
        self.属性描述 += 属性.觉醒增加(一觉Lv=1)
...
class 套装效果86(套装):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.23)
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.23)
...
class 套装效果100(套装):
    ...
    def BUFF属性(self, 属性):
        if 属性.装备检查('黑暗幽灵紫杉胸甲'):
            self.属性描述 += 属性.被动增加(一觉被动Lv=2)
            self.属性描述 += 属性.BUFF增加(BUFF力量per=1.22)
            self.属性描述 += 属性.BUFF增加(BUFF智力per=1.22)
