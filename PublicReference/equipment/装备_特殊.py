...
class 装备237(装备):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.11 - self.属性3选择_BUFF /
                               100, BUFF智力per=1.11 - self.属性3选择_BUFF / 100)
...
class 装备239(装备):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.被动增加(守护恩赐体精=176)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.BUFF增加(BUFF物攻per=1.12 - self.属性1选择_BUFF / 100, BUFF魔攻per=1.12 -
                               self.属性1选择_BUFF / 100, BUFF独立per=1.12 - self.属性1选择_BUFF / 100)
...
class 装备240(装备):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.12 - self.属性1选择_BUFF /
                               100, BUFF智力per=1.12 - self.属性1选择_BUFF / 100)
...
class 装备242(装备):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.04 - self.属性3选择_BUFF /
                               100, BUFF智力per=1.04 - self.属性3选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF物攻per=1.07 - self.属性4选择_BUFF / 100, BUFF魔攻per=1.07 -
                               self.属性4选择_BUFF / 100, BUFF独立per=1.07 - self.属性4选择_BUFF / 100)
...
class 装备243(装备):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.BUFF增加(BUFF物攻per=1.05 - self.属性1选择_BUFF / 100, BUFF魔攻per=1.05 -
                               self.属性1选择_BUFF / 100, BUFF独立per=1.05 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.10 - self.属性2选择_BUFF /
                               100, BUFF智力per=1.10 - self.属性2选择_BUFF / 100)
...
class 装备248(装备):
    ...
    def 产物升级(self, 属性):
        ...
        if 改造等级 >= 6:
            self.属性描述 += 属性.技能攻击力加成((self.属性2范围[0] -
                                    self.属性2选择*self.属性2范围[2])/100)
        if 改造等级 >= 7:
            self.属性描述 += 属性.伤害增加加成((self.属性3范围[0] -
                                   self.属性3选择*self.属性3范围[2])/100)
    ...
    def 产物升级(self, 属性):
        ...
        if 改造等级 >= 6:
            self.属性描述 += 属性.技能攻击力加成((self.属性2范围[0] -
                                    self.属性2选择*self.属性2范围[2])/100)
        if 改造等级 >= 7:
            self.属性描述 += 属性.暴击伤害加成((self.属性3范围[0] -
                                   self.属性3选择*self.属性3范围[2])/100)
...
class 装备531(装备):
    ...
    def 产物升级(self, 属性):
        ...
        if 改造等级 >= 6:
            self.属性描述 += 属性.技能攻击力加成((self.属性2范围[0] -
                                    self.属性2选择*self.属性2范围[2])/100)
        if 改造等级 >= 7:
            self.属性描述 += 属性.百分比三攻加成((self.属性3范围[0] -
                                    self.属性3选择*self.属性3范围[2])/100)
    ...
    def BUFF属性(self, 属性):
        if 属性.获取改造(self.部位) >= 1:
            self.属性描述 += '<font color="#FF8200">改造属性(+' + str(
                属性.获取改造(self.部位)) + ')：</font><br>'
            self.属性描述 += 属性.BUFF增加(BUFF魔攻per=1.06)
    ...
    def 产物升级(self, 属性):
        ...
        if 改造等级 >= 6:
            self.属性描述 += 属性.技能攻击力加成((self.属性2范围[0] -
                                    self.属性2选择*self.属性2范围[2])/100)
        if 改造等级 >= 7:
            self.属性描述 += 属性.附加伤害加成((self.属性3范围[0] -
                                   self.属性3选择*self.属性3范围[2])/100)
