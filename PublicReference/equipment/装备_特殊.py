...
class 装备228(装备):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=158)
        self.属性描述 += 属性.被动增加(转职被动智力=62)
...
class 装备229(装备):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=143)
        self.属性描述 += 属性.被动增加(转职被动智力=49)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
class 装备230(装备):
    名称 = '宽容之海'
    模式 = 0
...
class 装备236(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.附加伤害加成(0.04 - self.属性1选择 / 100)
        self.属性描述 += 属性.百分比三攻加成(0.09 - self.属性2选择 / 100)
        self.属性描述 += 属性.技能攻击力加成(0.04 - self.属性3选择 / 100)
        self.属性描述 += 属性.最终伤害加成(0.07 - self.属性4选择 / 100)   
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=318 - self.属性3选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(信念光环体精=220 - self.属性1选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(转职被动智力=222 - self.属性3选择_BUFF * 20)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
...
class 装备237(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.暴击伤害加成(0.24)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.百分比三攻加成(0.06 - self.属性1选择 / 100)
        self.属性描述 += 属性.技能攻击力加成(0.04 - self.属性2选择 / 100)
        self.属性描述 += 属性.附加伤害加成(0.08 - self.属性3选择 / 100)
        self.属性描述 += 属性.百分比力智加成(0.05 - self.属性4选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=343 - self.属性2选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(转职被动智力=249 - self.属性2选择_BUFF * 20)
...
class 装备238(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.最终伤害加成(0.08 - self.属性2选择 / 100)
        self.属性描述 += 属性.百分比力智加成(0.05 - self.属性3选择 / 100)
        self.属性描述 += 属性.伤害增加加成(0.04 - self.属性4选择 / 100)      
        pass
    def 进图属性(self, 属性):
        self.属性描述 += 属性.所有属性强化加成(40)
        pass
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=443 - self.属性3选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(信念光环体精=160 - self.属性4选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(转职被动智力=362 - self.属性3选择_BUFF * 20)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
...
class 装备239(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        if 属性.装备检查('能量回流控制者'):
            ...
            self.属性描述 += 属性.附加伤害加成(0.1)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.伤害增加加成(0.12 - self.属性1选择 / 100)
        self.属性描述 += 属性.力智固定加成(x=220 - self.属性2选择 * 20)
        self.属性描述 += 属性.附加伤害加成(0.12 - self.属性3选择 / 100)
        pass
    def 进图属性(self, 属性):
        if 属性.装备检查('电光能量支配者'):
            self.属性描述 += '<font color="#00A2E8">装备电光能量支配者时</font><br>'
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.被动增加(守护恩赐体精=378 - self.属性2选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(转职被动智力=62)
        self.属性描述 += 属性.BUFF增加(BUFF物攻per=1.12 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF魔攻per=1.12 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.12 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
...
class 装备240(装备):
    ...
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.最终伤害加成(0.42)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.最终伤害加成(0.12 - self.属性1选择 / 100)
        self.属性描述 += 属性.所有属性强化加成(40 - self.属性2选择 * 4)
        self.属性描述 += 属性.附加伤害加成(0.09  - self.属性3选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=432 - self.属性2选择_BUFF * 20)
        self.属性描述 += 属性.被动增加(转职被动智力=335 - self.属性2选择_BUFF * 20)
        self.属性描述 += 属性.BUFF增加(BUFF力量per=1.12 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.12 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
...
class 装备241(装备):
    ...
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.最终伤害加成(0.19)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.力智固定加成(x=300 - self.属性1选择 * 20)
        self.属性描述 += 属性.暴击伤害加成(0.21 - self.属性2选择 / 100)
        self.属性描述 += 属性.技能等级加成('所有', 60, 100 - self.属性3选择 * 5, 1)
        pass
    def 进图属性(self, 属性):
        self.属性描述 += 属性.技能等级加成('所有', 50, 50, 1)
        self.属性描述 += 属性.技能等级加成('所有', 85, 85, 1)
    ...
    def 城镇属性_BUFF(self, 属性):
        self.属性描述 += 属性.技能等级加成('所有', 60, 100, 1)
        pass
    def 进图属性_BUFF(self, 属性):
        self.属性描述 += 属性.技能等级加成('所有', 50, 50, 1)
        self.属性描述 += 属性.技能等级加成('所有', 85, 85, 1)
        ...
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=478 - self.属性1选择_BUFF * 20)
...
class 装备242(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        if '天命无常[2]' in 属性.套装栏:
            ...
            if 属性.天命无常 == 6:
                self.属性描述 += 属性.最终伤害加成(0.30)        
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.三攻固定加成(x=120 - self.属性1选择 * 10)
        self.属性描述 += 属性.技能等级加成('所有', 25, 45 - self.属性2选择 * 5, 1)
        self.属性描述 += 属性.百分比力智加成(0.04 - self.属性3选择 / 100)
        self.属性描述 += 属性.附加伤害加成(0.07 - self.属性4选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
    ...
    def BUFF属性(self, 属性):
        ...
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.04 - self.属性3选择_BUFF / 100)
...
class 装备243(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.伤害增加加成(0.15)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.所有属性强化加成(16 - self.属性1选择 * 4)
        self.属性描述 += 属性.持续伤害加成(0.1 - self.属性2选择 / 100)
        self.属性描述 += 属性.暴击伤害加成(0.18 - self.属性3选择 / 100)
        self.属性描述 += 属性.力智固定加成(x=140 - self.属性4选择 * 20)
    ...
    def 进图属性_BUFF(self, 属性):
        pass
    def BUFF属性(self, 属性):
        self.属性描述 += 属性.被动增加(守护恩赐体精=306 - self.属性4选择_BUFF * 20)
        ...
        self.属性描述 += 属性.BUFF增加(BUFF智力per=1.10 - self.属性2选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF魔攻per=1.05 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.05 - self.属性1选择_BUFF / 100)
        self.属性描述 += 属性.BUFF增加(BUFF独立per=1.06)
