...
class 装备12(装备):
    ...
    独立攻击力 = 770
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.百分比力智加成(0.27)
        self.属性描述 += 属性.伤害增加加成(0.2)
        self.属性描述 += 属性.暴击伤害加成(0.2)
        self.属性描述 += 属性.技能攻击力加成(0.3)
...
class 装备30(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.单技能等级加成('千魂弑',2)
        self.属性描述 += 属性.单技能等级加成('血战天狱',2)
        self.属性描述 += 属性.技能等级加成('所有',100,100,2)
        pass
    def 进图属性(self, 属性):
        pass
...
class 装备67(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.技能等级加成('所有',1,48,2)
        self.属性描述 += 属性.技能等级加成('所有',60,80,2)
        self.属性描述 += 属性.技能冷却缩减(1,48,0.19)
        self.属性描述 += 属性.技能冷却缩减(60,80,0.19)
        self.属性描述 += 属性.技能冷却缩减(90,95,0.19)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备70(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.单技能等级加成('电光飞掠',2)
        self.属性描述 += 属性.单技能等级加成('集结·暮光之翼',2)
        self.属性描述 += 属性.技能等级加成('所有',100,100,2)
        pass
    def 进图属性(self, 属性):
        pass
