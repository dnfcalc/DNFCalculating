...
增幅系数_HF = [0, 1, 2, 3, 4, 6, 8, 10, 22, 28, 35, 42, 52, 69, 108, 150, 192, 267, 342, 417, 500, 583, 667, 750, 833, 917, 1000, 1083, 1167, 1250, 1333, 1417]
...
def 增幅计算(装备等级, 品质, 强化等级,版本='GF'): 
    if 版本 == 'GF':
        ...
        return int((装备等级 + 增幅品级加分[品质]) * 增幅成长系数[品质] * 增幅系数_HF[强化等级] / 100 - 0.00000001) + 增幅品级底数_HF[品质]
