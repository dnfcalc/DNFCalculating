...
class 装备197(装备):
    ...
    独立攻击力 = 0
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.百分比力智加成(0.04  + 0.01 * min(13, 属性.获取强化(self.部位)))
...
class 装备205(装备):
    ...
    独立攻击力 = 0
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.伤害增加加成(0.04  + 0.01 * min(13, 属性.获取强化(self.部位)))
