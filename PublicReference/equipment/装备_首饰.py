...
class 装备188(装备):
    ...
    def 城镇属性(self, 属性):
        self.属性描述 += 属性.百分比力智加成(0.06 - self.属性4选择 / 100)
        self.属性描述 += 属性.百分比三攻加成(0.03 - self.属性1选择 / 100)
        self.属性描述 += 属性.暴击伤害加成(0.09 - self.属性3选择 / 100)
        self.属性描述 += 属性.附加伤害加成(0.06)
        self.属性描述 += 属性.技能攻击力加成(0.25)
        self.属性描述 += 属性.技能攻击力加成(0.06  - self.属性2选择 / 100)
        self.属性描述 += 属性.所有属性强化加成(25)
        pass
    def 进图属性(self, 属性):
        pass
...
class 装备189(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.技能攻击力加成(0.05 + 0.01 * min(13, 属性.获取强化(self.部位)))
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.三攻固定加成(x=110 - self.属性1选择 * 10)
        self.属性描述 += 属性.伤害增加加成(0.11 - self.属性3选择 / 100)
...
class 装备190(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.百分比力智加成(0.07)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.暴击伤害加成(0.04 - self.属性1选择 / 100)
        self.属性描述 += 属性.百分比力智加成(0.1 - self.属性2选择 / 100)
        self.属性描述 += 属性.伤害增加加成(0.03 - self.属性3选择 / 100)
        self.属性描述 += 属性.百分比三攻加成(0.08 - self.属性4选择 / 100)       
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备191(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.力智固定加成(x=160 - self.属性1选择 * 20)
        self.属性描述 += 属性.最终伤害加成(0.12 - self.属性2选择 / 100)
...
class 装备193(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.百分比力智加成(0.04 - self.属性1选择 / 100)
        self.属性描述 += 属性.所有属性强化加成(20 - self.属性2选择 * 4)
        self.属性描述 += 属性.三攻固定加成(100 - self.属性3选择 * 10)
        self.属性描述 += 属性.最终伤害加成(0.08 - self.属性4选择 / 100)  
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备194(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.技能攻击力加成(0.03 - self.属性1选择 / 100)
        self.属性描述 += 属性.附加伤害加成(0.04 - self.属性2选择 / 100)
        self.属性描述 += 属性.百分比力智加成(0.07 - self.属性3选择 / 100)
        self.属性描述 += 属性.百分比三攻加成(0.12 - self.属性4选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
...
class 装备195(装备):
    ...
    def 城镇属性(self, 属性):
        ...
        self.属性描述 += 属性.技能攻击力加成(0.11)
        self.属性描述 += '<font color="#00A2E8">神话属性：</font><br>'
        self.属性描述 += 属性.伤害增加加成(0.1 - self.属性1选择 / 100)
        self.属性描述 += 属性.所有属性强化加成(32 - self.属性2选择 * 4)
        self.属性描述 += 属性.暴击伤害加成(0.12 - self.属性3选择 / 100)
        pass
    def 进图属性(self, 属性):
        pass
    def 其它属性(self, 属性):
