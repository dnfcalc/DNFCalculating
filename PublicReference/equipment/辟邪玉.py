...
class 辟邪玉1(辟邪玉):
    名称 = '附加伤害增加增幅'
    def 穿戴属性(self, 属性):
        属性.附加伤害增加增幅 += self.当前值 / 100

class 辟邪玉2(辟邪玉):
    名称 = '属性附加伤害增加增幅'
    def 穿戴属性(self, 属性):
        属性.属性附加伤害增加增幅 += self.当前值 / 100
...
class 辟邪玉3(辟邪玉):
    ...
    最大值 = 3
    def 穿戴属性(self, 属性):
        属性.技能伤害增加增幅 += self.当前值 / 100

class 辟邪玉4(辟邪玉):
    名称 = '暴击伤害增加增幅'
    def 穿戴属性(self, 属性):
        属性.暴击伤害增加增幅 += self.当前值 / 100

class 辟邪玉5(辟邪玉):
    名称 = '伤害增加增幅'
    def 穿戴属性(self, 属性):
        属性.伤害增加增幅 += self.当前值 / 100

class 辟邪玉6(辟邪玉):
    名称 = '最终伤害增加增幅'
    def 穿戴属性(self, 属性):
        属性.最终伤害增加增幅 += self.当前值 / 100

class 辟邪玉7(辟邪玉):
    名称 = '力量智力增加增幅'
    def 穿戴属性(self, 属性):
        属性.力量智力增加增幅 += self.当前值 / 100

class 辟邪玉8(辟邪玉):
    名称 = '物理魔法攻击力增加增幅'
    def 穿戴属性(self, 属性):
        属性.物理魔法攻击力增加增幅 += self.当前值 / 100

class 辟邪玉9(辟邪玉):
    名称 = '装备属性强化增加'
    def 穿戴属性(self, 属性):
        属性.所有属性强化增加 += self.当前值 / 100
