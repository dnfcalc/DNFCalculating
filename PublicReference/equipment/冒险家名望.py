...
附魔名望 = {0:0, 1: 56, 2: 69, 3: 86, 4: 106, 5: 130, 6: 138, 7: 147, 8: 158, 100: 139, 101: 153, 102: 168, 103: 185}
...
# 100级，史诗
装备强化名望 = [0, 3, 5, 8, 10, 12, 15, 17, 29, 32, 45, 89, 142, 154, 166, 178, 190, 202, 213, 225, 237, 249, 261, 273, 284,
          296,
          308, 320, 332, 344, 355, 367]
装备增幅名望 = [0, 3, 6, 8, 11, 14, 16, 19, 32, 36, 50, 99, 158, 171, 185, 198, 211, 224, 237, 250, 263, 276, 289, 302, 315,
          328,
          341, 354, 369, 382, 395, 408]

装备改造名望 = [0, 11, 16, 32, 50, 158, 185, 211, 237, 263, 277, 290, 303, 316, 329, 342, 355, 369, 382, 395, 408, 408, 408,
          408,
          408, 408, 408, 408, 408, 408, 408, 408]
武器改造名望 = [0, 33, 50, 99, 156, 492, 574, 656, 738, 820, 861, 902, 943, 984, 1025, 1066, 1107, 1148, 1189, 1230, 1271,
          1271,
          1271, 1271, 1271, 1271, 1271, 1271, 1271, 1271, 1271, 1271]
神话装备强化名望 = [0, 3, 6, 9, 12, 15, 18, 21, 36, 40, 57, 111, 178, 193, 208, 222, 237, 252, 267, 282, 296, 311, 326, 341,
            355,
            370, 385, 400, 415, 429, 444, 459]
神话装备增幅名望 = [0, 4, 7, 10, 14, 17, 20, 24, 40, 45, 63, 123, 198, 214, 231, 247, 263, 280, 296, 313, 329, 346, 362, 378,
            395,
            411, 428, 444, 461, 477, 493, 510]
武器强化名望 = [0, 8, 15, 23, 30, 37, 45, 52, 89, 100, 141, 276, 443, 480, 517, 554, 591, 628, 664, 701, 738, 775, 812, 849,
          886,
          923, 960, 996, 1033, 1070, 1107, 1144]
武器增幅名望 = [0, 9, 17, 25, 33, 41, 50, 58, 99, 111, 156, 307, 492, 533, 574, 615, 656, 697, 738, 779, 820, 861, 902, 943,
          984,
...
def 希洛克融合名望计算(人物设置):
    ...
    希洛克融合名望 = {"残香名望": 残香名望, "下装": 116 * 下装希洛克, "辅助装备": 116 * 左槽希洛克, "戒指": 116 * 戒指希洛克}
    return 希洛克融合名望
...
def 奥兹玛融合名望计算(人物设置):
    ...
    return {"头肩": 头肩 * 116, "腰带": 腰带 * 116, "鞋": 鞋 * 116, "项链": 项链 * 116, "魔法石": 魔法石 * 116}
