...
宠物表 = {"火神的化身": 111, "骑士/精灵使": 107, "比拉谢尔号": 106, "夏日之恋莱森德": 5, "夏日之恋赫米雅": 5, "暴风圣女": 110, "神迹·莱恩": 108, "神官": 106,
       "莱恩": 102, "蒂雅": 100, "克里斯": 5, "关羽": 1, "墨仙雪莲": 1}

# 100级，史诗
强化名望 = [3, 5, 8, 10, 12, 15, 17, 29, 32, 45, 89, 142, 154, 166, 178, 190, 202, 213, 225, 237, 249, 261, 273, 284, 296,
...
def 宠物名望计算(角色属性):
    细节 = 细节收集(角色属性.细节选项输入, "宠物附魔")
    l = sum(len(_) for _ in 细节)
