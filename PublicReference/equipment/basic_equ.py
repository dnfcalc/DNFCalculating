...
class 装备:
    ...
    def 装备描述(self, 属性):
        ...
        self.属性描述 += ('{} +{}<br>'.format(trans('物理攻击力'),self.物理攻击力)) if self.物理攻击力 > 0 else ''
        self.属性描述 += ('{} +{}<br>'.format(trans('魔法攻击力'),self.魔法攻击力)) if self.魔法攻击力 > 0 else ''
        self.属性描述 += ('{} +{}<br>'.format(trans('独立攻击力'),self.独立攻击力)) if self.独立攻击力 > 0 else ''
