...
class 角色窗口(QWidget):
    ...
    def 界面2(self):
        ...
        temp += '<font color="#B99460">注：暗抗触发词条不享受加成<br>幸运三角套装技攻不享受加成<br><br>属白增幅分对应属性，计算器未作区分<br>双属性附加(星之海)需手动计算并在第三页修正<br><br>计算方式仅供参考，请以实际游戏为准！</font></font>'
