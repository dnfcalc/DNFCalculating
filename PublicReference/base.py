...
class 角色属性():
    ...
    def 持续伤害加成(self, x ):
        if self.装备描述 == 1:
            return '持续伤害 +{}%<br>'.format(int(x*100))
        else:
             self.持续伤害 += x 
        return ''
    ...
    def 百分比力智加成(self, x):
        if self.装备描述 ==1:
            return '力量、智力 +{}%<br>'.format(int(x*100))
        else:
    ...
    def 攻击速度增加(self,x):
        if self.装备描述 ==1:
            return '攻击速度 {}%<br>'.format(("+" if x > 0 else '')+str(int(x*100)))
        else:
            self.攻击速度 += x
        return ''
    ...
    def 移动速度增加(self,x):
        if self.装备描述 ==1:
            return '移动速度 {}%<br>'.format(("+" if x > 0 else '')+str(int(x*100)))
        else:
            self.移动速度 += x
        return ''
    ...
    def 释放速度增加(self,x):
        if self.装备描述 ==1:
            return '释放速度 {}%<br>'.format(("+" if x > 0 else '')+str(int(x*100)))
        else:
            self.释放速度 += x
        return ''
