...
def make_watermark_qt_color_string(watermark_surrounding_backgroud_color: tuple):
    color_str = ', '.join((str(rgb + watermark_delta) for rgb in watermark_surrounding_backgroud_color))
