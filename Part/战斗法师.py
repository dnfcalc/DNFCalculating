...
while i >= 0:
    try:
        exec('战斗法师技能列表.append(战斗法师技能'+str(i)+'())')
        i += 1
    except:
        i = -1

战斗法师技能序号 = dict()
for i in range(len(战斗法师技能列表)):
    战斗法师技能序号[战斗法师技能列表[i].名称] = i
...
for i in 战斗法师技能列表:
    if i.所在等级 == 85:
        战斗法师二觉序号 = 战斗法师技能序号[i.名称]
    if i.所在等级 == 100:
        战斗法师三觉序号 = 战斗法师技能序号[i.名称]

战斗法师护石选项 = ['无']
for i in 战斗法师技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        战斗法师护石选项.append(i.名称)

战斗法师符文选项 = ['无']
for i in 战斗法师技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        战斗法师符文选项.append(i.名称)
...
class 战斗法师角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(战斗法师技能列表)
        self.技能序号= deepcopy(战斗法师技能序号)
...
class 战斗法师(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 战斗法师二觉序号
        self.三觉序号 = 战斗法师三觉序号
        self.护石选项 = deepcopy(战斗法师护石选项)
        self.符文选项 = deepcopy(战斗法师符文选项)

    def 界面(self):
        super().界面()
        self.碎霸概率=MyQComboBox(self.main_frame2)
        self.碎霸概率.resize(130,20)
        self.碎霸概率.move(310,450)
        for i in range(11):
