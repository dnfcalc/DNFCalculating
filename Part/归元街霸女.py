...
class 归元街霸女技能9(归元街霸女主动技能):
    ...
    成长 = 51.5135135135135
    攻击次数 = 1.6 #异常倍率
    涂毒基础 = 44.8648648648649 * 1.6 #异常倍率
    涂毒成长 = 5.13513513513514 * 1.6 #异常倍率
    倍率 = 1.05  #三觉加强
    CD = 15.0
    TP上限 = 5
    TP成长 = 0.845
...
class 归元街霸女角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(归元街霸女技能列表)
        self.技能序号= deepcopy(归元街霸女技能序号)
...
class 归元街霸女(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 归元街霸女二觉序号
        self.三觉序号 = 归元街霸女三觉序号
        self.护石选项 = deepcopy(归元街霸女护石选项)
        self.符文选项 = deepcopy(归元街霸女符文选项)
    ...
    def 输入属性(self, 属性, x = 0):
        ...
        属性.技能栏[属性.技能序号['死亡毒雾']].涂毒基础 *= self.毒雾爆炸段数选择.currentIndex()
        属性.技能栏[属性.技能序号['死亡毒雾']].涂毒成长 *= self.毒雾爆炸段数选择.currentIndex()

        属性.技能栏[属性.技能序号['死亡毒雾']].中毒基础 *= self.毒雾中毒次数选择.currentIndex()
        属性.技能栏[属性.技能序号['死亡毒雾']].中毒成长 *= self.毒雾中毒次数选择.currentIndex()