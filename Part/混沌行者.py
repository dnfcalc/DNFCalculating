...
class 混沌行者技能7(混沌行者主动技能):
    名称 = '次元坠落'
    所在等级 = 15
    等级上限 = 60
    基础等级 = 1
    # 基础伤害
    数据1 = [0, 392, 432, 472, 512, 551, 591, 631, 671, 711, 750, 790, 830, 870, 910, 950, 989, 1029, 1069, 1109, 1149,
    ...
    数据2 = [0, 1333, 1468, 1603, 1739, 1874, 2009, 2144, 2280, 2415, 2550, 2685, 2821, 2956, 3091, 3226, 3362, 3497,
    ...
    攻击次数2 = 1
    # 30%概率触发箱子，额外伤害
    数据3 = [0, 1680, 1850, 2021, 2191, 2362, 2532, 2703, 2873, 3044, 3214, 3384, 3555, 3725, 3896, 4066, 4237, 4407,
...
class 混沌行者技能9(混沌行者主动技能):
    名称 = '次元虚影'
    所在等级 = 20
    等级上限 = 60
    基础等级 = 1
    数据1 = [0, 2639, 2907, 3175, 3443, 3711, 3978, 4246, 4514, 4782, 5050, 5318, 5585, 5853, 6121, 6389, 6657, 6924, 7192,
...
class 混沌行者技能10(混沌行者主动技能):
    ...
    等级上限 = 60
    基础等级 = 5
    数据1 = [0, 812, 894, 976, 1059, 1142, 1223, 1306, 1388, 1470, 1553, 1635, 1718, 1800, 1882, 1965, 2048, 2129, 2212,
...
class 混沌行者技能11(混沌行者主动技能):
    名称 = '次元离子束'
    所在等级 = 25
    等级上限 = 60
    基础等级 = 41
    # 不强化
    数据1 = [0, 588, 647, 707, 767, 826, 886, 946, 1005, 1065, 1125, 1184, 1244, 1304, 1363, 1423, 1483, 1542, 1602, 1662,
    ...
    攻击次数1 = 6
    # 强化
    数据2 = [0, 4569, 5032, 5496, 5960, 6423, 6887, 7350, 7814, 8277, 8741, 9204, 9668, 10132, 10595, 11059, 11522, 11986,
...
class 混沌行者技能12(混沌行者主动技能):
    名称 = '次元万花镜'
    所在等级 = 30
    等级上限 = 60
    基础等级 = 38
    # 不强化
    数据1 = [0, 1799, 1982, 2164, 2347, 2530, 2712, 2895, 3077, 3260, 3443, 3625, 3808, 3990, 4173, 4355, 4538, 4721, 4903,
    ...
    攻击次数1 = 4
    # 强化
    数据2 = [0, 1444, 1591, 1738, 1884, 2031, 2177, 2324, 2470, 2617, 2764, 2910, 3057, 3203, 3350, 3497, 3643, 3790,
...
class 混沌行者技能13(混沌行者主动技能):
    名称 = '乖离魅魔之舞'
    所在等级 = 30
    等级上限 = 60
    基础等级 = 38
    # 不强化
    数据1 = [0, 190, 209, 228, 248, 267, 286, 306, 325, 344, 364, 383, 402, 422, 441, 460, 480, 499, 518, 537, 557, 576,
    ...
    数据2 = [0, 3238, 3566, 3895, 4224, 4552, 4881, 5209, 5538, 5866, 6195, 6523, 6852, 7180, 7509, 7837, 8166, 8494,
...
class 混沌行者技能14(混沌行者主动技能):
    名称 = '次元粒子风暴'
    所在等级 = 35
    等级上限 = 60
    基础等级 = 36
    # 不强化
    数据1 = [0, 2576, 2837, 3098, 3360, 3621, 3882, 4144, 4405, 4666, 4928, 5189, 5450, 5712, 5973, 6234, 6496, 6757, 7018,
    ...
    攻击次数1 = 3
    # 强化
    数据2 = [0, 9864, 10865, 11866, 12866, 13867, 14868, 15869, 16869, 17870, 18871, 19872, 20872, 21873, 22874, 23875,
...
class 混沌行者技能15(混沌行者主动技能):
    名称 = '次元时空磁场'
    所在等级 = 35
    等级上限 = 60
    基础等级 = 36
    数据1 = [0, 3442, 3792, 4141, 4490, 4840, 5189, 5538, 5887, 6237, 6586, 6935, 7285, 7634, 7983, 8332, 8682, 9031, 9380,
...
class 混沌行者技能16(混沌行者主动技能):
    名称 = '乖离异界蜂群'
    所在等级 = 40
    等级上限 = 60
    基础等级 = 33
    # 20 + 6
    数据1 = [0, 712, 785, 857, 929, 1002, 1074, 1146, 1219, 1291, 1363, 1436, 1508, 1580, 1653, 1725, 1797, 1870, 1942,
    ...
    数据2 = [0, 151, 167, 182, 197, 213, 228, 244, 259, 274, 290, 305, 320, 336, 351, 367, 382, 397, 413, 428, 444, 459,
...
class 混沌行者技能17(混沌行者主动技能):
    名称 = '次元粒子波'
    所在等级 = 45
    等级上限 = 60
    基础等级 = 31
    # 一类裂隙
    数据1 = [0, 966, 1063, 1162, 1258, 1357, 1456, 1552, 1651, 1750, 1847, 1945, 2042, 2141, 2239, 2336, 2435, 2531, 2630,
    ...
    攻击次数1 = 10
    # 二类裂隙
    数据2 = [0, 693, 764, 834, 905, 975, 1045, 1116, 1186, 1256, 1327, 1397, 1468, 1538, 1608, 1679, 1749, 1820, 1890,
...
class 混沌行者技能18(混沌行者主动技能):
    名称 = '乖离扭曲之恐惧'
    所在等级 = 50
    等级上限 = 40
    基础等级 = 12
    # 出现
    数据1 = [0, 5803, 7149, 8494, 9840, 11186, 12532, 13877, 15223, 16569, 17914, 19260, 20606, 21952, 23297, 24643, 25989,
    ...
    攻击次数1 = 1
    # 触须
    数据2 = [0, 1261, 1554, 1846, 2139, 2431, 2724, 3016, 3309, 3601, 3894, 4187, 4479, 4772, 5064, 5357, 5649, 5942,
    ...
    攻击次数2 = 22
    # 结束爆发
    数据3 = [0, 23213, 28596, 33979, 39362, 44745, 50128, 55510, 60893, 66276, 71659, 77042, 82425, 87808, 93191, 98573,
...
class 混沌行者技能19(混沌行者主动技能):
    名称 = '次元思维聚爆'
    所在等级 = 60
    等级上限 = 40
    基础等级 = 23
    # 持续伤害
    数据1 = [0, 502, 553, 603, 654, 705, 756, 807, 858, 909, 960, 1011, 1062, 1113, 1164, 1215, 1266, 1317, 1368, 1418,
    ...
    攻击次数1 = 1
    # 爆发伤害
    数据2 = [0, 16227, 17873, 19519, 21165, 22811, 24458, 26104, 27750, 29396, 31043, 32689, 34335, 35981, 37628, 39274,
...
class 混沌行者技能20(混沌行者主动技能):
    ...
    护石选项 = ['圣痕']
    def 普通形态(self):
        self.数据1 = [0, 23123, 25469, 27815, 30161, 32507, 34853, 37199, 39545, 41891, 44236, 46582, 48928, 51274, 53620,
        ...
        self.数据2 = [0, 28191, 31051, 33911, 36771, 39631, 42491, 45351, 48211, 51071, 53931, 56791, 59651, 62511, 65371,
        ...
        self.攻击次数2 = 1
    def 强化形态(self):
        self.数据1 = [0, 7127, 7850, 8573, 9297, 10020, 10743, 11466, 12189, 12912, 13635, 14358, 15081, 15804, 16528, 17251,
        ...
        self.数据2 = [0, 4751, 5233, 5715, 6198, 6680, 7162, 7644, 8126, 8608, 9090, 9572, 10054, 10536, 11018, 11500, 11982,
...
class 混沌行者技能21(混沌行者主动技能):
    名称 = '乖离禁锢'
    所在等级 = 70
    等级上限 = 40
    基础等级 = 18
    数据1 = [0, 29878, 32909, 35940, 38971, 42002, 45033, 48065, 51096, 54127, 57158, 60189, 63220, 66251, 69282, 72314,
...
class 混沌行者技能22(混沌行者主动技能):
    名称 = '乖离沉沦'
    所在等级 = 80
    等级上限 = 40
    基础等级 = 13
    是否有护石 = 1
    数据1 = [0, 36493, 40196, 43898, 47600, 51302, 55006, 58708, 62410, 66112, 69815, 73517, 77219, 80921, 84624, 88326,
    ...
    #成长 = 3702.340
    攻击次数1 = 1
    数据2 = [0, 1214, 1338, 1462, 1585, 1708, 1831, 1955, 2078, 2201, 2324, 2448, 2572, 2694, 2818, 2941, 3065, 3187,
...
class 混沌行者技能23(混沌行者主动技能):
    名称 = '禁断之盛宴'
    所在等级 = 85
    等级上限 = 40
    基础等级 = 5
    迷雾数据 = [0, 5976, 7362, 8748, 10134, 11520, 12906, 14292, 15678, 17064, 18450, 19836, 21222, 22608, 23994, 25380, 26766,
    ...
    炮击数据 = [0, 4980, 6135, 7290, 8445, 9600, 10755, 11910, 13065, 14220, 15375, 16530, 17685, 18840, 19995, 21150, 22305,
    ...
    普通炮击数据 = [0, 2973, 3663, 4353, 5042, 5732, 6421, 7111, 7801, 8490, 9180, 9869, 10559, 11249, 11938, 12628, 13317, 14007,
    ...
    强化炮击数据 = [0, 2787, 3433, 4080, 4726, 5373, 6019, 6665, 7312, 7958, 8605, 9251, 9897, 10544, 11190, 11837, 12483, 13129,
    ...
    终结伤害 = [0, 98842, 121761, 144681, 167601, 190521, 213441, 236361, 259281, 282201, 305121, 328040, 350960, 373880, 396800,
...
class 混沌行者角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        ...
        if self.奇点形态 == 1:
            if self.装备奇点护石 == 1:
                self.技能栏[self.技能序号['次元奇点']].护石无效化()
            self.技能栏[self.技能序号['次元奇点']].强化形态()

        if self.二觉形态 == 0: # 不强化
            self.技能栏[self.技能序号['禁断之盛宴']].攻击次数1 = 10
            self.技能栏[self.技能序号['禁断之盛宴']].攻击次数2 = 13
        ...
        if self.二觉形态 == 1: # 强化:取消后摇
            ...
            self.技能栏[self.技能序号['禁断之盛宴']].攻击次数3 = 0
            self.技能栏[self.技能序号['禁断之盛宴']].攻击次数4 = 17 # 17 or 18?
...
class 混沌行者(角色窗口):
    ...
    def 界面(self):
        ...
        self.强化奇点.setToolTip('次元奇点护石只强化非强化形态的此技能')
