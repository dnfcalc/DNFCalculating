...
class 忍者技能9(主动技能):
    ...
    基础等级 = 1
    是否有伤害 = 0
    关联技能 = ['碎踝', '火遁·豪火球之术', '忍法：幻影手里剑', '火遁·飓风煞', '火遁·螺旋手里剑', '忍法：替身术', '火遁·炎天道', '火遁·蟾蜍油炎弹', '火遁·炎舞天璇','火遁·冥炎业火阵','八歧大蛇',
...
class 忍者技能11(主动技能):
    ...
    等级上限 = 11
    基础等级 = 1
    关联技能 = ['碎踝', '火遁·豪火球之术', '忍法：幻影手里剑', '火遁·飓风煞', '火遁·螺旋手里剑', '忍法：替身术', '火遁·炎天道','火遁·蟾蜍油炎弹','火遁·炎舞天璇','八歧大蛇','火遁·风魔手里剑','天照']
    CD = 31.5
...
class 忍者(角色窗口):
    ...
    def 界面(self):
        ...
        self.六道绑定按钮 = []
        self.可绑定技能 = ['碎踝', '火遁·豪火球之术', '忍法：幻影手里剑', '火遁·飓风煞', '火遁·螺旋手里剑', '忍法：替身术', '火遁·炎天道', '火遁·蟾蜍油炎弹', '火遁·炎舞天璇', '八歧大蛇','火遁·风魔手里剑', '天照']
        默认勾选 = [ '忍法：替身术',  '火遁·蟾蜍油炎弹', '火遁·炎舞天璇', '八歧大蛇','火遁·风魔手里剑', '天照']
