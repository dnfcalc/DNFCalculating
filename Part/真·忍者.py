...
class 真·忍者技能0(主动技能):
    ...
    学习间隔 = 2
    等级精通 = 50
    基础等级 = min(int((真·忍者等级 - 所在等级) / 学习间隔), 等级精通) + 1
...
class 真·忍者技能14(主动技能):
    ...
    学习间隔 = 5
    等级精通 = 30
    基础等级 = min(int((真·忍者等级 - 所在等级) / 学习间隔 + 1), 等级精通)
...
class 真·忍者技能21(主动技能):
    ...
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 * self.攻击倍率1 + self.数据2[self.等级] * self.攻击次数2 + self.数据3[self.等级] * self.攻击次数3 * self.攻击倍率3) * (1 + self.TP成长 * self.TP等级) * self.倍率
...
while i >= 0:
    try:
        exec('真·忍者技能列表.append(真·忍者技能' + str(i) + '())')
        i += 1
    except:
        i = -1

真·忍者技能序号 = dict()
for i in range(len(真·忍者技能列表)):
    真·忍者技能序号[真·忍者技能列表[i].名称] = i
...
for i in 真·忍者技能列表:
    if i.所在等级 == 50:
        真·忍者一觉序号 = 真·忍者技能序号[i.名称]
    if i.所在等级 == 85:
        真·忍者二觉序号 = 真·忍者技能序号[i.名称]
    if i.所在等级 == 100:
        真·忍者三觉序号 = 真·忍者技能序号[i.名称]

真·忍者护石选项 = ['无']
for i in 真·忍者技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        真·忍者护石选项.append(i.名称)

真·忍者符文选项 = ['无']
for i in 真·忍者技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        真·忍者符文选项.append(i.名称)
...
class 真·忍者角色属性(角色属性):
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏 = deepcopy(真·忍者技能列表)
        self.技能序号 = deepcopy(真·忍者技能序号)
    ...
    def 数据计算(self, x = 0, y = -1):
        ...
        if self.技能栏[self.技能序号['忍法：六道轮回']].等级 != 0 and 技能释放次数[self.技能序号['忍法：六道轮回']] !=0 :
           ...
           默认宠物技能 = ['火遁·蟾蜍油炎弹', '火遁·炎舞天璇', '八岐大蛇', '火遁·风魔手里剑', '天照', '勾玉之火·镰鼬']
...
class 真·忍者(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 真·忍者二觉序号
        self.三觉序号 = 真·忍者三觉序号
        self.护石选项 = deepcopy(真·忍者护石选项)
        self.符文选项 = deepcopy(真·忍者符文选项)
    ...
    def 界面(self):
        ...
        self.六道绑定按钮 = []
        self.可绑定技能 = ['火遁·豪火球之术', '忍法：幻影手里剑', '火遁·飓风煞', '火遁·螺旋手里剑','忍法：替身术','火遁·炎天道','火遁·蟾蜍油炎弹', '火遁·炎舞天璇', '八岐大蛇','火遁·风魔手里剑', '天照','勾玉之火·镰鼬']
        self.绑定技能次数 = []
