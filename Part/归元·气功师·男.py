...
# 分身 618不变
class 归元·气功师·男技能1(归元·气功师·男主动技能):
    名称 = '分身'
    所在等级 = 5
    等级上限 = 20
    基础等级 = 10
...
# 幻影爆碎*=（分身个数+tp个数）
class 归元·气功师·男技能6(归元·气功师·男主动技能):
    名称 = '幻影爆碎'
    是否主动 = 0
    所在等级 = 30
    等级上限 = 60
...
# 念气波：蓄念炮 
class 归元·气功师·男技能8(归元·气功师·男主动技能):
    名称 = '念气波：蓄念炮'
    所在等级 = 15
    等级上限 = 60
    # 基础等级 = 46
...
# 念气罩
class 归元·气功师·男技能9(归元·气功师·男主动技能):
    名称 = '念气罩'
    所在等级 = 25
    等级上限 = 20
    基础等级 = 10
...
# 念气环绕
class 归元·气功师·男技能10(归元·气功师·男主动技能):
    名称 = '念气环绕'
    所在等级 = 20
    等级上限 = 35
    学习间隔 = 3
...
# 念气环绕：袭 618改2秒演戏 遗漏
class 归元·气功师·男技能11(归元·气功师·男主动技能):
    名称 = '念气环绕：袭'
    所在等级 = 25
    等级上限 = 11
    基础等级 = 1
...
# 念气环绕：御  TP加算
class 归元·气功师·男技能12(归元·气功师·男主动技能):
    名称 = '念气环绕：御'
    所在等级 = 30
    等级上限 = 20
    # 基础等级 = 10
...
# 念兽：龙虎啸
class 归元·气功师·男技能13(归元·气功师·男主动技能):
    名称 = '念兽：龙虎啸'
    所在等级 = 30
    等级上限 = 35
    基础等级 = 25
...
# 狮子吼 618加强1.079 数组
class 归元·气功师·男技能14(归元·气功师·男主动技能):
    名称 = '狮子吼'
    所在等级 = 35
    等级上限 = 60
    # 基础等级 = 36
...
# 螺旋念气场 618加强1.095
class 归元·气功师·男技能15(归元·气功师·男主动技能):
    名称 = '螺旋念气场'
    所在等级 = 40
    等级上限 = 60
    # 基础等级 = 33
...
class 归元·气功师·男技能16(归元·气功师·男主动技能):
    名称 = '念兽：猛虎震地'
    所在等级 = 45
    等级上限 = 60
    # 基础等级 = 31
...
# 念兽：审判之金雷虎-一觉
class 归元·气功师·男技能17(归元·气功师·男主动技能):
    名称 = '念兽：审判之金雷虎'
    所在等级 = 50
    等级上限 = 40
    基础等级 = 12
...
# 念之战矛  618加强1.122
class 归元·气功师·男技能18(归元·气功师·男主动技能):
    名称 = '念之战矛'
    所在等级 = 60
    等级上限 = 40
    # 基础等级 = 23
...
# 冲云念气场 618感电分离1次
class 归元·气功师·男技能19(归元·气功师·男主动技能):
    名称 = '冲云念气场'
    所在等级 = 70
    等级上限 = 40
    # 基础等级 = 18
...
# 奔雷螺旋击 618加强1.074
class 归元·气功师·男技能20(归元·气功师·男主动技能):
    名称 = '奔雷螺旋击'
    所在等级 = 75
    等级上限 = 40
    # 基础等级 = 16
...
# 月辉念气破 618加强1.075
class 归元·气功师·男技能21(归元·气功师·男主动技能):
    名称 = '月辉念气破'
    所在等级 = 80
    等级上限 = 40
    # 基础等级 = 13
...
# 月华万象-二觉
class 归元·气功师·男技能22(归元·气功师·男主动技能):
    名称 = '月华万象'
    所在等级 = 85
    等级上限 = 40
    # 基础等级 = 5
...
class 归元·气功师·男技能23(归元·气功师·男主动技能):
    名称 = '禅语：形灭'
    所在等级 = 95
    等级上限 = 40
    # 基础等级 = 6
...
# 禅念：归一
class 归元·气功师·男技能24(归元·气功师·男主动技能):
    名称 = '禅念：归一'
    所在等级 = 100
    等级上限 = 40
    # 基础等级 = 2
