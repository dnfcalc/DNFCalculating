...
class 龙神技能2(主动技能):
    ...
    等级上限 = 60
    基础等级 = 46
    数据1 = [0, 785, 864, 944, 1023, 1103, 1183, 1262, 1342, 1422, 1501, 1581, 1661, 1740, 1820, 1900, 1979, 2059, 2138, 2218, 2298, 2377, 2457, 2537, 2616, 2696, 2776, 2855, 2935, 3014, 3094, 3174, 3253, 3333, 3413, 3492, 3572, 3652, 3731, 3811, 3891, 3970, 4050, 4129, 4209, 4289, 4368, 4448, 4528, 4607, 4687, 4767, 4846, 4926, 5006, 5085, 5165, 5244, 5324, 5404, 5483]
    攻击次数1 = 3
    CD = 5.0
    TP成长 = 0.10
    TP上限 = 7
...
class 龙神技能3(主动技能):
    ...
    等级上限 = 60
    基础等级 = 43
    数据1 = [0, 1545, 1702, 1859, 2016, 2172, 2329, 2486, 2643, 2800, 2957, 3113, 3270, 3427, 3584, 3741, 3897, 4054, 4211,
...
class 龙神技能5(主动技能):
    ...
    等级上限 = 60
    基础等级 = 41
    数据1 = [0, 1531, 1686, 1841, 1997, 2152, 2307, 2462, 2618, 2773, 2928, 3084, 3239, 3394, 3550, 3705, 3860, 4016, 4171,
...
class 龙神技能10(主动技能):
    ...
    等级上限 = 60
    基础等级 = 36
    数据1 = [0, 7109, 7825, 8548, 9271, 9993, 10710, 11432, 12156, 12878, 13595, 14317, 15040, 15763, 16486, 17203, 17925, 18648, 19371, 20087, 20810, 21533, 22256, 22972, 23694, 24418, 25140, 25857, 26579, 27303, 28025, 28741, 29464, 30187, 30910, 31633, 32350, 33072, 33795, 34518, 35234, 35957, 36680, 37403, 38119, 38841, 39565, 40287, 41004, 41726, 42449, 43172, 43895, 44611, 45334, 46057, 46780, 47496, 48219, 48942, 49665]
    攻击次数1 = 1
    CD = 12.0
    TP成长 = 0.10
    TP上限 = 7
...
class 龙神技能13(主动技能):
    ...
    等级上限 = 60
    基础等级 = 33
    数据1=[0, 14507, 15979, 17451, 18923, 20395, 21867, 23338, 24810, 26282, 27754, 29226, 30698, 32169, 33641, 35113, 36585, 38057, 39529, 41000, 42472, 43944, 45416, 46888, 48359, 49831, 51303, 52775, 54247, 55719, 57190, 58662, 60134, 61606, 63078, 64550, 66021, 67493, 68965, 70437, 71909, 73380, 74852, 76324, 77796, 79268, 80740, 82211, 83683, 85155, 86627, 88099, 89571, 91042, 92514, 93986, 95458, 96930, 98401, 99873, 101345]
    攻击次数1 = 1
    CD = 25.0
    TP成长 = 0.10
    TP上限 = 7
...
class 龙神技能16(主动技能):
    ...
    等级上限 = 40
    基础等级 = 20
    数据1 = [0, 935, 1084, 1233, 1383, 1532, 1681, 1830, 1979, 2128, 2278, 2427, 2576, 2725, 2874, 3023, 3172, 3322, 3471, 3620,
     3769, 3918, 4067, 4217, 4366, 4515, 4664, 4813, 4962, 5112, 5261, 5410, 5559, 5708, 5857, 6006, 6156, 6305, 6454,
     6603, 6752]
    攻击次数1 = 1
    CD = 3.0
    TP上限 = 0
...
class 龙神技能19(主动技能):
    ...
    等级上限 = 40
    基础等级 = 18
    数据1 = [0, 29663, 32672, 35681, 38690, 41701, 44710, 47719, 50729, 53738, 56747, 59757, 62766, 65775, 68784, 71794, 74803, 77812, 80822, 83831, 86840, 89850, 92859, 95868, 98877, 101887, 104896, 107905, 110915, 113924, 116933, 119943, 122952, 125961, 128970, 131980, 134990, 137999, 141009, 144018, 147027]
    攻击次数1 = 1
    CD = 50.0
    TP成长 = 0.10
    TP上限 = 7
