...
class 归元·柔道家·男技能0(归元·柔道家·男主动技能):
    名称 = '膝击'
    所在等级 = 15
    等级上限 = 60
    基础等级 = 50
...
class 归元·柔道家·男技能3(归元·柔道家·男主动技能):
    名称 = '抛投'
    所在等级 = 20
    等级上限 = 60
    基础等级 = 46
...
class 归元·柔道家·男技能5(归元·柔道家·男主动技能):
    名称 = '野蛮冲撞'
    所在等级 = 25
    等级上限 = 60
    基础等级 = 41
...
class 归元·柔道家·男技能6(归元·柔道家·男主动技能):
    名称 = '无情摔击'
    所在等级 = 25
    等级上限 = 60
    基础等级 = 41
...
class 归元·柔道家·男技能7(归元·柔道家·男主动技能):
    名称 = '空绞锤'
    所在等级 = 30
    等级上限 = 60
    基础等级 = 38
...
class 归元·柔道家·男技能8(归元·柔道家·男主动技能):
    名称 = '霹雳旋踢'
    所在等级 = 30
    等级上限 = 60
    基础等级 = 38
...
class 归元·柔道家·男技能9(归元·柔道家·男主动技能):
    名称 = '浮空凌云踢'
    所在等级 = 35
    等级上限 = 60
    基础等级 = 36
...
class 归元·柔道家·男技能10(归元·柔道家·男主动技能):
    名称 = '疾波猛坠'
    所在等级 = 35
    等级上限 = 60
    基础等级 = 36
...
class 归元·柔道家·男技能11(归元·柔道家·男主动技能):
    名称 = '地狱风火轮'
    所在等级 = 40
    等级上限 = 60
    基础等级 = 33
...
class 归元·柔道家·男技能12(归元·柔道家·男主动技能):
    名称 = '裂石破天'
    所在等级 = 45
    等级上限 = 60
    基础等级 = 31
...
class 归元·柔道家·男技能14(归元·柔道家·男主动技能):
    名称 = '死亡旋律'
    所在等级 = 50
    等级上限 = 40
    基础等级 = 12
...
class 归元·柔道家·男技能15(归元·柔道家·男主动技能):
    名称 = '彗星冲击'
    所在等级 = 60
    等级上限 = 40
    基础等级 = 23
...
class 归元·柔道家·男技能16(归元·柔道家·男主动技能):
    名称 = '武莲华'
    所在等级 = 70
    等级上限 = 40
    基础等级 = 18
...
class 归元·柔道家·男技能18(归元·柔道家·男主动技能):
    名称 = '黑震旋风'
    所在等级 = 75
    等级上限 = 40
    基础等级 = 16
...
class 归元·柔道家·男技能19(归元·柔道家·男主动技能):
    名称 = '疾风闪电'
    所在等级 = 80
    等级上限 = 40
    基础等级 = 13
...
class 归元·柔道家·男技能20(归元·柔道家·男主动技能):
    名称 = '一字传承：极义震天破'
    所在等级 = 85
    等级上限 = 40
    基础等级 = 5
...
class 归元·柔道家·男技能22(归元·柔道家·男主动技能):
    名称 = '黑震流·陨灭'
    所在等级 = 95
    等级上限 = 40
    基础等级 = 6
...
class 归元·柔道家·男技能23(归元·柔道家·男主动技能):
    名称 = '黑震流·山岳崩颓'
    所在等级 = 100
    等级上限 = 40
    基础等级 = 2
