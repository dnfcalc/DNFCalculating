...
class 归元气功师男技能6(归元气功师男主动技能):
    ...
    学习间隔 = 2
    等级精通 = 50
    基础等级 = min(int((归元气功师男等级 - 所在等级) / 学习间隔 + 1), 等级精通)
    # 基础等级 = 38
    # 基础 = 652
    # 成长 = 74
...
class 归元气功师男角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        ...
        super().被动倍率计算()
       # self.技能栏[self.技能序号['念气环绕：御']].被动倍率  = self.技能栏[self.技能序号['念气环绕']].等效百分比(self.武器类型) *self.技能栏[self.技能序号['念气环绕：御']].等效百分比(self.武器类型)/1000
