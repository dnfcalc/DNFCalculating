...
class 归元气功师男角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        ...
        self.技能栏[self.技能序号['念气环绕：御']].被动倍率 = 10 * self.技能栏[self.技能序号['念气环绕']].被动倍率 * self.技能栏[self.技能序号['念气环绕：御']].被动倍率
...
class 归元气功师男(角色窗口):
    def 窗口属性输入(self):
        ...
        self.护石选项 = deepcopy(归元气功师男护石选项)
        self.符文选项 = deepcopy(归元气功师男符文选项)
