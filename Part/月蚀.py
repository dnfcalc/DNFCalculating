...
class 月蚀技能4(月蚀主动技能):
    ...
    基础=3099.1556
    成长=349.8444
    秒伤基础 = 87.1555 + 246.2222/2 + 11.7111/4*6 + 620.0222/4
    秒伤成长 = 9.8444 + 27.7777/2 + 0.2888/4*6 + 620.0222/4
    CD=15
    演出时间 = 7.7
    TP成长=0.10
    TP上限=7
...
class 月蚀技能5(月蚀主动技能):
    ...
    基础=360.3555*6
    成长=40.6444*6
    秒伤基础 = 107.8222/2 + 163.5111/2.5 + 102.4222*4/8
    秒伤成长 = 12.1778/2 + 18.4888/2.5 + 11.5778*4/8
    CD=15
    TP成长=0.10
    TP上限=7
    演出时间 = 1.5
