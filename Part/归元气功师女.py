...
while i >= 0:
    try:
        exec('归元气功师女技能列表.append(归元气功师女技能' + str(i) + '())')
        i += 1
    except:
        i = -1

归元气功师女技能序号 = dict()
for i in range(len(归元气功师女技能列表)):
    归元气功师女技能序号[归元气功师女技能列表[i].名称] = i
...
for i in 归元气功师女技能列表:
    if i.所在等级 == 50:
        归元气功师女一觉序号 = 归元气功师女技能序号[i.名称]
    if i.所在等级 == 85:
        归元气功师女二觉序号 = 归元气功师女技能序号[i.名称]
    if i.所在等级 == 100:
        归元气功师女三觉序号 = 归元气功师女技能序号[i.名称]

归元气功师女护石选项 = ['无']
for i in 归元气功师女技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        归元气功师女护石选项.append(i.名称)

归元气功师女符文选项 = ['无']
for i in 归元气功师女技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        归元气功师女符文选项.append(i.名称)


class 归元气功师女角色属性(角色属性):
    职业名称 = '归元气功师女'
    ...
    def __init__(self):
        self.技能栏 = copy.deepcopy(归元气功师女技能列表)
        self.技能序号 = copy.deepcopy(归元气功师女技能序号)
...
class 归元气功师女(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 归元气功师女角色属性()
        self.角色属性A = 归元气功师女角色属性()
        self.角色属性B = 归元气功师女角色属性()
        self.一觉序号 = 归元气功师女一觉序号
        self.二觉序号 = 归元气功师女二觉序号
        self.三觉序号 = 归元气功师女三觉序号
        self.护石选项 = copy.deepcopy(归元气功师女护石选项)
        self.符文选项 = copy.deepcopy(归元气功师女符文选项)
