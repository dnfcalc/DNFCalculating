...
class 真·芙蕾雅技能21(真·芙蕾雅主动技能):
    ...
    等级精通 = 30
    基础等级 = min(int((芙蕾雅等级 - 所在等级) / 学习间隔 + 1), 等级精通)
    数据 = [0,233,233,233,233,233,233,233,233,233,233]
    攻击次数 = 1
    CD = 60
    脱手 = 1
    技能施放时间 = 0.0
...
class 真·芙蕾雅技能22(真·芙蕾雅主动技能):
    ...
    def 加成倍率(self, 武器类型):
        return 0.0
    数据 = [0,2333,2333,2333,2333,2333,2333,2333,2333,2333,2333]
    攻击次数 = 1
    CD = 60
    脱手 = 0
    技能施放时间 = 6.3
...
while i >= 0:
    try:
        exec('真·芙蕾雅技能列表.append(真·芙蕾雅技能' + str(i) + '())')
        i += 1
    except:
        i = -1

真·芙蕾雅技能序号 = dict()
for i in range(len(真·芙蕾雅技能列表)):
    真·芙蕾雅技能序号[真·芙蕾雅技能列表[i].名称] = i
...
for i in 真·芙蕾雅技能列表:
    if i.所在等级 == 50:
        真·芙蕾雅一觉序号 = 真·芙蕾雅技能序号[i.名称]
    if i.所在等级 == 85:
        真·芙蕾雅二觉序号 = 真·芙蕾雅技能序号[i.名称]
    if i.所在等级 == 100:
        真·芙蕾雅三觉序号 = 真·芙蕾雅技能序号[i.名称]

真·芙蕾雅护石选项 = ['无']
for i in 真·芙蕾雅技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        真·芙蕾雅护石选项.append(i.名称)

真·芙蕾雅符文选项 = ['无']
for i in 真·芙蕾雅技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1 and i.名称 != '爆裂弹':
        真·芙蕾雅符文选项.append(i.名称)


class 真·芙蕾雅角色属性(角色属性):
    实际名称 = '真·芙蕾雅'
    角色 = '神枪手(女)'
    职业 = '弹药专家'
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏 = deepcopy(真·芙蕾雅技能列表)
        self.技能序号 = deepcopy(真·芙蕾雅技能序号)
...
class 真·芙蕾雅(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 真·芙蕾雅角色属性()
        self.角色属性A = 真·芙蕾雅角色属性()
        self.角色属性B = 真·芙蕾雅角色属性()
        self.一觉序号 = 真·芙蕾雅一觉序号
        self.二觉序号 = 真·芙蕾雅二觉序号
        self.三觉序号 = 真·芙蕾雅三觉序号
        self.护石选项 = deepcopy(真·芙蕾雅护石选项)
        self.符文选项 = deepcopy(真·芙蕾雅符文选项)
    def 界面(self):
        super().界面()
