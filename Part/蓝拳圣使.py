...
while i >= 0:
    try:
        exec('蓝拳圣使技能列表.append(蓝拳圣使技能'+str(i)+'())')
        i += 1
    except:
        i = -1

蓝拳圣使技能序号 = dict()
for i in range(len(蓝拳圣使技能列表)):
    蓝拳圣使技能序号[蓝拳圣使技能列表[i].名称] = i
...
for i in 蓝拳圣使技能列表:
    if i.所在等级 == 50:
        蓝拳圣使一觉序号 = 蓝拳圣使技能序号[i.名称]
    if i.所在等级 == 85:
        蓝拳圣使二觉序号 = 蓝拳圣使技能序号[i.名称]
    if i.所在等级 == 100:
        蓝拳圣使三觉序号 = 蓝拳圣使技能序号[i.名称]

蓝拳圣使护石选项 = ['无']
for i in 蓝拳圣使技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        蓝拳圣使护石选项.append(i.名称)

蓝拳圣使符文选项 = ['无']
for i in 蓝拳圣使技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        蓝拳圣使符文选项.append(i.名称)
...
class 蓝拳圣使角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(蓝拳圣使技能列表)
        self.技能序号= deepcopy(蓝拳圣使技能序号)
...
class 蓝拳圣使(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 蓝拳圣使二觉序号
        self.三觉序号 = 蓝拳圣使三觉序号
        self.护石选项 = deepcopy(蓝拳圣使护石选项)
        self.符文选项 = deepcopy(蓝拳圣使符文选项)
