...
class 垂迹·复仇者技能8(主动技能):
    ...
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 + self.数据2[self.等级] * self.倍率2) * (1 + self.TP成长 * self.TP等级) * self.倍率
...
class 垂迹·复仇者技能12(主动技能):
    名称 = '审判'
    所在等级 = 50
    等级上限 = 1
    基础等级 = 1
    数据1 = [0, 8042, 9907, 11772, 13636, 15501, 17366, 19231, 21096, 22961, 24826, 26691, 28555, 30420, 32285, 34150, 36015,
    ...
    数据2 = [0, 22889, 28197, 33504, 38812, 44120, 49428, 54735, 60043, 65351, 70659, 75966, 81274, 86582, 91889, 97197, 102505,
...
while i >= 0:
    try:
        exec('垂迹·复仇者技能列表.append(垂迹·复仇者技能'+str(i)+'())')
        i += 1
    except:
        i = -1

垂迹·复仇者技能序号 = dict()
for i in range(len(垂迹·复仇者技能列表)):
    垂迹·复仇者技能序号[垂迹·复仇者技能列表[i].名称] = i
...
for i in 垂迹·复仇者技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        垂迹·复仇者护石选项.append(i.名称)

垂迹·复仇者符文选项 = ['无']
for i in 垂迹·复仇者技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        垂迹·复仇者符文选项.append(i.名称)

class 垂迹·复仇者角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(垂迹·复仇者技能列表)
        self.技能序号= deepcopy(垂迹·复仇者技能序号)
...
class 垂迹·复仇者(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 垂迹·复仇者角色属性()
        self.角色属性A = 垂迹·复仇者角色属性()
        self.角色属性B = 垂迹·复仇者角色属性()
        self.一觉序号 = 垂迹·复仇者一觉序号
        self.二觉序号 = 垂迹·复仇者二觉序号
        self.三觉序号 = 垂迹·复仇者三觉序号
        self.护石选项 = deepcopy(垂迹·复仇者护石选项)
        self.符文选项 = deepcopy(垂迹·复仇者符文选项)
