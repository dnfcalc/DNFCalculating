...
class 极诣驭剑士角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        super().被动倍率计算()
        self.技能栏[self.技能序号['破军旋舞斩']].被动倍率 *= round(1.096 + self.技能栏[self.技能序号['毁灭之巨剑精通']].等级 * 0.004, 3) * 1.2
        
        self.技能栏[self.技能序号['恶即斩']].基础2 *= round(1.375 + self.技能栏[self.技能序号['毁灭之巨剑精通']].等级 * 0.005, 3)
        self.技能栏[self.技能序号['恶即斩']].成长2 *= round(1.375 + self.技能栏[self.技能序号['毁灭之巨剑精通']].等级 * 0.005, 3)
    ...
    def 站街物理攻击力(self):
        ...
        if self.技能栏[self.技能序号['帝皇盟约']].等级 != 0:
           ...
           站街物理攻击 = int(站街物理攻击)
        try:
            站街物理攻击 *=   self.技能栏[self.技能序号['毁灭之巨剑精通']].物理攻击力倍率(self.武器类型)
        except:
            pass
    ...
    def 面板物理攻击力(self):
        ...
        if self.技能栏[self.技能序号['帝皇盟约']].等级 != 0:
           ...
           面板物理攻击 = int(面板物理攻击)
        try:
            面板物理攻击 *= self.技能栏[self.技能序号['毁灭之巨剑精通']].物理攻击力倍率(self.武器类型)
        except:
            pass
