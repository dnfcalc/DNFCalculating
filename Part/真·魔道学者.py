...
class 真·魔道学者技能4(主动技能):
    ...
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 + self.数据2[self.等级] * self.攻击次数2) * (1 + self.TP成长 * self.TP等级) * self.倍率*1.3/1.12
...
class 真·魔道学者技能11(主动技能):
    ...
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 + self.数据2[self.等级] * self.攻击次数2 *1.1) * (1 + self.TP成长 * self.TP等级) * self.倍率*1.18/1.12
...
class 真·魔道学者技能13(主动技能):
    ...
    护石选项 = ['圣痕']
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 + self.数据2[self.等级] * self.攻击次数2 + self.数据3[self.等级] * self.攻击次数3) * (1 + self.TP成长 * self.TP等级) * self.倍率*1.131/1.12
    def 装备护石(self):
        self.倍率 *= 1.3
...
class 真·魔道学者技能18(主动技能):
    ...
    def 等效百分比(self, 武器类型):
        return (self.数据1[self.等级] * self.攻击次数1 + self.数据2[self.等级] * self.攻击次数2+self.数据3[self.等级] * self.攻击次数3) * self.倍率*1.155/1.12
