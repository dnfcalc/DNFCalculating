...
class 真·枪炮师·女技能0(主动技能):
    名称 = 'M3喷火器'
    所在等级 = 15
    等级上限 = 60
    学习间隔 = 2
    等级精通 = 50
    基础等级 = min(int((真·枪炮师·女等级 - 所在等级) / 学习间隔 + 1), 等级精通) + 1
...
class 真·枪炮师·女技能12(被动技能):
    名称 = '超温重火器'
    所在等级 = 48
    等级上限 = 40
    学习间隔 = 3
    等级精通 = 30
    基础等级 = min(int((真·枪炮师·女等级 - 所在等级) / 学习间隔 + 1), 等级精通)
...
while i >= 0:
    try:
        exec('真·枪炮师·女技能列表.append(真·枪炮师·女技能'+str(i)+'())')
        i += 1
    except:
        i = -1

真·枪炮师·女技能序号 = dict()
for i in range(len(真·枪炮师·女技能列表)):
    真·枪炮师·女技能序号[真·枪炮师·女技能列表[i].名称] = i

真·枪炮师·女一觉序号 = 0
真·枪炮师·女二觉序号 = 0
真·枪炮师·女三觉序号 = 0
for i in 真·枪炮师·女技能列表:
    if i.所在等级 == 50:
        真·枪炮师·女一觉序号 = 真·枪炮师·女技能序号[i.名称]
    if i.所在等级 == 85:
        真·枪炮师·女二觉序号 = 真·枪炮师·女技能序号[i.名称]
    if i.所在等级 == 100:
        真·枪炮师·女三觉序号 = 真·枪炮师·女技能序号[i.名称]

真·枪炮师·女护石选项 = ['无']
for i in 真·枪炮师·女技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        真·枪炮师·女护石选项.append(i.名称)

真·枪炮师·女符文选项 = ['无']
for i in 真·枪炮师·女技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        真·枪炮师·女符文选项.append(i.名称)

class 真·枪炮师·女角色属性(角色属性):
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏= deepcopy(真·枪炮师·女技能列表)
        self.技能序号= deepcopy(真·枪炮师·女技能序号)

class 真·枪炮师·女(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 真·枪炮师·女角色属性()
        self.角色属性A = 真·枪炮师·女角色属性()
        self.角色属性B = 真·枪炮师·女角色属性()
        self.一觉序号 = 真·枪炮师·女一觉序号
        self.二觉序号 = 真·枪炮师·女二觉序号
        self.三觉序号 = 真·枪炮师·女三觉序号
        self.护石选项 = deepcopy(真·枪炮师·女护石选项)
        self.符文选项 = deepcopy(真·枪炮师·女符文选项)
