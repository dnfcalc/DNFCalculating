...
while i >= 0:
    try:
        exec('真·刺客技能列表.append(真·刺客技能'+str(i)+'())')
        i += 1
    except:
        i = -1

真·刺客技能序号 = dict()
for i in range(len(真·刺客技能列表)):
    真·刺客技能序号[真·刺客技能列表[i].名称] = i
...
for i in 真·刺客技能列表:
    if i.所在等级 == 50:
        真·刺客一觉序号 = 真·刺客技能序号[i.名称]
    if i.所在等级 == 85:
        真·刺客二觉序号 = 真·刺客技能序号[i.名称]
    if i.所在等级 == 100:
        真·刺客三觉序号 = 真·刺客技能序号[i.名称]

真·刺客护石选项 = ['无']
for i in 真·刺客技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        真·刺客护石选项.append(i.名称)

真·刺客符文选项 = ['无']
for i in 真·刺客技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        真·刺客符文选项.append(i.名称)
...
class 真·刺客角色属性(角色属性):
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏= deepcopy(真·刺客技能列表)
        self.技能序号= deepcopy(真·刺客技能序号)
...
class 真·刺客(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 真·刺客二觉序号
        self.三觉序号 = 真·刺客三觉序号
        self.护石选项 = deepcopy(真·刺客护石选项)
        self.符文选项 = deepcopy(真·刺客符文选项)
