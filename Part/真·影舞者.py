...
class 真·影舞者技能0(主动技能):
    ...
    学习间隔 = 2
    等级精通 = 50
    基础等级 = min(int((真·影舞者等级 - 所在等级) / 学习间隔) + 1, 等级精通)
...
class 真·影舞者技能13(主动技能):
    ...
    def 技能描述(self, 武器类型):
        temp = '暗杀之匕首精通：<br>'
        temp += 'Lv.' + str(self.描述信息[0]) + ' → Lv.' + str(self.描述信息[2]) + '<br>'
        temp += str('%.1f%%' % (self.描述信息[1] * 100 - 100)) + ' → ' + str('%.1f%%' % (self.描述信息[3] * 100 - 100)) + '<br>'
        temp += '(该技能自身不享受加成)'
        return temp

class 真·影舞者技能14(主动技能):
    名称 = '绝命飞刃'
    所在等级 = 60
    等级上限 = 40
    学习间隔 = 2
...
while i >= 0:
    try:
        exec('真·影舞者技能列表.append(真·影舞者技能' + str(i) + '())')
        i += 1
    except:
        i = -1

真·影舞者技能序号 = dict()
for i in range(len(真·影舞者技能列表)):
    真·影舞者技能序号[真·影舞者技能列表[i].名称] = i
...
for i in 真·影舞者技能列表:
    if i.所在等级 == 50:
        真·影舞者一觉序号 = 真·影舞者技能序号[i.名称]
    if i.所在等级 == 85:
        真·影舞者二觉序号 = 真·影舞者技能序号[i.名称]
    if i.所在等级 == 100:
        真·影舞者三觉序号 = 真·影舞者技能序号[i.名称]

真·影舞者护石选项 = ['无']
for i in 真·影舞者技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        真·影舞者护石选项.append(i.名称)

真·影舞者符文选项 = ['无']
for i in 真·影舞者技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        真·影舞者符文选项.append(i.名称)


class 真·影舞者角色属性(角色属性):
    实际名称 = '真·影舞者'
    角色 = '暗夜使者'
    职业 = '影舞者'
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏 = deepcopy(真·影舞者技能列表)
        self.技能序号 = deepcopy(真·影舞者技能序号)
...
class 真·影舞者(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 真·影舞者角色属性()
        self.角色属性A = 真·影舞者角色属性()
        self.角色属性B = 真·影舞者角色属性()
        self.一觉序号 = 真·影舞者一觉序号
        self.二觉序号 = 真·影舞者二觉序号
        self.三觉序号 = 真·影舞者三觉序号
        self.护石选项 = deepcopy(真·影舞者护石选项)
        self.符文选项 = deepcopy(真·影舞者符文选项)