...
while i >= 0:
    try:
        exec('BUFF垂迹圣骑士技能列表.append(BUFF垂迹圣骑士技能'+str(i)+'())')
        i += 1
    except:
        i = -1

BUFF垂迹圣骑士技能序号 = dict()
for i in range(len(BUFF垂迹圣骑士技能列表)):
    BUFF垂迹圣骑士技能序号[BUFF垂迹圣骑士技能列表[i].名称] = i
BUFF垂迹圣骑士一觉序号 = 0
BUFF垂迹圣骑士二觉序号 = 0
BUFF垂迹圣骑士三觉序号 = 0
for i in BUFF垂迹圣骑士技能列表:
    if i.所在等级 == 50:
        BUFF垂迹圣骑士一觉序号 = BUFF垂迹圣骑士技能序号[i.名称]
    if i.所在等级 == 85:
        BUFF垂迹圣骑士二觉序号 = BUFF垂迹圣骑士技能序号[i.名称]
    if i.所在等级 == 100:
        BUFF垂迹圣骑士三觉序号 = BUFF垂迹圣骑士技能序号[i.名称]

class BUFF垂迹圣骑士角色属性(角色属性):
    职业名称 = 'BUFF垂迹圣骑士'
    系数类型选择 = ['体力','精神']
    体力 = 958
    精神 = 954
    ...
    def __init__(self):
        self.技能栏 = deepcopy(BUFF垂迹圣骑士技能列表)
        self.技能序号 = deepcopy(BUFF垂迹圣骑士技能序号)
...
class BUFF垂迹圣骑士(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = BUFF垂迹圣骑士角色属性()
        self.角色属性A = BUFF垂迹圣骑士角色属性()
        self.角色属性B = BUFF垂迹圣骑士角色属性()
        self.一觉序号 = BUFF垂迹圣骑士一觉序号
        self.二觉序号 = BUFF垂迹圣骑士二觉序号
        self.三觉序号 = BUFF垂迹圣骑士三觉序号
