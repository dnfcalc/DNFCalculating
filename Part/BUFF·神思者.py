...
while i >= 0:
    try:
        exec('BUFF·神思者技能列表.append(BUFF·神思者技能'+str(i)+'())')
        i += 1
    except:
        i = -1

BUFF·神思者技能序号 = dict()
for i in range(len(BUFF·神思者技能列表)):
    BUFF·神思者技能序号[BUFF·神思者技能列表[i].名称] = i


class BUFF·神思者角色属性(角色属性):
    实际名称 = 'BUFF·神思者'
    角色 = '圣职者(男)'
    职业 = '圣骑士'
    ...
    def __init__(self):
        基础属性输入(self)
        self.技能栏 = deepcopy(BUFF·神思者技能列表)
        self.技能序号 = deepcopy(BUFF·神思者技能序号)
...
class BUFF·神思者(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = BUFF·神思者角色属性()
        self.角色属性A = BUFF·神思者角色属性()
        self.角色属性B = BUFF·神思者角色属性()