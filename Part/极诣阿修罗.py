...
while i >= 0:
    try:
        exec('极诣阿修罗技能列表.append(极诣阿修罗技能'+str(i)+'())')
        i += 1
    except:
        i = -1

极诣阿修罗技能序号 = dict()
for i in range(len(极诣阿修罗技能列表)):
    极诣阿修罗技能序号[极诣阿修罗技能列表[i].名称] = i
...
for i in 极诣阿修罗技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        极诣阿修罗护石选项.append(i.名称)

极诣阿修罗符文选项 = ['无']
for i in 极诣阿修罗技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        极诣阿修罗符文选项.append(i.名称)

class 极诣阿修罗角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(极诣阿修罗技能列表)
        self.技能序号= deepcopy(极诣阿修罗技能序号)
...
class 极诣阿修罗(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 极诣阿修罗角色属性()
        self.角色属性A = 极诣阿修罗角色属性()
        self.角色属性B = 极诣阿修罗角色属性()
        self.一觉序号 = 极诣阿修罗一觉序号
        self.二觉序号 = 极诣阿修罗二觉序号
        self.三觉序号 = 极诣阿修罗三觉序号
        self.护石选项 = deepcopy(极诣阿修罗护石选项)
        self.符文选项 = deepcopy(极诣阿修罗符文选项)
