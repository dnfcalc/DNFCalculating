...
class 垂迹驱魔师技能14(被动技能):
    名称 = '驱魔之书'
    所在等级 = 30
    等级上限 = 40
    基础等级 = 10
    关联技能 = ['真龙焚天','式神封灵阵','逆龙七杀','逆鳞震','灭魂符','苍龙逐日','无双击','式神：殇','疾风旋空破','落雷符','狂乱锤击','疾风打','朱雀符','黑暗切割','升天阵','落凤锤','破魔符','式神合击：灭','五行返虚：开天辟地']
...
while i >= 0:
    try:
        exec('垂迹驱魔师技能列表.append(垂迹驱魔师技能' + str(i) + '())')
        i += 1
    except:
        i = -1

垂迹驱魔师技能序号 = dict()
for i in range(len(垂迹驱魔师技能列表)):
    垂迹驱魔师技能序号[垂迹驱魔师技能列表[i].名称] = i
...
for i in 垂迹驱魔师技能列表:
    if i.所在等级 == 50:
        垂迹驱魔师一觉序号 = 垂迹驱魔师技能序号[i.名称]
    if i.所在等级 == 85:
        垂迹驱魔师二觉序号 = 垂迹驱魔师技能序号[i.名称]
    if i.所在等级 == 100:
        垂迹驱魔师三觉序号 = 垂迹驱魔师技能序号[i.名称]

垂迹驱魔师护石选项 = ['无']
for i in 垂迹驱魔师技能列表:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        垂迹驱魔师护石选项.append(i.名称)

垂迹驱魔师符文选项 = ['无']
for i in 垂迹驱魔师技能列表:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        垂迹驱魔师符文选项.append(i.名称)


class 垂迹驱魔师角色属性(角色属性):
    职业名称 = '垂迹驱魔师'
    ...
    def __init__(self):
        self.技能栏 = deepcopy(垂迹驱魔师技能列表)
        self.技能序号 = deepcopy(垂迹驱魔师技能序号)
    ...
    def 被动倍率计算(self):
        ...
        if self.力法及精通 == 0 or self.力法及精通 == 1:
            ...
            self.技能栏[self.技能序号['式神合击：灭']].攻击次数 = 0
            self.技能栏[self.技能序号['式神合击：灭']].攻击次数2 = 1
            self.技能栏[self.技能序号['无双击']].被动倍率 *= 1.2

class 垂迹驱魔师(角色窗口):
    def 窗口属性输入(self):
        self.初始属性 = 垂迹驱魔师角色属性()
        self.角色属性A = 垂迹驱魔师角色属性()
        self.角色属性B = 垂迹驱魔师角色属性()
        self.一觉序号 = 垂迹驱魔师一觉序号
        self.二觉序号 = 垂迹驱魔师二觉序号
        self.三觉序号 = 垂迹驱魔师三觉序号
        self.护石选项 = deepcopy(垂迹驱魔师护石选项)
        self.符文选项 = deepcopy(垂迹驱魔师符文选项)
