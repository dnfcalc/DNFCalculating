...
class 极诣契魔者角色属性(角色属性):
    ...
    def __init__(self):
        self.技能栏= deepcopy(极诣契魔者技能列表)
        self.技能序号= deepcopy(极诣契魔者技能序号)
    ...
    def 被动倍率计算(self):
        ...
        self.技能栏[self.技能序号['蛇腹剑缠']].被动倍率 /= (x * y)
        self.技能栏[self.技能序号['蛇腹剑缠']].被动倍率 *= x + y -1
...
class 极诣契魔者(角色窗口):
    def 窗口属性输入(self):
        ...
        self.二觉序号 = 极诣契魔者二觉序号
        self.三觉序号 = 极诣契魔者三觉序号
        self.护石选项 = deepcopy(极诣契魔者护石选项)
        self.符文选项 = deepcopy(极诣契魔者符文选项)
