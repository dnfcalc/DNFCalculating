...
class 选择窗口(QWidget):
    ...
    def ui(self):
        ...
        action_1.triggered.connect(lambda state:self.打开链接(['https://gitee.com/i_melon/DNFCalculating/issues?state=all']))
        action_2 = QAction('联系我们-QQ-1群',parent=menu)
        action_2.triggered.connect(lambda state:self.打开链接(['https://jq.qq.com/?_wv=1027&k=VSNtZ1xv']))
        action_3 = QAction('联系我们-QQ-2群',parent=menu)
        action_3.triggered.connect(lambda state:self.打开链接(['https://jq.qq.com/?_wv=1027&k=QMgadVkA']))
        action_4 = QAction('联系我们-QQ-3群',parent=menu)
        action_4.triggered.connect(lambda state:self.打开链接(['https://jq.qq.com/?_wv=1027&k=ekQXpyq0']))
        menu.addAction(action_0)
        menu.addSeparator()
        menu.addAction(action_1)
        menu.addSeparator()
