...
class 苍暮·特工技能0(苍暮·特工主动技能):
    ...
    等级上限 = 60
    基础等级 = 46
    数据1 = [0, 846, 932, 1018, 1104, 1190, 1276, 1362, 1448, 1534, 1620, 1705, 1791, 1877, 1963, 2049, 2135, 2221, 2307, 2393, 2479, 2565, 2651, 2736, 2822, 2908, 2994, 3080, 3166, 3252, 3338, 3424, 3510, 3596, 3681,
    ...
    攻击次数1 = 2
    数据2 = [0, 1129, 1243, 1358, 1472, 1587, 1701, 1816, 1930, 2045, 2160, 2274, 2389, 2503, 2618, 2732, 2847, 2961, 3076, 3191, 3305, 3420, 3534, 3649, 3763, 3878, 3992, 4107, 4221, 4336, 4451, 4565, 4680, 4794, 4909,
...
class 苍暮·特工技能2(苍暮·特工主动技能):
    名称 = '双弦斩'
    所在等级 = 20
    等级上限 = 60
    基础等级 = 43
    数据1 = [0, 1130, 1245, 1359, 1474, 1589, 1703, 1818, 1933, 2047, 2162, 2277, 2392, 2506, 2621, 2736, 2850, 2965, 3080, 3194, 3309, 3424, 3538, 3653, 3768, 3883, 3997, 4112, 4227, 4341, 4456, 4571, 4685, 4800, 4915,
    ...
    攻击次数1 = 1
    数据2 = [0, 1695, 1867, 2039, 2211, 2383, 2555, 2727, 2899, 3071, 3244, 3416, 3588, 3760, 3932, 4104, 4276, 4448, 4620, 4792, 4964, 5136, 5308, 5480, 5652, 5824, 5996, 6168, 6340, 6512, 6684, 6856, 7028, 7200, 7372, 7544, 7716,
...
class 苍暮·特工技能3(苍暮·特工主动技能):
    名称 = '月光挥斩'
    所在等级 = 25
    等级上限 = 60
    基础等级 = 41
    数据 = [0, 1932, 2128, 2325, 2521, 2717, 2913, 3109, 3305, 3501, 3697, 3893, 4089, 4285, 4481, 4678, 4874, 5070, 5266, 5462, 5658, 5854, 6050, 6246, 6442, 6638, 6835, 7031, 7227, 7423, 7619, 7815, 8011, 8207, 8403, 8599, 8795, 8991,
...
class 苍暮·特工技能5(苍暮·特工主动技能):
    名称 = '满月斩'
    所在等级 = 35
    等级上限 = 60
    基础等级 = 36
    数据1 = [0, 1159, 1277, 1395, 1512, 1630, 1748, 1865, 1983, 2100, 2218, 2336, 2453, 2571, 2689, 2806, 2924, 3042, 3159, 3277, 3395, 3512, 3630, 3748, 3865, 3983, 4101, 4218, 4336, 4454, 4571, 4689, 4807, 4924, 5042,
    ...
    攻击次数1 = 3
    数据2 = [0, 4252, 4683, 5115, 5546, 5978, 6409, 6840, 7272, 7703, 8135, 8566, 8997, 9429, 9860, 10292, 10723, 11154, 11586, 12017, 12449, 12880, 13311, 13743, 14174, 14606, 15037, 15468, 15900, 16331, 16763, 17194, 17625, 18057, 18488, 18920,
...
class 苍暮·特工技能6(苍暮·特工主动技能):
    ...
    等级上限 = 60
    基础等级 = 46
    数据 = [0, 2489, 2742, 2994, 3247, 3499, 3752, 4004, 4257, 4509, 4762, 5015, 5267, 5520, 5772, 6025, 6277, 6530, 6782, 7035, 7288, 7540, 7793, 8045, 8298, 8550, 8803, 9055, 9308, 9561, 9813, 10066, 10318, 10571, 10823, 11076, 11328, 11581,
...
class 苍暮·特工技能8(苍暮·特工主动技能):
    名称 = '锁定射击'
    所在等级 = 40
    等级上限 = 60
    基础等级 = 33
    数据 = [0, 1152, 1269, 1386, 1503, 1620, 1736, 1853, 1970, 2087, 2204, 2321, 2438, 2555, 2672, 2789, 2906, 3023, 3139, 3256, 3373, 3490, 3607, 3724, 3841, 3958, 4075, 4192, 4309, 4425, 4542, 4659, 4776, 4893, 5010,
...
class 苍暮·特工技能9(苍暮·特工主动技能):
    名称 = '枪刃旋杀'
    所在等级 = 45
    等级上限 = 60
    基础等级 = 31
    数据1 = [0, 1105, 1217, 1329, 1442, 1554, 1666, 1778, 1890, 2002, 2115, 2227, 2339, 2451, 2563, 2675, 2787, 2900, 3012, 3124, 3236, 3348, 3460, 3573, 3685, 3797, 3909, 4021, 4133, 4246, 4358, 4470, 4582, 4694, 4806,
    ...
    攻击次数1 = 1
    数据2 = [0, 947, 1043, 1139, 1236, 1332, 1428, 1524, 1620, 1716, 1812, 1908, 2005, 2101, 2197, 2293, 2389, 2485, 2581, 2678, 2774, 2870, 2966, 3062, 3158, 3254, 3351, 3447, 3543, 3639, 3735, 3831, 3927, 4024, 4120,
    ...
    攻击次数2 = 17
    数据3 = [0, 4875, 5370, 5864, 6359, 6854, 7348, 7843, 8338, 8832, 9327, 9822, 10316, 10811, 11305, 11800, 12295, 12789, 13284, 13779, 14273, 14768, 15263, 15757, 16252, 16746, 17241, 17736, 18230, 18725, 19220, 19714, 20209, 20704, 21198, 21693,
...
class 苍暮·特工技能10(苍暮·特工主动技能):
    名称 = '终极锁定'
    所在等级 = 60
    等级上限 = 60
    基础等级 = 23
    数据 = [0, 5036, 5547, 6058, 6569, 7080, 7591, 8102, 8613, 9124, 9635, 10146, 10657, 11167, 11678, 12189, 12700, 13211, 13722, 14233, 14744,
...
class 苍暮·特工技能12(苍暮·特工主动技能):
    名称 = '噬血绝杀'
    所在等级 = 50
    等级上限 = 40
    基础等级 = 12
    数据 = [0, 27816, 34266, 40717, 47167, 53617, 60067, 66517, 72968, 79418, 85868, 92318, 98768, 105219, 111669, 118119, 124569, 131020, 137470, 143920, 150370,
...
class 苍暮·特工技能13(苍暮·特工主动技能):
    ...
    等级上限 = 40
    基础等级 = 18
    数据1 = [0, 4459, 4912, 5364, 5817, 6269, 6722, 7174, 7626, 8079, 8531, 8984, 9436, 9889, 10341, 10794, 11246, 11699, 12151, 12603, 13056, 13508, 13961, 14413, 14866, 15318, 15771, 16223, 16675, 17128, 17580, 18033, 18485, 18938, 19390, 19843,
    ...
    攻击次数1 = 2
    数据2 = [0, 5042, 5554, 6065, 6577, 7088, 7600, 8111, 8623, 9134, 9646, 10158, 10669, 11181, 11692, 12204, 12715, 13227, 13738, 14250, 14762, 15273, 15785, 16296, 16808, 17319, 17831, 18342, 18854, 19366, 19877, 20389, 20900, 21412, 21923, 22435,
    ...
    攻击次数2 = 2
    数据3 = [0, 6303, 6942, 7581, 8221, 8860, 9500, 10139, 10779, 11418, 12058, 12697, 13336, 13976, 14615, 15255, 15894, 16534, 17173, 17813, 18452, 19091, 19731, 20370, 21010, 21649, 22289, 22928, 23568, 24207, 24846, 25486, 26125, 26765, 27404, 28044,
...
class 苍暮·特工技能14(苍暮·特工主动技能):
    名称 = '月光镇魂曲'
    所在等级 = 75
    等级上限 = 40
    基础等级 = 16
    数据1 = [0, 4385, 4829, 5274, 5719, 6164, 6609, 7054, 7499, 7943, 8388, 8833, 9278, 9723, 10168, 10613, 11058, 11502, 11947, 12392, 12837,
           13282, 13727, 14172, 14616, 15061, 15506, 15951, 16396, 16841, 17286, 17730, 18175, 18620, 19065, 19510, 19955, 20400, 20845, 21289, 21734]
    攻击次数1 = 9
    数据2 = [0, 16913, 18629, 20345, 22061, 23777, 25493, 27209, 28925, 30641, 32357, 34072, 35788, 37504, 39220, 40936, 42652, 44368, 46084, 47800,
...
class 苍暮·特工技能16(苍暮·特工主动技能):
    名称 = '毁灭狂欢'
    所在等级 = 80
    等级上限 = 40
    基础等级 = 13
    数据1 = [0, 4306, 4743, 5180, 5617, 6054, 6491, 6927, 7364, 7801, 8238, 8675, 9112, 9549, 9986, 10423, 10860, 11296, 11733, 12170, 12607, 13044, 13481, 13918, 14355, 14792, 15228, 15665, 16102, 16539, 16976, 17413, 17850, 18287, 18724, 19161,
    ...
    攻击次数1 = 9
    暗杀目标追加攻击次数1 = 2
    数据2 = [0, 8359, 9207, 10055, 10904, 11752, 12600, 13448, 14296, 15144, 15992, 16840, 17688, 18536, 19385, 20233, 21081, 21929, 22777, 23625, 24473, 25321, 26169, 27017, 27865, 28714, 29562, 30410, 31258, 32106, 32954, 33802, 34650, 35498, 36346, 37195,
...
class 苍暮·特工技能17(苍暮·特工主动技能):
    名称 = '精准射击'
    所在等级 = 30
    等级上限 = 60
    基础等级 = 38
    数据 = [0, 4963, 5467, 5971, 6474, 6978, 7481, 7985, 8488, 8992, 9496, 9999, 10503, 11006, 11510, 12014, 12517, 13021, 13524, 14028, 14531, 15035, 15539, 16042, 16546, 17049, 17553, 18057, 18560, 19064, 19567, 20071, 20574, 21078, 21582, 22085,
...
class 苍暮·特工技能18(苍暮·特工主动技能):
    名称 = '月相天陨'
    所在等级 = 85
    等级上限 = 40
    基础等级 = 5
    数据1 = [0, 3975, 4897, 5819, 6741, 7663, 8585, 9507, 10429, 11350, 12272, 13194, 14116, 15038, 15960, 16882, 17804, 18726, 19648, 20569, 21491, 22413, 23335, 24257, 25179, 26101, 27023, 27945, 28867, 29788, 30710, 31632, 32554, 33476, 34398, 35320,
    ...
    攻击次数1 = 21
    数据2 = [0, 44955, 55380, 65805, 76229, 86654, 97078, 107503, 117928, 128352, 138777, 149201, 159626, 170050, 180475, 190900, 201324, 211749, 222173, 232598, 243022, 253447, 263872, 274296, 284721, 295145, 305570, 315995, 326419, 336844, 347268, 357693, 368117, 378542, 388967, 399391,
...
class 苍暮·特工技能20(苍暮·特工主动技能):
    名称 = '残月'
    所在等级 = 95
    等级上限 = 11
    基础等级 = 6
    数据1 = [0, 31557, 34758, 37960, 41161, 44363, 47564, 50765.6, 53967.05714, 57168.51429, 60369.97143, 63571.42857, 66772.88571,
           69974.34286, 73175.8, 76377.25714, 79578.71429, 82780.17143, 85981.62857, 89183.08571, 92384.54286, 95586, 98787.45714]
    攻击次数1 = 1
    数据2 = [0, 33660, 37076, 40490, 43906, 47320, 50736, 54150.8, 57565.88571, 60980.97143, 64396.05714, 67811.14286, 71226.22857,
           74641.31429, 78056.4, 81471.48571, 84886.57143, 88301.65714, 91716.74286, 95131.82857, 98546.91429, 101962, 105377.0857]
    攻击次数2 = 1
    数据3 = [0, 39972, 44027, 48082, 52138, 56193, 60248, 64303.4, 68358.65714, 72413.91429, 76469.17143, 80524.42857, 84579.68571,
...
class 苍暮·特工技能21(苍暮·特工主动技能):
    名称 = '最后的任务'
    所在等级 = 100
    等级上限 = 40
    基础等级 = 2
    数据1 = [0, 22833, 28127, 33421, 38715, 44009, 49303, 54597, 59891, 65185, 70479, 75773, 81067, 86361, 91655, 96949, 102243, 107537, 112831, 118125, 123419,
    ...
    攻击次数1 = 11
    数据2 = [0, 107642, 132603, 157564, 182525, 207486, 68970, 93931, 118892, 143853, 168814, 193775, 218736, 243697, 268658, 293619, 318580, 343541, 368502, 393463, 418424,
           443385, 468346, 493307, 518268, 543229, 568190, 593151, 618112, 643073, 668034, 692995, 717956, 742917, 767878, 792839, 817800, 842761, 867722, 892683, 917644]
    攻击次数2 = 1
    CD = 290
...
while i >= 0:
    try:
        exec('苍暮·特工技能列表.append(苍暮·特工技能'+str(i)+'())')
        i += 1
    except:
        i = -1

苍暮·特工技能序号 = dict()
for i in range(len(苍暮·特工技能列表)):
    苍暮·特工技能序号[苍暮·特工技能列表[i].名称] = i
...
for i in 苍暮·特工技能列表:
    if i.所在等级 == 50:
        苍暮·特工一觉序号 = 苍暮·特工技能序号[i.名称]
    if i.所在等级 == 85:
        苍暮·特工二觉序号 = 苍暮·特工技能序号[i.名称]
    if i.所在等级 == 100:
        苍暮·特工三觉序号 = 苍暮·特工技能序号[i.名称]
...
class 苍暮·特工(角色窗口):
    ...
    def 载入配置(self, path='set'):
        ...
        try:
            ...
            self.一觉减CD开关.setChecked(True if int(
                setfile[0].replace('\n', '')) == 1 else False)
        except:
            pass
