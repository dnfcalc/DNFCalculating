...
class 苍暮·特工技能20(苍暮·特工主动技能):
    ...
    等级上限 = 11
    基础等级 = 6
    数据1 = [0,31557,34758,37960,41161,44363,47564,50765.6,53967.05714,57168.51429,60369.97143,63571.42857,66772.88571,69974.34286,73175.8,76377.25714,79578.71429,82780.17143,85981.62857,89183.08571,92384.54286,95586,98787.45714]
    攻击次数1 = 1
    数据2 = [0,33660,37076,40490,43906,47320,50736,54150.8,57565.88571,60980.97143,64396.05714,67811.14286,71226.22857,74641.31429,78056.4,81471.48571,84886.57143,88301.65714,91716.74286,95131.82857,98546.91429,101962,105377.0857]
    攻击次数2 = 1
    数据3 = [0,39972,44027,48082,52138,56193,60248,64303.4,68358.65714,72413.91429,76469.17143,80524.42857,84579.68571,88634.94286,92690.2,96745.45714,100800.7143,104855.9714,108911.2286,112966.4857,117021.7429,121077,125132.2571]
    攻击次数3 = 1
    CD = 60
    def 等效百分比(self, 武器类型):
...
class 苍暮·特工技能21(苍暮·特工主动技能):
    ...
    等级上限 = 40
    基础等级 = 2
    数据1 = [0,22833,28127,33421,38715,44009,49303,54597,59891,65185,70479,75773,81067,86361,91655,96949,102243,107537,112831,118125,123419,128713,134007,139301,144595,149889,155183,160477,165771,171065,176359,181653,186947,192241,197535,202829,208123,213417,218711,224005,229299]
    攻击次数1 = 11
    数据2 = [0,107642,132603,157564,182525,207486,68970,93931,118892,143853,168814,193775,218736,243697,268658,293619,318580,343541,368502,393463,418424,443385,468346,493307,518268,543229,568190,593151,618112,643073,668034,692995,717956,742917,767878,792839,817800,842761,867722,892683,917644]
    攻击次数2 = 1
    CD = 290
    def 等效百分比(self, 武器类型):
        return ((self.数据1[self.等级] * self.攻击次数1)+(self.数据2[self.等级] * self.攻击次数2 )) * self.倍率
