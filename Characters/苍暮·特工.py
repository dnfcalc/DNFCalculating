...
class 技能21(苍暮·特工主动技能):
    ...
    攻击次数1 = 11
    数据2 = [0, 107642, 132603, 157564, 182525, 207486, 232447, 257408, 282369, 307330, 332291, 357252, 382213, 407174, 432135, 457096, 482057, 507018, 531979,
