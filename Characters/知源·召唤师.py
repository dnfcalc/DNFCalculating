...
class 知源·召唤师技能10(知源·召唤师主动技能):
    ...
    基础 = 555.2820*1.3*8
    成长 = 62.7179*1.3*8
    秒伤基础 = 82.5641*1.3/0.6 + 190.3846*1.3/3.1 * \
        3 + 415.9230*1.3/5*3 + 646.1025*1.3*4/9.3
...
class 知源·召唤师技能22(知源·召唤师主动技能):
    ...
    基础 = 1992.4*1.15*3
    成长 = 601.6*1.15*3
    秒伤基础 = 717.6*1.15/3*2 + 192.4*1.15/3 + 335*1.15 / \
        3 + 430*1.15/3 + 238.8*1.15/6 + 837.4*1.15/6
    秒伤成长 = 216.4*1.15/3*2 + 57.6*1.15/3 + 101*1.15 / \
        3 + 130*1.15/3 + 72.2*1.15/6 + 252.6*1.15/6
    演出时间 = 1.55
    额外演出时间 = 0
...
class 知源·召唤师技能23(知源·召唤师主动技能):
    ...
    等级上限 = 40
    基础等级 = 5
    基础 = 4782.4*1.15 + 1912.5*1.15*5 + 2733.2*1.15*7 + 14346*1.15
    成长 = 1443.7*1.15 + 577.7*1.15*5 + 824.9*1.15*7 + 4332*1.15
    演出时间 = 5.25
    CD = 180
