...
class 神启·蓝拳圣使技能1(被动技能):
    ...
    基础等级 = 10
    是否主动 = 1
    冷却关联技能 = ['直拳冲击', '圣拳锤击', '俯冲翔拳', '俯冲直拳', '俯冲腹拳', '瞬拳', '圣拳连击', '神圣反击', '破碎之锤',
              '漩涡重拳', '刺拳猛击', '神圣组合拳', '极速飓风拳', '破碎之拳', '破坏之拳', '仲裁怒击', '超重拳', '浩势审判']
...
class 神启·蓝拳圣使角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        ...
        self.技能栏[self.技能序号['神圣反击']].基础 = ((self.技能栏[self.技能序号['俯冲腹拳']].基础 * 1.1) + (self.技能栏[self.技能序号['俯冲腹拳']].等级 *
                                          self.技能栏[self.技能序号['俯冲腹拳']].成长 * 1.1) * (1 + self.技能栏[self.技能序号['俯冲腹拳']].TP等级 * 0.1)) * 0.8

        self.技能栏[self.技能序号['刺拳猛击']].攻击次数 += self.技能栏[self.技能序号['刺拳猛击']].TP等级 * 1
        self.技能栏[self.技能序号['刺拳猛击']].基础2 *= 1 + \
            self.技能栏[self.技能序号['刺拳猛击']].TP等级 * 0.1
        self.技能栏[self.技能序号['刺拳猛击']].成长2 *= 1 + \
            self.技能栏[self.技能序号['刺拳猛击']].TP等级 * 0.1
        self.技能栏[self.技能序号['刺拳猛击']].基础3 *= 1 + \
            self.技能栏[self.技能序号['刺拳猛击']].TP等级 * 0.1
        self.技能栏[self.技能序号['刺拳猛击']].成长3 *= 1 + \
            self.技能栏[self.技能序号['刺拳猛击']].TP等级 * 0.1
