...
class 技能22(主动技能):
    ...
    攻击次数2 = 1
    data3 = [int(i*1.085*1.1324*1.1) for i in [0, 72, 80, 87, 94, 102, 109, 116, 124, 131, 138, 146, 153, 160, 168, 175, 182, 190, 197, 204, 212, 219, 226, 234, 241, 249, 256, 263, 271, 278, 285, 293, 300, 307, 315, 322, 329, 337, 344, 351, 359, 366, 373, 381, 388, 395, 403, 410, 417, 425, 432, 439, 447, 454, 461, 469, 476, 483, 491, 498, 505, 513, 520, 527, 535, 542, 549, 557, 564, 571, 579]]
    攻击次数3 = 6
    def 等效百分比(self, 武器类型):
        return (self.data0[self.等级] * self.攻击次数 + self.data1[self.等级] * self.攻击次数2 + self.data3[self.等级] * self.攻击次数3) * (1 + self.TP成长 * self.TP等级) * self.倍率
...
class 技能24(主动技能):
    ...
    攻击次数3 = 1
    # 感电部分待定
    data4 = [int(i*1.085*1.0563*1.1) for i in [0, 38, 42, 46, 49, 53, 57, 61, 65, 69, 72, 76, 80, 84, 88, 92, 96, 99, 103, 107, 111, 115, 119, 122, 126, 130, 134, 138, 142, 145, 149, 153, 157, 161, 165, 169, 172, 176, 180, 184, 188, 192, 195, 199, 203, 207, 211, 215, 218, 222, 226, 230, 234, 238, 242, 245, 249, 253, 257, 261, 265, 268, 272, 276, 280, 284, 288, 291, 295, 299, 303]]
    攻击次数4 = 18
    # 护石加成 = 1
    def 等效百分比(self, 武器类型):
