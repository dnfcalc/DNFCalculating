...
class 极诣·契魔者技能1(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 660, 727, 794, 861, 928, 995, 1062, 1129, 1196, 1263, 1330, 1397, 1464, 1531, 1598, 1665, 1732, 1799, 1866, 1933, 2000, 2067, 2134, 2201, 2268, 2335, 2402, 2469, 2536, 2603, 2670, 2737, 2804, 2870, 2937,
...
class 极诣·契魔者技能2(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 949, 1046, 1142, 1238, 1335, 1431, 1528, 1624, 1720, 1817, 1913, 2009, 2106, 2202, 2299, 2395, 2491, 2588, 2684, 2780, 2877, 2973, 3069, 3166, 3262, 3359, 3455, 3551, 3648, 3744, 3840, 3937, 4033, 4129,
    ...
    data2 = [int(x*1.0) for x in[0, 900, 991, 1082, 1174, 1265, 1356, 1448, 1539, 1631, 1722, 1813, 1905, 1996, 2087, 2179, 2270, 2361, 2453, 2544, 2635, 2727, 2818, 2909, 3001, 3092, 3183, 3275, 3366, 3457, 3549, 3640, 3731, 3823, 3914,
    ...
    data3 = [int(x*1.0) for x in[0, 1182, 1302, 1422, 1542, 1662, 1782, 1902, 2022, 2142, 2261, 2381, 2501, 2621, 2741, 2861, 2981, 3101, 3221, 3341, 3461, 3581, 3701, 3821, 3941, 4061, 4181, 4301, 4421, 4541, 4661, 4780, 4900, 5020, 5140,
...
class 极诣·契魔者技能3(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 2103, 2317, 2530, 2744, 2957, 3170, 3384, 3597, 3811, 4024, 4238, 4451, 4664, 4878, 5091, 5305, 5518, 5732, 5945, 6158, 6372, 6585, 6799, 7012, 7226, 7439, 7652, 7866, 8079, 8293, 8506, 8720, 8933, 9146, 9360, 9573, 9787,
    ...
    data2 = [int(x*1.0) for x in[0, 2837, 3125, 3413, 3701, 3989, 4277, 4565, 4852, 5140, 5428, 5716, 6004, 6292, 6580, 6868, 7156, 7443, 7731, 8019, 8307, 8595, 8883, 9171, 9459, 9747, 10034, 10322, 10610, 10898, 11186, 11474, 11762, 12050, 12338, 12625, 12913,
...
class 极诣·契魔者技能4(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 2083, 2295, 2506, 2717, 2929, 3140, 3351, 3563, 3774, 3986, 4197, 4408, 4620, 4831, 5042, 5254, 5465, 5677, 5888, 6099, 6311, 6522, 6734, 6945, 7156, 7368, 7579, 7790, 8002, 8213, 8425, 8636, 8847, 9059, 9270, 9482, 9693,
    ...
    data2 = [int(x*1.0) for x in[0, 1023, 1126, 1230, 1334, 1438, 1542, 1645, 1749, 1853, 1957, 2061, 2164, 2268, 2372, 2476, 2580, 2683, 2787, 2891, 2995, 3099, 3202, 3306, 3410, 3514, 3618, 3721, 3825, 3929, 4033, 4137, 4240, 4344, 4448,
...
class 极诣·契魔者技能5(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 523, 576, 629, 683, 736, 789, 842, 895, 948, 1001, 1055, 1108, 1161, 1214, 1267, 1320, 1373, 1426, 1480, 1533, 1586, 1639, 1692, 1745, 1798, 1852, 1905, 1958, 2011, 2064, 2117, 2170, 2223, 2277, 2330,
...
class 极诣·契魔者技能7(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 639, 704, 769, 834, 899, 964, 1029, 1094, 1159, 1224, 1289, 1353, 1418, 1483, 1548, 1613, 1678, 1743, 1808, 1873, 1938, 2003, 2067, 2132, 2197, 2262, 2327, 2392, 2457, 2522, 2587, 2652, 2717, 2782, 2846,
    ...
    data2 = [int(x*1.0) for x in[0, 1647, 1814, 1981, 2149, 2316, 2483, 2650, 2817, 2984, 3152, 3319, 3486, 3653, 3820, 3987, 4154, 4322, 4489, 4656, 4823, 4990, 5157, 5325, 5492, 5659, 5826, 5993, 6160, 6327, 6495, 6662, 6829, 6996, 7163, 7330, 7498,
...
class 极诣·契魔者技能8(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 1935, 2131, 2328, 2524, 2720, 2917, 3113, 3309, 3506, 3702, 3898, 4095, 4291, 4488, 4684, 4880, 5077, 5273, 5469, 5666, 5862, 6058, 6255, 6451, 6647, 6844, 7040, 7236, 7433, 7629, 7826, 8022, 8218, 8415, 8611, 8807,
...
class 极诣·契魔者技能9(极诣·契魔者主动技能):
    ...
    # [蛇腹剑 : 破]
    data1 = [int(x*1.0) for x in[0, 815, 945, 1075, 1205, 1335, 1465, 1595, 1726, 1856, 1986, 2116, 2246, 2376, 2506, 2636, 2766, 2896, 3026, 3156, 3286, 3416, 3546, 3676, 3806, 3936, 4066, 4196, 4326, 4456,
    ...
    # [蛇腹剑 : 舞]
    data2 = [int(x*1.0) for x in[0, 1087, 1261, 1434, 1607, 1781, 1954, 2127, 2301, 2474, 2648, 2821, 2994, 3168, 3341, 3515, 3688, 3861, 4035, 4208, 4382, 4555, 4728, 4902, 5075, 5248, 5422, 5595, 5769, 5942, 6115,
    ...
    # [蛇腹剑 : 刺]
    data3 = [int(x*1.0) for x in[0, 1631, 1891, 2151, 2411, 2671, 2931, 3191, 3452, 3712, 3972, 4232, 4492, 4752, 5012, 5272, 5532, 5792, 6052, 6312, 6573, 6833, 7093, 7353, 7613, 7873, 8133, 8393, 8653, 8913, 9173, 9433,
    ...
    # [蛇腹剑 : 灭]
    data4 = [int(x*1.0) for x in[0, 271, 315, 358, 401, 445, 488, 531, 575, 618, 662, 705, 748, 792, 835, 878, 922, 965, 1008, 1052, 1095, 1138, 1182, 1225, 1268, 1312, 1355, 1398, 1442, 1485, 1528, 1572,
    ...
    # [血饮狂舞]
    data5 = [int(x*1.0) for x in[0, 296, 343, 391, 438, 485, 533, 580, 627, 674, 722, 769, 816, 864, 911, 958, 1005, 1053, 1100, 1147, 1195, 1242, 1289, 1336, 1384, 1431, 1478, 1526, 1573, 1620, 1667,
...
class 极诣·契魔者技能10(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 983, 1083, 1183, 1283, 1382, 1482, 1582, 1682, 1782, 1881, 1981, 2081, 2181, 2281, 2380, 2480, 2580, 2680, 2780, 2879, 2979, 3079, 3179, 3278, 3378, 3478, 3578, 3678, 3777, 3877, 3977, 4077, 4177, 4276,
    ...
    data2 = [int(x*1.0) for x in[0, 7730, 8515, 9299, 10083, 10868, 11652, 12436, 13221, 14005, 14789, 15573, 16358, 17142, 17926, 18711, 19495, 20279, 21064, 21848, 22632, 23416, 24201, 24985, 25769, 26554, 27338, 28122, 28907, 29691, 30475, 31259, 32044, 32828, 33612,
    ...
    data3 = [int(x*1.0) for x in[0, 2967, 3268, 3569, 3870, 4171, 4472, 4773, 5074, 5376, 5677, 5978, 6279, 6580, 6881, 7182, 7483, 7784, 8085, 8386, 8687, 8988, 9289, 9590, 9891, 10192, 10494, 10795, 11096, 11397, 11698, 11999, 12300, 12601, 12902, 13203, 13504,
...
class 极诣·契魔者技能12(极诣·契魔者主动技能):
    ...
    倍率 = 1.1  # 三级效果
    CD = 145.0
    data1 = [int(x*1.0) for x in[0, 6948, 8559, 10171, 11782, 13393, 15005, 16616, 18227, 19838, 21450, 23061, 24672, 26283, 27895, 29506, 31117, 32729, 34340, 35951, 37562, 39174, 40785, 42396, 44007, 45619, 47230, 48841, 50453, 52064, 53675, 55286, 56898, 58509, 60120, 61732,
    ...
    data2 = [int(x*1.0) for x in[0, 10690, 13169, 15647, 18126, 20605, 23084, 25563, 28042, 30521, 33000, 35479, 37957, 40436, 42915, 45394, 47873, 50352, 52831, 55310, 57789, 60267, 62746, 65225, 67704, 70183, 72662, 75141, 77620, 80099, 82577, 85056, 87535, 90014, 92493, 94972, 97451, 99930,
    ...
    data3 = [int(x*1.0) for x in[0, 14966, 18436, 21907, 25377, 28848, 32318, 35788, 39259, 42729, 46200, 49670, 53141, 56611, 60082, 63552, 67022, 70493, 73963, 77434, 80904, 84375, 87845, 91315, 94786, 98256, 101727, 105197, 108668, 112138, 115609, 119079, 122549, 126020, 129490, 132961, 136431,
    ...
    data4 = [int(x*1.0) for x in[0, 1679, 2069, 2458, 2848, 3238, 3627, 4017, 4406, 4796, 5185, 5575, 5964, 6354, 6743, 7133, 7522, 7912, 8302, 8691, 9081, 9470, 9860, 10249, 10639, 11028, 11418, 11807, 12197, 12586, 12976, 13366, 13755, 14145, 14534, 14924, 15313,
    ...
    data5 = [int(x*1.0) for x in[0, 0, 0, 0, 0, 0, 2803, 3104, 3405, 3706, 4007, 4308, 4609, 4910, 5211, 5512, 5813, 6114, 6415, 6716, 7017, 7318, 7619, 7920, 8221, 8522, 8823, 9124, 9425, 9726, 10027, 10328, 10629, 10930, 11231, 11532, 11833, 12134,
...
class 极诣·契魔者技能13(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 1302, 1435, 1567, 1699, 1831, 1963, 2095, 2228, 2360, 2492, 2624, 2756, 2888, 3021, 3153, 3285, 3417, 3549, 3681, 3814, 3946, 4078, 4210, 4342, 4474, 4607, 4739, 4871, 5003, 5135, 5267, 5400, 5532, 5664,
    ...
    data2 = [int(x*1.0) for x in[0, 1085, 1195, 1305, 1416, 1526, 1636, 1746, 1856, 1966, 2076, 2187, 2297, 2407, 2517, 2627, 2737, 2847, 2958, 3068, 3178, 3288, 3398, 3508, 3618, 3729, 3839, 3949, 4059, 4169, 4279, 4389, 4500, 4610, 4720,
    ...
    data3 = [int(x*1.0) for x in[0, 6427, 7079, 7731, 8383, 9035, 9687, 10339, 10991, 11643, 12296, 12948, 13600, 14252, 14904, 15556, 16208, 16860, 17512, 18164, 18816, 19468, 20120, 20772, 21424, 22076, 22729, 23381, 24033, 24685, 25337, 25989, 26641, 27293, 27945, 28597,
...
class 极诣·契魔者技能14(极诣·契魔者主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    data1 = [int(x*1.0) for x in[0, 32119, 35377, 38636, 41894, 45153, 48411, 51670, 54928, 58187, 61445, 64704, 67962, 71221, 74479, 77738, 80996, 84255, 87513, 90772, 94030, 97289,
...
class 极诣·契魔者技能16(极诣·契魔者主动技能):
    ...
    基础等级 = 16
    CD = 40.0
    data1 = [int(x*1.0) for x in[0, 51106, 56291, 61476, 66661, 71845, 77030, 82215, 87400, 92584, 97769, 102954, 108139, 113324, 118508, 123693, 128878, 134063, 139247, 144432, 149617, 154802, 159986, 165171, 170356, 175541, 180725, 185910, 191095, 196280, 201464, 206649, 211834, 217019, 222203, 227388,
...
class 极诣·契魔者技能17(极诣·契魔者主动技能):
    ...
    基础等级 = 13
    CD = 45.0
    data1 = [int(x*1.0) for x in[0, 56553, 62292, 68031, 73765, 79503, 85242, 90981, 96716, 102454, 108192, 113931, 119670, 125405, 131143, 136882, 142620, 148355, 154093, 159832, 165571, 171306, 177043, 182782, 188521, 194256, 199995, 205733, 211471, 217210, 222945, 228683, 234422, 240161, 245895, 251634,
...
class 极诣·契魔者技能18(极诣·契魔者主动技能):
    ...
    基础等级 = 5
    CD = 180.0
    data1 = [int(x*1.0) for x in[0, 4288, 5282, 6276, 7271, 8265, 9259, 10254, 11248, 12242, 13237, 14231, 15225, 16220, 17214, 18208, 19203, 20197, 21191, 22186, 23180, 24174, 25169, 26163, 27157, 28151, 29146, 30140, 31134, 32129, 33123, 34117, 35112, 36106, 37100, 38095,
    ...
    data2 = [int(x*1.0) for x in[0, 15892, 19578, 23263, 26948, 30633, 34319, 38004, 41689, 45375, 49060, 52745, 56430, 60116, 63801, 67486, 71172, 74857, 78542, 82227, 85913, 89598, 93283, 96968, 100654, 104339, 108024, 111710, 115395, 119080, 122765, 126451, 130136, 133821, 137507, 141192, 144877,
    ...
    data3 = [int(x*1.0) for x in[0, 59373, 73140, 86908, 100676, 114443, 128211, 141978, 155746, 169514, 183281, 197049, 210817, 224584, 238352, 252120, 265887, 279655, 293423, 307190, 320958, 334726, 348493, 362261, 376029, 389796, 403564, 417332, 431099, 444867, 458635, 472402, 486170, 499938, 513705, 527473,
...
class 极诣·契魔者技能20(极诣·契魔者主动技能):
    ...
    成长 = 11917.40
    CD = 60.0
    data1 = [int(x*1.0) for x in[0, 11746, 12938, 14130, 15321, 16513, 17705, 18896, 20088, 21280, 22472, 23663, 24855, 26047, 27238, 28430, 29622, 30813, 32005, 33197, 34388, 35580, 36772, 37964, 39155, 40347, 41539, 42730, 43922, 45114, 46305, 47497, 48689, 49881, 51072,
    ...
    data2 = [int(x*1.0) for x in[0, 70480, 77630, 84780, 91930, 99081, 106231, 113381, 120531, 127681, 134832, 141982, 149132, 156282, 163432, 170583, 177733, 184883, 192033, 199183, 206333, 213484, 220634, 227784, 234934, 242084, 249235, 256385, 263535, 270685, 277835, 284985, 292136, 299286, 306436, 313586,
...
class 极诣·契魔者技能21(极诣·契魔者主动技能):
    ...
    成长 = 89516.00
    CD = 290.0
    data1 = [int(x*1.0) for x in[0, 10293, 12679, 15066, 17453, 19840, 22227, 24613, 27000, 29387, 31774, 34161, 36547, 38934, 41321, 43708, 46095, 48481, 50868, 53255,
    ...
    data2 = [int(x*1.0) for x in[0, 231594, 285297, 339000, 392703, 446406, 500109, 553812, 607515, 661218, 714921, 768624, 822327, 876030, 929733, 983436, 1037139, 1090842, 1144545, 1198248, 1251952,
