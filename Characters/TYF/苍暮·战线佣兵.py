...
class 技能11(职业主动技能):
    ...
    # 射击攻击力：<data0>%
    data0 = [int(i*1.179) for i in  [0, 478, 524, 573, 622, 671, 720, 767, 815, 864, 913, 962, 1009, 1058, 1106, 1155, 1204, 1251, 1300, 1349, 1397, 1445, 1494, 1542, 1591, 1639, 1687, 1736, 1784, 1833, 1882, 1929, 1978, 2027, 2075, 2124,
    ...
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.179) for i in  [0, 1432, 1576, 1723, 1867, 2012, 2158, 2303, 2449, 2594, 2739, 2885, 3029, 3175, 3320, 3466, 3611, 3757, 3901, 4048, 4192, 4338, 4483, 4629, 4774, 4918, 5064, 5209, 5355, 5499, 5646, 5790, 5937, 6081, 6226, 6372,
    ...
    攻击次数2 = 6
    # 特殊灼伤攻击力：<data2>%
    data2 = [int(i*1.179) for i in  [0, 68, 75, 81, 88, 95, 103, 109, 116, 124, 130, 136, 143, 151, 157, 165, 171, 179, 185, 192, 198, 206, 212, 220, 227, 234, 241, 247, 254, 261, 268, 274, 282, 290, 296,
