...
class 技能4(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 43
    data0 = [(i*1.135*1.198) for i in [0, 573, 631, 688, 746, 805, 863, 921, 978, 1037, 1095, 1153, 1212, 1270, 1327, 1385, 1445, 1502, 1560, 1617, 1676, 1735, 1792, 1851, 1909, 1966, 2025, 2084, 2141, 2199, 2258, 2315, 2374, 2432,
