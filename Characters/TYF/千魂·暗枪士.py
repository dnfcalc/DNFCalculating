...
class 技能1(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 46
    data0 = [(i*1.134*1.197) for i in [0, 1790, 1971, 2153, 2335, 2516, 2698, 2879, 3061, 3244, 3425, 3606, 3787, 3969, 4150, 4333, 4515, 4695, 4877, 5059, 5241, 5423, 5605, 5785, 5967, 6148, 6331, 6513, 6694, 6875, 7056, 7238, 7421, 7602, 7784, 7965,
...
class 技能2(职业主动技能):
    ...
    # 基础 = 1633.33333333333
    # 成长 = 184.666666666667
    data0 = [(i*1.135*1.197) for i in [0, 909, 1002, 1095, 1185, 1278, 1371, 1463, 1555, 1648, 1741, 1832, 1925, 2016, 2109, 2202, 2295, 2386, 2479, 2570, 2663, 2755, 2847, 2940, 3033, 3125, 3216, 3309, 3401, 3494, 3586, 3679, 3771, 3863,
...
class 技能4(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 43
    data0 = [(i*1.135*1.196) for i in [0, 573, 631, 688, 746, 805, 863, 921, 978, 1037, 1095, 1153, 1212, 1270, 1327, 1385, 1445, 1502, 1560, 1617, 1676, 1735, 1792, 1851, 1909, 1966, 2025, 2084, 2141, 2199, 2258, 2315, 2374, 2432,
...
class 技能5(职业主动技能):
    ...
    # 基础 = 4060.68292682927
    # 成长 = 459.317073170732
    data0 = [(i*1.135*1.197) for i in [0, 565, 623, 680, 737, 795, 852, 909, 966, 1025, 1082, 1140, 1197, 1255, 1312, 1369, 1426, 1485, 1542, 1599, 1656, 1714, 1771, 1828, 1885, 1943, 2000, 2057, 2115, 2173, 2230, 2288, 2345, 2403,
...
class 技能6(职业主动技能):
    ...
    基础等级 = 41
    # 魔枪贯穿攻击力：<data0>%
    data0 = [(i*1.138*1.251) for i in [0, 1063, 1171, 1278, 1385, 1494, 1603, 1710, 1817, 1925, 2033, 2141, 2248, 2357, 2465, 2573, 2680, 2788, 2895, 3005, 3112, 3220, 3327, 3435, 3543, 3651, 3759, 3867, 3975, 4083, 4190, 4298, 4405, 4515,
    ...
    # 冲击波攻击力：<data1>%
    data1 = [(i*1.138*1.251) for i in [0, 1586, 1747, 1908, 2069, 2230, 2391, 2552, 2713, 2874, 3035, 3196, 3357, 3518, 3679, 3840, 4001, 4162, 4323, 4484, 4645, 4805, 4966, 5128, 5288, 5450, 5611, 5772, 5933, 6094, 6255, 6415, 6576, 6737, 6899,
...
class 技能8(职业主动技能):
    ...
    基础等级 = 38
    # 黑暗之枪爆炸攻击力：<data0>%
    data0 = [(i*1.107*1.194) for i in [0, 1548, 1705, 1862, 2019, 2177, 2334, 2491, 2647, 2805, 2963, 3119, 3276, 3435, 3591, 3748, 3905, 4062, 4219, 4376, 4533, 4690, 4848, 5005, 5162, 5318, 5476, 5634, 5790, 5947, 6105, 6262, 6419, 6575, 6734,
    ...
    # 黑雷枪爆炸攻击力：<data1>%
    data1 = [(i*1.107*1.194) for i in [0, 2322, 2558, 2794, 3029, 3265, 3501, 3736, 3973, 4208, 4443, 4679, 4915, 5151, 5386, 5622, 5858, 6094, 6329, 6565, 6800, 7035, 7272, 7507, 7743, 7979, 8215, 8451, 8686, 8921, 9157, 9393, 9628, 9865, 10100, 10335,
...
class 技能9(职业主动技能):
    ...
    基础等级 = 38
    # 投掷魔枪攻击力：<data0>%
    data0 = [(i*1.135*1.197) for i in [0, 382, 420, 459, 497, 536, 575, 614, 652, 692, 730, 769, 807, 846, 885, 924, 962, 1001, 1041, 1079, 1118, 1156, 1195, 1234, 1273, 1311, 1349, 1388, 1428, 1466, 1505, 1544, 1583, 1621, 1660,
...
class 技能10(职业主动技能):
    ...
    # 成长 = 645.885714285714
    # 多段攻击力：<data0>% x 20
    data0 = [(i*1.136*1.197) for i in [0, 200, 220, 241, 261, 281, 302, 322, 343, 363, 383, 404, 424, 445, 465, 485, 505, 525, 546, 566, 586, 607, 627, 648, 668, 688, 709, 729, 749, 770, 790, 811, 831, 851, 872, 892,
    ...
    攻击次数 = 20
    # 爆炸攻击力：<data1>%
    data1 = [(i*1.136*1.197) for i in [0, 2349, 2588, 2826, 3065, 3303, 3542, 3781, 4018, 4257, 4495, 4734, 4972, 5211, 5450, 5687, 5926, 6165, 6403, 6641, 6880, 7117, 7356, 7595, 7834, 8072, 8310, 8549, 8786, 9025, 9265, 9502, 9741, 9979, 10218, 10455,
...
class 技能11(职业主动技能):
    ...
    基础等级 = 36
    # 浓缩黑雷攻击力：<data0>%
    data0 = [(i*1.135*1.251) for i in [0, 2194, 2415, 2638, 2861, 3085, 3306, 3529, 3751, 3974, 4196, 4420, 4642, 4865, 5086, 5309, 5532, 5755, 5977, 6200, 6423, 6645, 6867, 7089, 7313, 7535, 7758, 7980, 8203, 8425, 8648, 8871, 9094, 9315, 9538, 9760,
    ...
    # 持续伤害攻击力：<data1>%
    data1 = [(i*1.135*1.251) for i in [0, 548, 604, 659, 715, 770, 826, 881, 937, 993, 1049, 1105, 1160, 1216, 1271, 1327, 1383, 1438, 1494, 1550, 1605, 1661, 1715, 1772, 1828, 1884, 1939, 1995, 2051, 2105, 2162, 2217, 2273, 2328,
...
class 技能12(职业主动技能):
    ...
    TP上限 = 5
    是否有护石 = 1
    data0 = [(i*1.135*1.197) for i in [0, 383, 422, 461, 500, 538, 577, 615, 655, 694, 733, 771, 811, 850, 888, 927, 966, 1005, 1044, 1083, 1123, 1161, 1200, 1238, 1277, 1316, 1355, 1394, 1433, 1473, 1511, 1550, 1588, 1628, 1666,
...
class 技能13(职业主动技能):
    ...
    # 被动倍率 = 1.2
    # 贯穿攻击力：<data0>%
    data0 = [(i*1.135*1.197) for i in [0, 4958, 5460, 5964, 6466, 6970, 7472, 7975, 8479, 8981, 9485, 9987, 10491, 10993, 11496, 11999, 12503, 13005, 13508, 14012, 14515, 15017, 15520, 16024, 16527, 17029, 17532, 18035, 18539, 19041, 19545, 20047, 20551, 21053, 21556,
    ...
    # 冲击波攻击力：<data1>%
    data1 = [(i*1.135*1.197) for i in [0, 3493, 3847, 4201, 4555, 4910, 5265, 5618, 5973, 6327, 6682, 7035, 7390, 7745, 8100, 8453, 8807, 9163, 9517, 9870, 10225, 10580, 10935, 11289, 11643, 11997, 12352, 12706, 13060, 13415, 13769, 14124, 14477, 14832, 15186,
    ...
    攻击次数2 = 1
    # 爆炸攻击力：<data2>%
    data2 = [(i*1.135*1.197) for i in [0, 5313, 5853, 6392, 6930, 7470, 8008, 8548, 9086, 9625, 10165, 10704, 11244, 11782, 12322, 12860, 13399, 13938, 14477, 15017, 15555, 16095, 16634, 17173, 17711, 18251, 18791, 19329, 19868, 20407, 20946, 21485, 22025, 22563, 23103,
...
class 技能15(职业主动技能):
    ...
    基础等级 = 12
    # 黑暗之枪攻击力：<data0>% x 15
    data0 = [(i*1.135*1.197) for i in [0, 1258, 1551, 1844, 2135, 2427, 2719, 3012, 3303, 3595, 3887, 4180, 4471, 4764, 5055, 5348, 5639, 5932, 6224, 6516, 6807, 7100, 7392, 7684, 7975, 8268, 8559, 8852, 9144, 9436, 9727, 10020, 10312, 10605, 10895, 11188,
    ...
    data1 = [(i*1.135*1.197) for i in [0, 2308, 2845, 3379, 3914, 4450, 4985, 5521, 6056, 6592, 7127, 7662, 8198, 8733, 9269, 9804, 10340, 10875, 11410, 11945, 12481, 13016, 13552, 14087, 14623, 15157, 15694, 16228, 16765, 17299, 17835, 18370, 18905, 19441, 19976,
...
class 技能16(职业主动技能):
    ...
    等级上限 = 40
    基础等级 = 23
    data0 = [(i*1.135*1.197) for i in [0, 14655, 16143, 17629, 19115, 20604, 22090, 23576, 25065, 26551, 28037, 29525, 31011, 32497, 33985, 35472, 36958, 38446, 39933, 41419, 42905, 44393, 45879, 47366, 48854, 50340, 51826, 53315, 54801, 56287, 57775, 59261, 60748, 62235, 63722,
...
class 技能17(职业主动技能):
    ...
    # 被动倍率 = 1.2
    # 巨大魔枪攻击力：<data0>%
    data0 = [(i*1.135*1.197) for i in [0, 4566, 5028, 5492, 5955, 6419, 6881, 7345, 7808, 8272, 8734, 9197, 9661, 10125, 10588, 11050, 11514, 11977, 12441, 12903, 13366, 13830, 14294, 14756, 15219, 15683, 16146, 16609, 17072, 17535, 17999, 18463, 18925, 19388, 19852,
    ...
    # 小型魔枪攻击力：<data1>%
    data1 = [(i*1.135*1.197) for i in [0, 1141, 1257, 1373, 1489, 1605, 1719, 1835, 1951, 2067, 2183, 2299, 2415, 2531, 2646, 2763, 2878, 2994, 3110, 3225, 3342, 3457, 3574, 3688, 3804, 3920, 4035, 4152, 4267, 4384, 4499, 4615, 4731, 4847,
    ...
    攻击次数2 = 10
    # 爆炸攻击力：<data2>%
    data2 = [(i*1.135*1.197) for i in [0, 6420, 7071, 7722, 8374, 9025, 9676, 10327, 10979, 11630, 12282, 12933, 13585, 14235, 14887, 15538, 16188, 16841, 17491, 18144, 18794, 19446, 20096, 20749, 21399, 22052, 22702, 23353, 24005, 24655, 25307, 25958, 26610, 27261,
...
class 技能19(职业主动技能):
    ...
    等级上限 = 40
    基础等级 = 16
    data0 = [(i*1.135*1.197) for i in [0, 1817, 2003, 2186, 2371, 2555, 2740, 2925, 3109, 3294, 3477, 3663, 3847, 4031, 4216, 4400, 4585, 4770, 4954, 5138, 5322, 5507, 5692, 5875, 6061, 6245, 6429, 6615, 6798, 6983, 7166, 7352, 7536, 7720, 7905, 8089,
...
class 技能20(职业主动技能):
    ...
    # 被动倍率 = 1.2
    # 黑暗气息攻击力：<data0>%
    data0 = [(i*1.135*1.197) for i in [0, 4161, 4584, 5006, 5427, 5850, 6273, 6694, 7116, 7539, 7962, 8383, 8805, 9228, 9649, 10072, 10495, 10917, 11338, 11761, 12184, 12605, 13027, 13450, 13872, 14294, 14716, 15139, 15561, 15983, 16405, 16827, 17249, 17672, 18094,
    ...
    data1 = [(i*1.135*1.197) for i in [0, 2184, 2406, 2627, 2849, 3071, 3293, 3514, 3736, 3957, 4180, 4401, 4622, 4845, 5065, 5287, 5509, 5731, 5953, 6175, 6395, 6618, 6839, 7060, 7283, 7504, 7726, 7947, 8168, 8391, 8612, 8835, 9055, 9277, 9499, 9721,
    ...
    攻击次数2 = 8
    # 爆炸攻击力：<data2>%
    data2 = [(i*1.135*1.197) for i in [0, 19976, 22002, 24028, 26055, 28082, 30109, 32135, 34162, 36188, 38215, 40242, 42267, 44295, 46321, 48348, 50374, 52401, 54427, 56455, 58481, 60506, 62534, 64560, 66587, 68614, 70640, 72666, 74694, 76720, 78745, 80773, 82799, 84826, 86853, 88880,
...
class 技能21(职业主动技能):
    ...
    基础等级 = 5
    # 黑暗气息攻击力：<data0>%
    data0 = [(i*1.135*1.197) for i in [0, 4295, 5289, 6285, 7282, 8277, 9274, 10270, 11265, 12261, 13256, 14253, 15249, 16244, 17240, 18235, 19232, 20228, 21223, 22219, 23215, 24211, 25207, 26203, 27198, 28194, 29190, 30186, 31182, 32177, 33173, 34169, 35165, 36161,
    ...
    # 爆炸攻击力：<data1>% 暗雷系
    data1 = [(i*1.135*1.197) for i in [0, 81595, 100517, 119438, 138358, 157280, 176200, 195122, 214042, 232964, 251885, 270805, 289726, 308647, 327568, 346490, 365410, 384331, 403252, 422173, 441094, 460015, 478936, 497856, 516778, 535698, 554620, 573540, 592462, 611382, 630304, 649225, 668145, 687066, 705986, 724908,
...
class 技能24(职业主动技能):
    ...
    基础等级 = 2
    # 暗蚀之枪
    基础 = 7776.27186064668*1.162
    成长 = 2347.72813935332*1.162
    攻击次数 = 12
    # 暗雷系
    # 黑雷之枪
    基础2 = 17497.4610988877*1.162
    成长2 = 5282.53890111227*1.162
    攻击次数2 = 8
    CD = 290.0
    关联技能 = ['无']
