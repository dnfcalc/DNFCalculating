...
class 技能1(主动技能):
    ...
    等级精通 = 50
    基础等级 = min(int((等级 - 所在等级) / 学习间隔), 等级精通) + 1
    data1 = [int(i*1.0) for i in [0, 162, 179, 195, 212, 228, 245, 261, 278, 293, 311, 328, 343, 359, 376, 393, 410, 425, 442, 459, 475, 491, 508, 524, 541, 558, 573, 590, 607, 623, 639, 656, 673, 689, 706, 721, 739, 755, 771, 788, 805, 820, 837, 854, 869, 886, 903, 920, 936, 952, 968, 986, 1002, 1017, 1034, 1052, 1067, 1084, 1100, 1117, 1133, 1149, 1167, 1183, 1198, 1215, 1233, 1248, 1264, 1281, 1298]]
    攻击次数1 = 10
    data2 = [int(i*1.0) for i in [0, 162, 179, 195, 212, 228, 245, 261, 278, 293, 311, 328, 343, 359, 376, 393, 410, 425, 442, 459, 475, 491, 508, 524, 541, 558, 573, 590, 607, 623, 639, 656, 673, 689, 706, 721, 739, 755, 771, 788, 805, 820, 837, 854, 869, 886, 903, 920, 936, 952, 968, 986, 1002, 1017, 1034, 1052, 1067, 1084, 1100, 1117, 1133, 1149, 1167, 1183, 1198, 1215, 1233, 1248, 1264, 1281, 1298]]
    攻击次数2 = 10*2
    攻击倍率2 = 0.5
    data3 = [int(i*1.0) for i in [0, 162, 179, 195, 212, 228, 245, 261, 278, 293, 311, 328, 343, 359, 376, 393, 410, 425, 442, 459, 475, 491, 508, 524, 541, 558, 573, 590, 607, 623, 639, 656, 673, 689, 706, 721, 739, 755, 771, 788, 805, 820, 837, 854, 869, 886, 903, 920, 936, 952, 968, 986, 1002, 1017, 1034, 1052, 1067, 1084, 1100, 1117, 1133, 1149, 1167, 1183, 1198, 1215, 1233, 1248, 1264, 1281, 1298]]
    攻击次数3 = 10
    攻击倍率3 = 0.3
    攻击倍率 = 1.0
    CD = 12.0
...
class 技能7(主动技能):
    ...
    等级精通 = 50
    基础等级 = min(int((等级 - 所在等级) / 学习间隔), 等级精通) + 1
    data1 = [int(i*1.0) for i in [0, 228, 249, 276, 296, 319, 342, 366, 389, 412, 436, 457, 483, 504, 527, 549, 574, 598, 619, 645, 666, 690, 712, 735, 759, 782, 806, 827, 853, 874, 898, 918, 941, 966, 988, 1012, 1034, 1059, 1081, 1105, 1128, 1151, 1175, 1195, 1221, 1242, 1266, 1289, 1312, 1336, 1358, 1382, 1404, 1429, 1451, 1475, 1498, 1521, 1545, 1567, 1591, 1610, 1638, 1658, 1681, 1704, 1728, 1751, 1773, 1797, 1820]]  # 地面爆炸
    攻击次数1 = 1
...
class 技能11(主动技能):
    ...
    等级精通 = 50
    基础等级 = min(int((等级 - 所在等级) / 学习间隔), 等级精通) + 1
    data1 = [int(i*1.0) for i in [0, 455, 500, 548, 594, 639, 685, 730, 778, 824, 869, 916, 962, 1008, 1054, 1100, 1147, 1192, 1239, 1284, 1330, 1379, 1424, 1470, 1515, 1561, 1608, 1655, 1699, 1747, 1792, 1838, 1884, 1931, 1977, 2023, 2068, 2115, 2160, 2207, 2255, 2299, 2346, 2391, 2438, 2484, 2530, 2576, 2623, 2668, 2714, 2759, 2808, 2853, 2899, 2946, 2991, 3037, 3084, 3130, 3176, 3222, 3267, 3315, 3360, 3407, 3452, 3499, 3544, 3590, 3637]]
    攻击次数1 = 8
    data2 = [int(i*1.0) for i in [0, 138, 150, 164, 178, 191, 205, 219, 234, 247, 261, 274, 289, 303, 316, 330, 344, 358, 371, 385, 400, 413, 427, 440, 455, 469, 481, 496, 510, 525, 539, 551, 566, 579, 594, 606, 621, 634, 649, 663, 675, 691, 703, 718, 730, 746, 759, 772, 787, 800, 815, 828, 842, 856, 869, 883, 896, 911, 925, 940, 952, 966, 981, 995, 1008, 1022, 1036, 1050, 1064, 1077, 1092]]
    攻击次数2 = 25
    data3 = [int(i*1.0) for i in [0, 3752, 4132, 4511, 4892, 5272, 5653, 6033, 6414, 6794, 7174, 7554, 7936, 8317, 8698, 9077, 9458, 9837, 10219, 10599, 10980, 11360, 11740, 12121, 12503, 12882, 13262, 13643, 14023, 14404, 14785, 15166, 15546, 15926, 16305, 16685, 17067, 17449, 17829, 18210, 18589, 18969, 19350, 19730, 20111, 20491, 20872, 21251, 21633, 22014, 22395, 22775, 23155, 23535, 23917, 24296, 24677, 25057, 25437, 25818, 26200, 26580, 26959, 27340, 27720, 28101, 28482, 28863, 29243, 29624, 30003]]
    攻击次数3 = 1
    # CD = 33.6
    CD = 40
    攻击倍率 = 1.0
...
class 技能19(主动技能):
    ...
    等级精通 = 30
    基础等级 = min(int((等级 - 所在等级) / 学习间隔), 等级精通) + 1
    data1 = [int(i*1.0) for i in [0, 2406, 2555, 2705, 2853, 3002, 3150, 3300, 3449, 3598, 3747, 3895, 4044, 4193, 4343, 4491, 4641, 4789, 4938, 5087, 5236, 5385, 5534, 5682, 5832, 5981, 6130, 6279, 6428, 6576, 6725, 6874, 7023, 7173, 7320, 7470, 7619, 7768, 7917, 8066, 8214, 8363, 8513, 8661, 8811, 8960, 9108, 9257, 9406, 9556, 9704, 9854, 10001, 10151, 10299, 10449, 10599, 10747, 10896, 11044, 11194, 11342, 11492, 11642, 11789, 11939, 12087, 12237, 12385, 12535, 12682]]
    攻击次数1 = 1
    data2 = [int(i*1.0) for i in [0, 2490, 2718, 2949, 3177, 3407, 3635, 3864, 4094, 4323, 4552, 4781, 5010, 5240, 5469, 5698, 5927, 6156, 6386, 6615, 6843, 7073, 7301, 7532, 7760, 7989, 8218, 8447, 8677, 8906, 9135, 9363, 9593, 9822, 10052, 10280, 10510, 10738, 10969, 11197, 11427, 11655, 11885, 12114, 12344, 12572, 12801, 13030, 13260, 13489, 13718, 13947, 14175, 14406, 14634, 14864, 15092, 15321, 15551, 15780, 16009, 16238, 16467, 16697, 16926, 17155, 17384, 17613, 17843, 18072, 18300]]
    攻击次数2 = 10
    data3 = [int(i*1.0) for i in [0, 389, 449, 510, 568, 628, 689, 747, 807, 866, 926, 986, 1045, 1105, 1163, 1224, 1284, 1342, 1403, 1463, 1521, 1582, 1640, 1700, 1761, 1819, 1879, 1940, 1998, 2058, 2118, 2177, 2237, 2296, 2356, 2415, 2475, 2535, 2593, 2654, 2714, 2772, 2833, 2892, 2951, 3012, 3070, 3130, 3191, 3249, 3309, 3369, 3428, 3488, 3548, 3607, 3666, 3726, 3786, 3845, 3905, 3965, 4023, 4084, 4143, 4202, 4263, 4322, 4381, 4442, 4501]]
    攻击次数3 = 22
    攻击倍率 = 1.0
    CD = 43
    是否有护石 = 1
...
class 技能20(主动技能):
    ...
    等级精通 = 30
    基础等级 = min(int((等级 - 所在等级) / 学习间隔), 等级精通) + 1
    data1 = [int(i*1.0) for i in [0, 3245, 3573, 3903, 4232, 4562, 4891, 5219, 5549, 5878, 6208, 6537, 6865, 7195, 7525, 7854, 8182, 8512, 8840, 9171, 9500, 9828, 10158, 10487, 10817, 11145, 11474, 11803, 12133, 12461, 12791, 13121, 13449, 13779, 14108, 14437, 14766, 15096, 15424, 15754, 16083, 16412, 16742, 17070, 17400, 17729, 18058, 18387, 18717, 19046, 19375, 19705, 20032, 20363, 20692, 21021, 21351, 21679, 22009, 22338, 22667, 22995, 23325, 23654, 23984, 24314, 24641, 24971, 25301, 25630, 25958]]
    攻击次数1 = 2
    data2 = [int(i*1.0) for i in [0, 3454, 3805, 4155, 4505, 4857, 5207, 5558, 5908, 6258, 6609, 6959, 7309, 7660, 8010, 8361, 8711, 9061, 9413, 9762, 10112, 10463, 10814, 11165, 11514, 11864, 12216, 12566, 12917, 13267, 13617, 13969, 14319, 14670, 15019, 15370, 15721, 16071, 16420, 16772, 17122, 17472, 17823, 18173, 18524, 18874, 19224, 19575, 19925, 20275, 20626, 20976, 21328, 21678, 22028, 22379, 22729, 23081, 23430, 23780, 24131, 24482, 24833, 25182, 25532, 25884, 26234, 26584, 26933, 27285, 27635]]
    攻击次数2 = 8
    攻击倍率 = 1.06 # 者皆阵倍率
    # 攻击倍率 = 1.03  # 临兵斗倍率
    CD = 51
...
class 技能25(主动技能):
    ...
    data1 = [int(i*1.0) for i in [0, 5932, 7308, 8683, 10059, 11434, 12810, 14185, 15561, 16937, 18312, 19688, 21063, 22439, 23814, 25190, 26565, 27941, 29317, 30692, 32068, 33443, 34819, 36194, 37570, 38945, 40321, 41697, 43072, 44448, 45823, 47199, 48574, 49950, 51325, 52701, 54077, 55452, 56828, 58203, 59579, 60954, 62330, 63706, 65081, 66457, 67832, 69208, 70583, 71959, 73334, 74710, 76086, 77461, 78837, 80212, 81588, 82963, 84339, 85714, 87090, 88466, 89841, 91217, 92592, 93968, 95343, 96719, 98094, 99470, 100846]]
    data2 = [int(i*1.0) for i in [0, 7627, 9396, 11164, 12933, 14701, 16470, 18238, 20007, 21776, 23544, 25313, 27081, 28850, 30618, 32387, 34156, 35924, 37693, 39461, 41230, 42998, 44767, 46536, 48304, 50073, 51841, 53610, 55378, 57147, 58916, 60684, 62453, 64221, 65990, 67758, 69527, 71296, 73064, 74833, 76601, 78370, 80139, 81907, 83676, 85444, 87213, 88981, 90750, 92519, 94287, 96056, 97824, 99593, 101361, 103130, 104899, 106667, 108436, 110204, 111973, 113741, 115510, 117279, 119047, 120816, 122584, 124353, 126121, 127890, 129659]]
    data3 = [int(i*1.0) for i in [0, 177963, 219230, 260496, 301763, 343030, 384296, 425563, 466830, 508097, 549363, 590630, 631897, 673164, 714430, 755697, 796964, 838230, 879497, 920764, 962031, 1003297, 1044564, 1085831, 1127098, 1168364, 1209631, 1250898, 1292165, 1333431, 1374698, 1415965, 1457231, 1498498, 1539765, 1581032, 1622298, 1663565, 1704832, 1746099, 1787365, 1828632, 1869899, 1911165, 1952432, 1993699, 2034966, 2076232, 2117499, 2158766, 2200033, 2241299, 2282566, 2323833, 2365100, 2406366, 2447633, 2488900, 2530166, 2571433, 2612700, 2653967, 2695233, 2736500, 2777767, 2819034, 2860300, 2901567, 2942834, 2984100, 3025367]]
