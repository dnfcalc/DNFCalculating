...
class 极诣·狂战士技能4(主动技能):
    ...
    等级精通 = 50
    基础等级 = min(int((极诣·狂战士等级 - 所在等级) / 学习间隔) + 1, 等级精通)
    数据 = [0, 1893, 2085, 2277, 2469, 2662, 2854, 3046, 3238, 3430, 3622, 3814, 4006, 4198, 4391, 4583, 4775, 4967, 5159, 5351, 5543, 5735, 5927, 6120, 6312, 6504, 6696, 6888, 7080, 7272, 7464, 7656, 7848, 8041, 8233, 8425, 8617, 8809,
