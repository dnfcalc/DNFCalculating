...
class 技能0(职业主动技能):
    ...
    data0=[(1+1.1244)*x for x in data0]
...
class 技能11(职业主动技能):
    ...
    data0=[1.3*x for x in data0]
    data1=[1.3*x for x in data1]
...
class 技能15(职业主动技能):
    ...
    data0=[1.172*x for x in data0]
    data1=[1.172*x for x in data1]
