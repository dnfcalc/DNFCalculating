...
class 技能0(职业主动技能):
    ...
    data0=[(1+1.1244)*x*1.085 for x in data0]
...
class 技能1(职业主动技能):
    ...
    data0=[1.213*1.085*x for x in data0]
...
class 技能2(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 48
    data0 = [int(i*1.085) for i in [0, 78, 89, 100, 111, 124, 135, 146, 158, 169, 180, 193, 204, 215, 226, 238, 249, 260, 273, 284, 295, 307, 318, 329, 341, 353, 364, 375, 387, 398, 410, 422, 433, 444, 455, 467, 479, 490, 502, 513, 524, 536, 548, 559, 570, 582, 593, 604, 617, 628, 639, 651, 662, 673, 684, 697, 708, 719, 731, 742, 754, 766, 777, 788, 799, 811, 823, 834, 844, 856, 867]]
...
class 技能3(职业主动技能):
    ...
    data0=[1.101*1.085*x for x in data0]
...
class 技能6(职业主动技能):
    ...
    data0=[1.153*1.085*x for x in data0]
...
class 技能7(职业主动技能):
    ...
    data0=[1.19*1.085*x for x in data0]
    攻击次数 = 1
...
class 技能8(职业主动技能):
    ...
    data0=[1.13*1.085 *x for x in data0]
...
class 技能11(职业主动技能):
    ...
    data0=[1.3*1.085*x for x in data0]
    data1=[1.3*1.085*x for x in data1]
...
class 技能15(职业主动技能):
    ...
    data0=[1.172*1.085*x for x in data0]
    data1=[1.172*1.085*x for x in data1]
...
class 技能16(职业主动技能):
    ...
    data0=[1.15*1.085*x for x in data0]
