...
class 技能12(职业主动技能):
    ...
    基础等级 = 18
    # 横扫地面攻击力：<data0>%
    data0 = [int(i*1.184) for i in [0, 2863, 3153, 3444, 3734, 4025, 4315, 4606, 4896, 5187, 5477, 5768, 6059, 6349, 6640, 6930, 7221, 7511, 7802, 8092, 8383, 8673, 8964, 9254, 9544, 9835, 10125,
    ...
    攻击次数 = 1
    # 寸劲攻击力：<data1>%
    data1 = [int(i*1.184) for i in [0, 5939, 6541, 7144, 7747, 8349, 8951, 9554, 10157, 10759, 11362, 11964, 12567, 13169, 13772, 14375, 14977, 15579, 16182, 16785, 17387, 17990, 18592, 19195, 19797, 20400,
    ...
    攻击次数2 = 1
    # 正拳攻击力：<data2>%
    data2 = [int(i*1.184) for i in [0, 8820, 9715, 10610, 11505, 12399, 13295, 14189, 15084, 15978, 16874, 17768, 18663, 19559, 20453, 21348, 22242, 23138, 24032, 24927, 25822, 26717, 27612, 28506, 29402,
    ...
    攻击次数3 = 1
    # 环绕攻击力：<data3>%
    data3 = [int(i*1.184) for i in [0, 11571, 12745, 13920, 15094, 16268, 17441, 18615, 19789, 20963, 22137, 23311, 24485, 25659, 26833, 28007, 29181, 30355, 31529, 32703, 33877, 35050, 36224, 37399, 38573,
