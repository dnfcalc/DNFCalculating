...
class 极诣·流浪武士技能4(主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    数据 = [0, 3928, 4331, 4714, 5118, 5520, 5912, 6314, 6718, 7120, 7511, 7913, 8306, 8700, 9102, 9504, 9897, 10300, 10702, 11104, 11490, 11889, 12292, 12686, 13087, 13489, 13882, 14285, 14685, 15068, 15473, 15875, 16278, 16669, 17073, 17474, 17867,
...
class 极诣·流浪武士技能5(主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    数据 = [0, 1191, 1311, 1432, 1552, 1674, 1794, 1915, 2036, 2157, 2277, 2398, 2520, 2640, 2761, 2881, 3003, 3123, 3244, 3365, 3486, 3606, 3727, 3848, 3969, 4089, 4211, 4332, 4452, 4573, 4694, 4815, 4935, 5057, 5177,
...
class 极诣·流浪武士技能8(主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    数据 = [0, 6371, 7014, 7661, 8307, 8954, 9600, 10248, 10893, 11542, 12186, 12833, 13478, 14126, 14770, 15418, 16061, 16711, 17354, 18006, 18650, 19295, 19942, 20588, 21235, 21878, 22527, 23169, 23817, 24462, 25112, 25757, 26405, 27048, 27696, 28340,
...
class 极诣·流浪武士技能9(主动技能):
    ...
    TP成长 = 0.10
    TP上限 = 5
    数据 = [0, 838, 927, 1016, 1096, 1184, 1273, 1362, 1444, 1533, 1622, 1708, 1789, 1876, 1967, 2053, 2139, 2229, 2312, 2401, 2487, 2575, 2659, 2747, 2838, 2923, 3004, 3094, 3183, 3268, 3355, 3445, 3528, 3615, 3702, 3791,
    ...
    def 等效百分比(self, 武器类型):
        # 攻击次数为10
        return self.数据[self.等级] * (1 + self.TP成长 * self.TP等级) * self.倍率 * 10
...
class 极诣·流浪武士技能14(主动技能):
    ...
    基础等级 = 12
    CD = 145
    data1 = [0, 6249, 7698, 9147, 10596, 12045, 13495, 14943, 16392, 17841, 19290, 20740, 22188, 23637, 25086, 26536, 27985, 29433, 30882, 32331,
    ...
    data2 = [0, 960, 1184, 1406, 1630, 1853, 2075, 2297, 2522, 2744, 2967, 3190, 3413, 3636, 3858, 4082, 4305, 4527, 4751, 4974,
             5196, 5419, 5643, 5865, 6088, 6312, 6534, 6758, 6980, 7203, 7425, 7649, 7871, 8094, 8318, 8540, 8762, 8987, 9209, 9431, 9656]
    data3 = [0, 39767, 48987, 58209, 67431, 76652, 85873, 95095, 104316, 124891, 135036, 145178, 155322, 165466, 175609, 185753, 195895, 206040, 216182, 226326, 236471,
...
class 极诣·流浪武士技能18(主动技能):
    ...
    基础等级 = 13
    CD = 45.0
    数据 = [0, 64519, 71064, 77606, 84153, 90698, 97245, 103790, 110336, 116880, 123428, 129972, 136519, 143063, 149607, 156153, 162700, 169244, 175792, 182334, 188881, 195427, 201972, 208519, 215064, 221607, 228153, 234698, 241246, 247789, 254336, 260880, 267428, 273972, 280519, 287062,
...
class 极诣·流浪武士技能19(主动技能):
    ...
    基础等级 = 5
    CD = 180.0
    data1 = [0, 3322, 4092, 4862, 5633, 6403, 7173, 7944, 8711, 9483, 10254, 11024, 11793, 12563, 13335, 14105, 14873, 15646, 16413, 17184, 17956, 18724, 19496, 20267, 21033, 21806, 22576, 23345, 24116, 24886, 25657, 26426, 27196, 27966, 28737, 29508,
    ...
    data2 = [0, 69749, 85921, 102096, 118267, 134441, 150617, 166789, 182963, 199135, 215308, 231483, 247656, 263830, 280002, 296178, 312352, 328523, 344698, 360870, 377046, 393217, 409391, 425565, 441739, 457912, 474085, 490260, 506434, 522604, 538781, 554953, 571125, 587298, 603473, 619648,
...
class 极诣·流浪武士技能21(主动技能):
    ...
    基础等级 = 2
    CD = 290.0
    数据 = [0, 384840, 474079, 563317, 652556, 741794, 831033, 920271, 1009510, 1098748, 1187987, 1277225, 1366464, 1455702, 1544941, 1634179, 1723418, 1812656, 1901895, 1991133, 2080372,
