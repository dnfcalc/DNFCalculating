...
class 皓曦·混沌魔灵(角色窗口):
    ...
    def 界面(self):
        ...
        self.职业存档.append(('第二次魔灵炸弹引爆的战士选择', self.第二次魔灵炸弹引爆的战士选择, 1))
        self.职业存档.append(('黑暗冲击战士冲击波个数选择', self.黑暗冲击战士冲击波个数选择, 1))
        self.职业存档.append(('绽放·终章战士黑炎个数选择', self.绽放·终章战士黑炎个数选择择, 1))
