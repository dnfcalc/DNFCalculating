...
class 技能0(被动技能):
    ...
    等级上限 = 20
    基础等级 = 10
    冷却关联技能 = ['神光冲击','神光连斩','圣盾突击','神光喷涌','神光盾击','烈光','神光闪耀','神光闪影击','神罚之锤','神光之跃','圣盾裁决','破晓之光','神光回旋斩','神圣信约','超越之之光']
...
class 技能6(职业主动技能):
    ...
    # 成长 = 311.3
    #攻击力：<data0>% X 4
    data0 = [(i*1.0/1.126*1.134) for i in [0, 767, 844, 922, 1000, 1078, 1156, 1234, 1311, 1389, 1467, 1545, 1623, 1700, 1778, 1856, 1934, 2012, 2090, 2167, 2245, 2323, 2401, 2479, 2556, 2634, 2712, 2790, 2868, 2946, 3023, 3101, 3179, 3257, 3335, 3413, 3490, 3568, 3646, 3724, 3802, 3879, 3957, 4035, 4113, 4191, 4269, 4346, 4424, 4502, 4580, 4658, 4736, 4813, 4891, 4969, 5047, 5125, 5202, 5280, 5358]]
    攻击次数 = 4
    CD = 6
    TP成长 = 0.10
    TP上限 = 5
...
class 技能7(职业主动技能):
    ...
    # 成长 = 503.1
    #锤击攻击力：<data0>%
    data0 = [(i*1.0*1.05) for i in [0, 991, 1092, 1192, 1293, 1394, 1494, 1595, 1695, 1796, 1897, 1997, 2098, 2199, 2299, 2400, 2500, 2601, 2702, 2802, 2903, 3003, 3104, 3205, 3305, 3406, 3506, 3607, 3708, 3808, 3909, 4009, 4110, 4211, 4311, 4412, 4512, 4613, 4714, 4814, 4915, 5016, 5116, 5217, 5317, 5418, 5519, 5619, 5720, 5820, 5921, 6022, 6122, 6223, 6323, 6424, 6525, 6625, 6726, 6826, 6927]]
    #喷涌的神光攻击力：<data1>% X 4
    data1 = [(i*1.0*1.05) for i in [0, 991, 1092, 1192, 1293, 1394, 1494, 1595, 1695, 1796, 1897, 1997, 2098, 2199, 2299, 2400, 2500, 2601, 2702, 2802, 2903, 3003, 3104, 3205, 3305, 3406, 3506, 3607, 3708, 3808, 3909, 4009, 4110, 4211, 4311, 4412, 4512, 4613, 4714, 4814, 4915, 5016, 5116, 5217, 5317, 5418, 5519, 5619, 5720, 5820, 5921, 6022, 6122, 6223, 6323, 6424, 6525, 6625, 6726, 6826, 6927]]
    攻击次数2 = 4
    CD = 8
    TP成长 = 0.10
    TP上限 = 5
...
class 技能10(职业主动技能):
    ...
    # 成长 = 882.7
    #多段攻击力：<data0>% X 10
    data0 = [(i*1.0*1.108) for i in [0, 609, 671, 732, 795, 856, 918, 980, 1041, 1104, 1165, 1227, 1289, 1350, 1413, 1474, 1536, 1598, 1659, 1722, 1783, 1845, 1907, 1968, 2031, 2092, 2154, 2216, 2277, 2340, 2401, 2463, 2525, 2586, 2649, 2710, 2772, 2834, 2895, 2958, 3019, 3081, 3143, 3204, 3267, 3328, 3390, 3452, 3513, 3576, 3637, 3699, 3761, 3822, 3885, 3946, 4008, 4070, 4131, 4194, 4255]]
    攻击次数 = 10
    #最后一击攻击力：<data1>%
    data1 = [(i*1.0*1.108) for i in [0, 2609, 2875, 3139, 3404, 3670, 3935, 4199, 4463, 4729, 4993, 5258, 5524, 5788, 6053, 6317, 6583, 6847, 7112, 7378, 7642, 7906, 8171, 8437, 8701, 8966, 9232, 9496, 9760, 10024, 10291, 10555, 10820, 11086, 11350, 11614, 11878, 12144, 12409, 12674, 12940, 13204, 13468, 13732, 13998, 14263, 14528, 14794, 15058, 15322, 15586, 15852, 16117, 16381, 16648, 16912, 17176, 17440, 17706, 17971, 18235]]
    攻击次数2 = 1
    CD = 16
    TP成长 = 0.10
    TP上限 = 5
...
class 技能11(职业主动技能):
    ...
    # 基础 = 10235.5
    # 成长 = 1155.5
    data0 = [(i*1.0/1.125*1.134) for i in [0, 526, 579, 632, 686, 739, 792, 846, 899, 952, 1006, 1059, 1113, 1166, 1219, 1273, 1326, 1379, 1433, 1486, 1539, 1593, 1646, 1700, 1753, 1806, 1860, 1913, 1966, 2020, 2073, 2126, 2180, 2233, 2287, 2340, 2393, 2447, 2500, 2553, 2607, 2660, 2713, 2767, 2820, 2874, 2927, 2980, 3034, 3087, 3140, 3194, 3247, 3301, 3354, 3407, 3461, 3514, 3567, 3621, 3674]]
    攻击次数 = 15
    data1 = [(i*1.0/1.125*1.134) for i in [0, 3501, 3856, 4211, 4566, 4921, 5277, 5632, 5987, 6342, 6697, 7053, 7408, 7763, 8118, 8473, 8829, 9184, 9539, 9894, 10249, 10604, 10960, 11315, 11670, 12025, 12380, 12736, 13091, 13446, 13801, 14156, 14512, 14867, 15222, 15577, 15932, 16287, 16643, 16998, 17353, 17708, 18063, 18419, 18774, 19129, 19484, 19839, 20195, 20550, 20905, 21260, 21615, 21971, 22326, 22681, 23036, 23391, 23746, 24102, 24457]]
    攻击次数2 = 1
    CD = 20
    TP成长 = 0.10
    TP上限 = 5
...
class 技能12(职业主动技能):
    ...
    # 基础 = 11383.6
    # 成长 = 1285.4
    data0 = [(i*1.0/1.126*1.134) for i in [0, 12669, 13955, 15240, 16526, 17811, 19096, 20382, 21667, 22952, 24238, 25523, 26808, 28094, 29379, 30664, 31950, 33235, 34521, 35806, 37091, 38377, 39662, 40947, 42233, 43518, 44803, 46089, 47374, 48659, 49945, 51230, 52516, 53801, 55086, 56372, 57657, 58942, 60228, 61513, 62798, 64084, 65369, 66654, 67940, 69225, 70511, 71796, 73081, 74367, 75652, 76937, 78223, 79508, 80793, 82079, 83364, 84650, 85935, 87220, 88506]]
    CD = 25
    TP成长 = 0.10
    TP上限 = 5
    是否有护石 = 1
...
class 技能13(职业主动技能):
    ...
    # 基础 = 19198.4
    # 成长 = 2167.6
    data0 = [(i*1.0/1.126*1.134) for i in [0, 21366, 23533, 25701, 27868, 30036, 32204, 34371, 36539, 38706, 40874, 43042, 45209, 47377, 49544, 51712, 53879, 56047, 58215, 60382, 62550, 64717, 66885, 69053, 71220, 73388, 75555, 77723, 79891, 82058, 84226, 86393, 88561, 90728, 92896, 95064, 97231, 99399, 101566, 103734, 105902, 108069, 110237, 112404, 114572, 116739, 118907, 121075, 123242, 125410, 127577, 129745, 131913, 134080, 136248, 138415, 140583, 142750, 144918, 147086, 149253]]
    CD = 45
    TP成长 = 0.10
    TP上限 = 5
    是否有护石 = 1
...
class 技能14(职业主动技能):
    ...
    # 基础 = 46241.6
    # 成长 = 13959.2
    data0 = [(i*1.0/1.126*1.134) for i in [0, 60199, 74158, 88118, 102077, 116036, 129996, 143955, 157914, 171874, 185833, 199792, 213752, 227711, 241670, 255630, 269589, 283548, 297508, 311467, 325426, 339386, 353345, 367304, 381264, 395223, 409182, 423142, 437101, 451060, 465020, 478979, 492938, 506898, 520857, 534817, 548776, 562735, 576695, 590654, 604613]]
    CD = 145.0
...
class 技能15(职业主动技能):
    ...
    # 基础 = 14912.3
    # 成长 = 1683.7
    data0 = [(i*1.0/1.126*1.134) for i in [0, 16596, 18280, 19964, 21647, 23331, 25015, 26698, 28382, 30066, 31750, 33433, 35117, 36801, 38484, 40168, 41852, 43536, 45219, 46903, 48587, 50270, 51954, 53638, 55322, 57005, 58689, 60373, 62056, 63740, 65424, 67108, 68791, 70475, 72159, 73842, 75526, 77210, 78894, 80577, 82261]]
    CD = 25
    TP成长 = 0.10
    TP上限 = 5
    是否有护石 = 1
...
class 技能16(职业主动技能):
    ...
    # 基础 = 29092.3
    # 成长 = 3284.7
    data0 = [(i*1.0/1.126*1.134) for i in [0, 32377, 35662, 38947, 42231, 45516, 48801, 52086, 55370, 58655, 61940, 65224, 68509, 71794, 75078, 78363, 81648, 84933, 88217, 91502, 94787, 98071, 101356, 104641, 107925, 111210, 114495, 117780, 121064, 124349, 127634, 130918, 134203, 137488, 140772, 144057, 147342, 150627, 153911, 157196, 160481]]
    CD = 50
    TP成长 = 0.10
    TP上限 = 5
    是否有护石 = 1
...
class 技能17(职业主动技能):
    ...
    # 基础 = 46139.6
    # 成长 = 5209.4
    data0 = [(i*1.0) for i in [0, 51349, 56559, 61768, 66978, 72187, 77396, 82606, 87815, 93025, 98234, 103443, 108653, 113862, 119072, 124281, 129490, 134700, 139909, 145119, 150328, 155537, 160747, 165956, 171166, 176375, 181584, 186794, 192003, 197213, 202422, 207632, 212841, 218050, 223260, 228469, 233679, 238888, 244097, 249307, 254516]]
    CD = 40
    是否有护石 = 1
...
class 技能18(职业主动技能):
    ...
    # 基础 = 50250.4
    # 成长 = 5673.6
    data0 = [(i*1.0/1.126*1.132) for i in [0, 5084, 5600, 6116, 6631, 7147, 7663, 8179, 8695, 9210, 9726, 10242, 10758, 11274, 11790, 12305, 12821, 13337, 13853, 14369, 14884, 15400, 15916, 16432, 16948, 17463, 17979, 18495, 19011, 19527, 20043, 20558, 21074, 21590, 22106, 22622, 23137, 23653, 24169, 24685, 25201]]
    攻击次数 = 11
    CD = 45
    是否有护石 = 1
    蓄力 = 0
