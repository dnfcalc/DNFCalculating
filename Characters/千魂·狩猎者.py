...
class 技能6(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 46
    data0 = [(i*1.129) for i in [0, 2066, 2275, 2485, 2694, 2904, 3114, 3323, 3533, 3742, 3952, 4162, 4371, 4581, 4791, 5000, 5210, 5419, 5629, 5839, 6048, 6258, 6467, 6677, 6887, 7096, 7306, 7515, 7725, 7935, 8144, 8354, 8563, 8773, 8983, 9192, 9402, 9612, 9821, 10031, 10240, 10450, 10660, 10869, 11079, 11288, 11498, 11708, 11917, 12127, 12336, 12546, 12756, 12965, 13175, 13384, 13594, 13804, 14013, 14223, 14433, 14642, 14852, 15061, 15271, 15481, 15690, 15900, 16109, 16319, 16529]]
    攻击次数 = 1
    # 基础 = 1856.40
    # 成长 = 209.60
    CD = 5.0
...
class 技能7(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 43
    data0 = [(i*1.13) for i in [0, 514, 566, 618, 671, 723, 775, 827, 879, 931, 984, 1036, 1088, 1140, 1192, 1245, 1297, 1349, 1401, 1453, 1506, 1558, 1610, 1662, 1714, 1767, 1819, 1871, 1923, 1975, 2027, 2080, 2132, 2184, 2236, 2288, 2341, 2393, 2445, 2497, 2549, 2602, 2654, 2706, 2758, 2810, 2863, 2915, 2967, 3019, 3071, 3123, 3176, 3228, 3280, 3332, 3384, 3437, 3489, 3541, 3593]]
    攻击次数 = 5
    # 基础 = 2309.05
    # 成长 = 260.95
    CD = 6.0
...
class 技能9(职业主动技能):
    ...
    基础等级 = 41
    #地面发射攻击力：<data0>%
    data0 = [(i*1.0355) for i in [0, 3635, 4003, 4372, 4741, 5110, 5478, 5847, 6216, 6585, 6953, 7322, 7691, 8060, 8429, 8797, 9166, 9535, 9904, 10272, 10641, 11010, 11379, 11747, 12116, 12485, 12854, 13223, 13591, 13960, 14329, 14698, 15066, 15435, 15804, 16173, 16541, 16910, 17279, 17648, 18017, 18385, 18754, 19123, 19492, 19860, 20229, 20598, 20967, 21335, 21704, 22073, 22442, 22811, 23179, 23548, 23917, 24286, 24654, 25023, 25392, 25761, 26129, 26498, 26867, 27236, 27605, 27973, 28342, 28711, 29080]]
    #空中发射攻击力：<data1>%
...
class 技能15(职业主动技能):
    ...
    # 成长 = 1855.48
    #魔法枪攻击力：<data0>%
    data0 = [0,403,444,485,525,567,607,648,689,730,771,812,853,894,935,976,1017,1058,1099,1140,1181,1222,1263,1304,1345,1386,1427,1468,1509,1550,1591,1632,1673,1714,1755,1796,1837,1878,1919,1960,2001,2042,2083,2124,2165,2206,2247,2288,2329,2370,2411,2452,2493,2534,2575,2616,2657,2698,2739,2780,2821]
    攻击次数 = 20
    #终结攻击力：<data1>%
    data1 = [0,12103,13331,14558,15787,17014,18242,19470,20698,21926,23154,24382,25610,26838,28066,29294,30522,31750,32978,34206,35434,36662,37890,39118,40346,41574,42802,44030,45258,46486,47714,48942,50170,51398,52626,53854,55082,56310,57538,58766,59994,61222,62450,63678,64906,66134,67362,68590,69818,71046,72274,73502,74730,75958,77186,78414,79642,80870,82098,83326,84554]
    攻击次数2 = 1
    CD = 45.0
    TP成长 = 0.10
    TP上限 = 5
...
class 技能23(职业主动技能):
    ...
    data0 = [0, 3743, 4123, 4503, 4883, 5263, 5642, 6023, 6403, 6783, 7163, 7543, 7923, 8303, 8683, 9063, 9443]
    攻击次数 = 10

    data1 = [0, 56145, 61841, 67537, 73233, 78929, 84624, 90321, 96017, 101713, 107409, 113105, 118801, 124497, 130193, 135889, 141585]
    攻击次数2 = 1
...
class 技能24(职业主动技能):
    ...
    data0 = [0,23568,29034,34500,39966,45432,50898,56364,61830,67296,72762,78228,83694,89160,94626,100092,105558,111024,116490]
    攻击次数 = 3
    data1 = [0,282821,348403,413985,479567,545149,610731,676313,741895,807477,873059,938641,1004223,1069805,1135387,1200969,1266551,1332133,1397715]
    攻击次数2 = 1
