...
class 技能12(主动技能):
    ...
    等级上限 = 60
    基础等级 = 31
    data0 = [int(i*1.108) for i in [0, 1786, 1967, 2149, 2330, 2512, 2692, 2874, 3055, 3237, 3418, 3599, 3780, 3962, 4143, 4323, 4505, 4687, 4868, 5050, 5230, 5411, 5593, 5774, 5956, 6136, 6318, 6499, 6681, 6862, 7043, 7224, 7406, 7587, 7769, 7949, 8131,
...
class 技能22(主动技能):
    ...
    等级上限 = 40
    基础等级 = 6
    data0 = [int(i*1.209) for i in [0, 38764, 42693, 46623, 50553, 54483, 58413, 62343, 66273, 70203, 74133, 78063, 81993, 85923, 89853, 93783, 97713, 101643, 105573, 109502, 113432, 117362, 121292, 125222, 129152, 133082, 137012, 140942, 144872, 148802, 152732, 156662, 160592, 164522, 168452, 172382,
    ...
    data1 = [int(i*1.209) for i in [0, 90448, 99618, 108788, 117958, 127128, 136298, 145467, 154637, 163807, 172977, 182147, 191317, 200487, 209656, 218826, 227996, 237166, 246336, 255506, 264676, 273846, 283015, 292185, 301355, 310525, 319695, 328865, 338035, 347204, 356374, 365544, 374714, 383884, 393054, 402224,
