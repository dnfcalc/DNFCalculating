...
class 技能22(职业主动技能):
    ...
    CD = 60.0
    # 毛雷
    数据 = [int(i*1.75)for i in [0, 7148, 7873, 8598, 9323, 10048, 10773, 11498, 12223, 12948,
                               13673, 14398, 15123, 15848, 16573, 17298, 18023, 18748, 19473, 20198, 20923, 21648]]
    攻击次数 = 6
    # # 电雷
    ...
    # 攻击次数3 = 20*3
    # 终结
    数据2 = [0, 32166, 35429, 38693, 41956, 45219, 48482, 51745, 55008, 58271,
           61534, 64797, 68060, 71323, 74586, 77849, 81112, 84375, 87638, 90901, 94164]
    攻击次数2 = 1
...
class 技能23(职业主动技能):
    ...
    脱手 = 0
    技能施放时间 = 6.8
    数据 = [0, 17492, 21548, 25604, 29660, 33716, 37772, 41828, 45884, 49940,
          53996, 58052, 62108, 66164, 70220, 74276, 78332, 82388, 86444, 90500]
    攻击次数 = 7
    数据2 = [0, 57141, 70391, 83641, 96891, 110141, 123391, 136641, 149891, 163141,
           176391, 189641, 202891, 216141, 229391, 242641, 255891, 269141, 282391, 295641]
    攻击次数2 = 5
