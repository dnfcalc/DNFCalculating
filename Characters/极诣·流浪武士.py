...
class 技能21(主动技能):
    ...
    基础等级 = 2
    CD = 290.0
    data0 = [0, 384840, 474079, 563317, 652556, 741794, 831033, 920271, 1009510, 1098748, 1187987, 1277225, 1366464, 1455702, 1544941, 1634179, 1723418, 1812656, 1901895, 1991133, 2080372,
