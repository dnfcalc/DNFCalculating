...
class 真·混沌魔灵角色属性(角色属性):
    ...
    def 被动倍率计算(self):
        ...
        self.技能栏[self.技能序号['大结局']].攻击次数3 = (self.大结局战士黑炎个数 + 1)*3
    ...
    def 技能总伤害计算(self, a, b):
        ...
        if self.第二次魔灵炸弹引爆的战士 != 0:
            temp0 = self.技能栏[15].等效百分比2(self.武器类型) * self.伤害指数 * self.技能栏[15].被动倍率
            temp1 = a[15]%2
            temp2 = int(a[15]/2)
            if temp1 != 0:
...
class 真·混沌魔灵(角色窗口):
    ...
    def 界面(self):
        ...
        self.大结局战士黑炎个数选择=MyQComboBox(self.main_frame2)
        self.大结局战士黑炎个数选择.addItem('大结局战士黑炎 - 击中1个')
        self.大结局战士黑炎个数选择.addItem('大结局战士黑炎 - 击中2个')
        self.大结局战士黑炎个数选择.addItem('大结局战士黑炎 - 击中3个')
        self.大结局战士黑炎个数选择.addItem('大结局战士黑炎 - 击中4个')
        self.大结局战士黑炎个数选择.addItem('大结局战士黑炎 - 击中5个')
        self.大结局战士黑炎个数选择.setCurrentIndex(2)
        self.大结局战士黑炎个数选择.resize(166,20)
        self.大结局战士黑炎个数选择.move(322,450)
    
    def 载入配置(self, path='set'):
        super().载入配置(path)
        try:
           setfile = open('./ResourceFiles/' + self.角色属性A.实际名称 + '/' + path + '/skill5.ini', 'r',encoding='utf-8').readlines()
           self.第二次魔灵炸弹引爆的战士选择.setCurrentIndex(int(setfile[0].replace('\n', '')));
           self.黑暗冲击战士冲击波个数选择.setCurrentIndex(int(setfile[1].replace('\n', '')));
           self.大结局战士黑炎个数选择.setCurrentIndex(int(setfile[2].replace('\n', '')));
        except:
            pass
    ...
    def 保存配置(self, path='set'):
        ...
        try:
            ...
            setfile.write(str(self.大结局战士黑炎个数选择.currentIndex())+'\n')
        except:
            pass
    ...
    def 输入属性(self, 属性, x = 0):
        ...
        属性.大结局战士黑炎个数 = self.大结局战士黑炎个数选择.currentIndex()