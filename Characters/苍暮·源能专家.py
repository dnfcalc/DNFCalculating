...
class 技能5(职业主动技能):
    ...
    攻击段数 = 2
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.204) for i in [0, 859, 946, 1033, 1120, 1208, 1295, 1382, 1469, 1556, 1644, 1730, 1818, 1906, 1992, 2080, 2166, 2254, 2341, 2428, 2516, 2602, 2690, 2777, 2864, 2951, 3039, 3126, 3213, 3300, 3387, 3475, 3561, 3649, 3736,
    ...
    # 能量多段攻击力：<data1>%
    data1 = [int(i*1.204) for i in [0, 146, 161, 176, 191, 205, 221, 236, 251, 265, 280, 295, 310, 326, 340, 355, 370, 385, 399, 414, 429, 444, 460, 474, 489, 504, 519, 533, 548, 563, 579, 594, 608, 623, 638, 653,
...
class 技能6(职业主动技能):
    ...
    # 成长 = 193.16
    # 波动攻击力：<data0>%
    data0 = [int(i*1.13*1.198) for i in [0, 284, 314, 342, 371, 400, 429, 457, 487, 516, 544, 573, 602, 632, 660, 689, 718, 746, 775, 805, 834, 862, 891, 920, 950, 978, 1007, 1036, 1064, 1093, 1123,
    ...
    # 源能波攻击力：<data1>%
    data1 = [int(i*1.13*1.198) for i in [0, 403, 444, 486, 527, 568, 609, 650, 691, 732, 773, 814, 855, 897, 938, 979, 1020, 1060, 1101, 1142, 1183, 1224, 1265, 1306, 1348, 1389, 1430, 1471, 1512, 1553,
...
class 技能7(职业主动技能):
    ...
    基础等级 = 46
    # 攻击段数 = 2
    data0 = [int(i*1.203) for i in [0, 2996, 3299, 3907, 4210, 4515, 4819, 5122, 5426, 5731, 6035, 6338, 6642, 6946, 7250, 7554, 7858, 8161, 8466, 8770, 9073, 9377, 9681, 9986, 10289, 10593, 10897, 11200, 11505, 11809, 12112, 12416, 12721, 13025, 13328, 13632,
...
class 技能8(职业主动技能):
    ...
    # 基础 = 3116.00 - 316.33
    # 成长 = 316.33
    data0 = [int(i*1.163) for i in [0, 636, 700, 765, 830, 894, 959, 1024, 1088, 1153, 1217, 1281, 1346, 1411, 1476, 1540, 1605, 1670, 1733, 1798, 1863, 1927, 1992, 2057, 2121, 2186, 2251, 2315, 2379, 2444, 2509,
    ...
    攻击次数 = 2
    data1 = [int(i*1.163) for i in [0, 1844, 2031, 2219, 2405, 2593, 2780, 2966, 3154, 3341, 3528, 3715, 3903, 4089, 4277, 4464, 4650, 4838, 5025, 5212, 5399, 5587, 5773, 5961, 6148, 6335, 6522, 6709, 6896, 7083, 7271,
...
class 技能9(职业主动技能):
    ...
    # 成长 = 318.48
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.073*1.199) for i in [0, 1726, 1901, 2076, 2252, 2427, 2602, 2777, 2952, 3127, 3302, 3477, 3653, 3829, 4004, 4179, 4354, 4529, 4704, 4879, 5054, 5229, 5404, 5580, 5755, 5930, 6105, 6280, 6456,
    ...
    # 吸附攻击力：<data1>%
    data1 = [int(i*1.073*1.199) for i in [0, 1412, 1555, 1698, 1842, 1986, 2129, 2272, 2415, 2559, 2702, 2845, 2989, 3132, 3275, 3419, 3562, 3705, 3848, 3992, 4135, 4279, 4422, 4565, 4708, 4851, 4996, 5139,
...
class 技能10(职业主动技能):
    ...
    基础等级 = 41
    # 攻击段数 = 1 * 1.102
    data0 = [int(i*1.102*1.226) for i in [0, 3254, 3584, 3915, 4245, 4575, 4905, 5236, 5565, 5896, 6226, 6557, 6886, 7217, 7547, 7877, 8207, 8538, 8868, 9198, 9528, 9859, 10188, 10519, 10849, 11180, 11509, 11840, 12170, 12500,
...
class 技能11(职业主动技能):
    ...
    # 成长 = 413.84
    # 多段攻击力：<data0>%
    data0 = [int(i*1.101*1.225) for i in [0, 1020, 1123, 1227, 1330, 1434, 1537, 1640, 1744, 1847, 1951, 2054, 2158, 2261, 2364, 2469, 2572, 2676, 2779, 2882, 2986, 3089, 3193, 3296, 3399, 3503, 3606, 3710,
...
class 技能12(职业主动技能):
    ...
    基础等级 = 36
    攻击段数 = 3
    data0 = [int(i*1.22) for i in [0, 934, 1029, 1125, 1220, 1314, 1409, 1504, 1599, 1693, 1788, 1883, 1978, 2073, 2168, 2263, 2358, 2452, 2547, 2642, 2737, 2831, 2926, 3022, 3117, 3212, 3306, 3401, 3496, 3591,
    ...
    攻击次数 = 5
    data1 = [int(i*1.22) for i in [0, 2003, 2206, 2410, 2613, 2816, 3020, 3223, 3426, 3630, 3833, 4037, 4239, 4442, 4646, 4849, 5052, 5256, 5459, 5662, 5866, 6069, 6272, 6476, 6679, 6882, 7085, 7288, 7492, 7695, 7898, 8102,
...
class 技能13(职业主动技能):
    ...
    # 多段攻击力：<data0>%
    data0 = [int(i*1.101*1.175) for i in [0, 593, 652, 713, 773, 833, 893, 954, 1013, 1074, 1134, 1194, 1255, 1314, 1375, 1435, 1495, 1555, 1616, 1675, 1736, 1795, 1856, 1916, 1976, 2036, 2097, 2157, 2217,
    ...
    攻击次数 = 8
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.101*1.175) for i in [0, 1673, 1843, 2012, 2181, 2351, 2521, 2691, 2861, 3030, 3200, 3370, 3540, 3710, 3879, 4049, 4219, 4389, 4559, 4728, 4898, 5068, 5238, 5406, 5576, 5746, 5916, 6086, 6255,
...
class 技能14(职业主动技能):
    ...
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.125*1.198) for i in [0, 5612, 6181, 6750, 7320, 7889, 8459, 9028, 9597, 10167, 10735, 11305, 11875, 12443, 13013, 13583, 14152, 14721, 15291, 15860, 16429, 16999, 17568, 18138, 18707, 19276, 19846, 20415, 20984,
    ...
    # 能量多段攻击力：<data1>%
    data1 = [int(i*1.125*1.198) for i in [0, 747, 823, 899, 975, 1051, 1127, 1204, 1280, 1354, 1430, 1507, 1583, 1659, 1735, 1811, 1887, 1963, 2038, 2114, 2190, 2266, 2342, 2418, 2494, 2570, 2646, 2721, 2797,
...
class 技能15(职业主动技能):
    ...
    # 下劈攻击力：<data0>%
    data0 = [int(i*1.121*1.232) for i in [0, 6247, 6880, 7514, 8148, 8782, 9415, 10050, 10683, 11317, 11951, 12585, 13218, 13852, 14486, 15119, 15754, 16387, 17021, 17655, 18289, 18922, 19557, 20190, 20824, 21458, 22091, 22725, 23359,
    ...
    # 上挑攻击力：<data1>%
    data1 = [int(i*1.121*1.232) for i in [0, 9512, 10477, 11442, 12406, 13371, 14337, 15302, 16267, 17232, 18197, 19162, 20127, 21092, 22056, 23022, 23987, 24952, 25917, 26882, 27847, 28812, 29777, 30742, 31706, 32672, 33637, 34602, 35567,
...
class 技能16(职业主动技能):
    ...
    基础等级 = 12
    # 能量多段攻击力：<data0>%
    data0 = [int(i*1.128*1.198) for i in [0, 567, 698, 829, 960, 1092, 1224, 1355, 1487, 1617, 1749, 1881, 2012, 2144, 2276, 2406, 2538, 2669, 2801,
                                    2933, 3064, 3195, 3326, 3458, 3590, 3721, 3853, 3983, 4115, 4247, 4378, 4510, 4642, 4773, 4904, 5035, 5167, 5299, 5430, 5562, 5692]]
    # 秒C的段数
    攻击次数 = 14
    # 能量爆炸攻击力：<data1>%
    data1 = [int(i*1.128*1.198) for i in [0, 28858, 35550, 42241, 48933, 55625, 62317, 69010, 75702, 90632, 97994, 105355, 112716, 120077, 127438, 134799, 142160, 149521, 156883, 164244,
...
class 技能17(职业主动技能):
    ...
    #多段攻击力：<data0>%
    data0 = [int(i*1.126*1.204) for i in [0, 792, 872, 954, 1034, 1114, 1195, 1275, 1355, 1436, 1516, 1597, 1677, 1757, 1838, 1918, 1998, 2079, 2159, 2240, 2320, 2400, 2481, 2561, 2641, 2722, 2802, 2883, 2963, 3043, 3124, 3205, 3286, 3366, 3446, 3527, 3607, 3687, 3768, 3848, 3929, 4009, 4089, 4170, 4250, 4331, 4411, 4491, 4572, 4652, 4732, 4813, 4893, 4974, 5054, 5134, 5215, 5295, 5375, 5457, 5537]]
    攻击次数 = 10
    data1 = [int(i*1.126*1.204) for i in [0, 3397, 3741, 4086, 4431, 4775, 5120, 5465, 5809, 6154, 6499, 6843, 7188, 7532, 7877, 8222, 8566, 8911, 9256, 9600, 9945, 10289, 10634, 10979, 11323, 11668, 12013, 12357, 12702, 13047, 13391, 13736, 14080, 14425, 14770, 15114, 15459, 15804, 16148, 16493, 16838, 17182, 17527, 17871, 18216, 18561, 18905, 19250, 19595, 19939, 20285, 20630, 20974, 21319, 21664, 22008, 22353, 22697, 23042, 23387, 23731]]
    攻击次数2 = 1
    ###
...
class 技能18(主动技能):
    ...
    成长 = 168.5
    #能量释放多段攻击力：<data0>%
    # data0 = [0, 1658, 1827, 1995, 2163, 2332, 2500, 2669, 2837, 3005, 3173, 3341, 3510, 3678, 3846, 4015, 4183, 4352, 4520, 4688, 4856, 5024, 5192, 5361, 5529, 5698, 5866, 6034, 6203, 6371, 6539, 6707, 6875, 7044, 7212, 7381, 7549, 7717, 7886, 8054, 8222, 8390, 8558, 8727, 8895, 9064, 9232, 9400, 9569, 9737, 9906, 10073, 10241, 10410, 10578, 10747, 10915, 11083, 11252, 11420, 11589]
...
class 技能19(职业主动技能):
    ...
    # 乱舞攻击力：<data0>% X 8次
    data0 = [int(i*1.121*1.199) for i in [0, 3403, 3748, 4094, 4439, 4784, 5129, 5475, 5821, 6166, 6512, 6857, 7202, 7547, 7893, 8238, 8583, 8928, 9274, 9619, 9964, 10309, 10655, 11000, 11345, 11691, 12037, 12382, 12727, 13072,
    ...
    攻击次数 = 8
    # 最后一击攻击力：<data1>%
    data1 = [int(i*1.121*1.199) for i in [0, 11670, 12853, 14038, 15221, 16406, 17589, 18774, 19957, 21142, 22325, 23509, 24693, 25877, 27061, 28245, 29429, 30613, 31797, 32981, 34165, 35349, 36532, 37717, 38900, 40085, 41268, 42452, 43636,
...
class 技能20(职业主动技能):
    ...
    # 最大蓄气时的爆炸攻击力：
    data0 = [int(i*1.074*1.198) for i in [0, 44464, 48975, 53486, 57998, 62508, 67019, 71530, 76041, 80552, 85063, 89574, 94084, 98595, 103106, 107617, 112128, 116639, 121150, 125660, 130171, 134683, 139194, 143705, 148216, 152727, 157238, 161748, 166259, 170770,
...
class 技能21(职业主动技能):
    ...
    # 多段攻击力：<data0>%
    # 秒C6段，打满14次
    data0 = [int(i*1.1*1.227) for i in [0, 934, 1149, 1366, 1583, 1800, 2015, 2232, 2449, 2666, 2882, 3098, 3315, 3531, 3748, 3965, 4182, 4397, 4614, 4831, 5048, 5263, 5480, 5697, 5913, 6130, 6346, 6563, 6779, 6996,
    ...
    攻击次数 = 6
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.1*1.227) for i in [0, 87485, 107772, 128059, 148345, 168632, 188919, 209205, 229492, 249779, 270064, 290351, 310638, 330924, 351211, 371498, 391784, 412071, 432358, 452644, 472931, 493218, 513504, 533790, 554077, 574363, 594650, 614937, 635223, 655510,
