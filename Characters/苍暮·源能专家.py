...
class 技能8(职业主动技能):
    ...
    基础等级 = 43
    攻击段数 = 2
    data0 = [int(i*1.0) for i in [0, 739, 814, 889, 965, 1039, 1115, 1190, 1265, 1340, 1415, 1489, 1565, 1640, 1716, 1791, 1866, 1942, 2015, 2091, 2166, 2241, 2316, 2392, 2466, 2542, 2617, 2692, 2766, 2842, 2917, 2992, 3067, 3143, 3218, 3292, 3368, 3442, 3518, 3593, 3669, 3743, 3819, 3894, 3968, 4043, 4119, 4193, 4269, 4344, 4419, 4494, 4569, 4645, 4719, 4795, 4870, 4945, 5020, 5096, 5169]]
    攻击次数 = 2
    data1 = [int(i*1.0) for i in [0, 2144, 2362, 2580, 2797, 3015, 3233, 3449, 3668, 3885, 4103, 4320, 4539, 4755, 4974, 5191, 5407, 5626, 5844, 6061, 6279, 6497, 6713, 6932, 7150, 7367, 7585, 7802, 8020, 8237, 8456, 8672, 8891, 9108, 9327, 9543, 9761, 9979, 10196, 10414, 10632, 10849, 11067, 11285, 11502, 11720, 11938, 12154, 12373, 12590, 12808, 13025, 13244, 13460, 13679, 13896, 14113, 14331, 14549, 14766, 14984]]
    攻击次数2 = 1
    CD = 10
    TP成长 = 0.10
    TP上限 = 5
...
class 技能10(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 41
    data0 = [int(i*1.0) for i in [0, 4395, 4841, 5288, 5734, 6180, 6626, 7074, 7517, 7965, 8411, 8857, 9302, 9750, 10195, 10641, 11087, 11534, 11980, 12426, 12871, 13319, 13764, 14210, 14656, 15104, 15548, 15995, 16441, 16888, 17333, 17780, 18226, 18671, 19118, 19565, 20010, 20457, 20903, 21349, 21794, 22242, 22687, 23134, 23579, 24025, 24472, 24918, 25363, 25810, 26257, 26703, 27148, 27596, 28041, 28487, 28933, 29381, 29824, 30272, 30718]]
    CD = 7.5
    TP成长 = 0.10
    TP上限 = 5
...
class 技能11(职业主动技能):
    ...
    等级上限 = 60
    基础等级 = 38
    data0 = [int(i*1.0) for i in [0, 1375, 1514, 1653, 1793, 1933, 2072, 2211, 2352, 2490, 2631, 2769, 2909, 3049, 3187, 3329, 3467, 3608, 3747, 3886, 4026, 4165, 4305, 4444, 4583, 4723, 4863, 5002, 5142, 5283, 5423, 5561, 5702, 5840, 5980, 6120, 6258, 6399, 6537, 6678, 6817, 6955, 7096, 7234, 7376, 7515, 7656, 7794, 7934, 8073, 8213, 8353, 8491, 8631, 8771, 8910, 9050, 9189, 9329, 9470, 9608]]
    攻击次数 = 4
    CD = 10
    TP成长 = 0.10
    TP上限 = 5
...
class 技能12(职业主动技能):
    ...
    基础等级 = 36
    攻击段数 = 3
    data0 = [int(i*1.0) for i in [0, 1139, 1255, 1372, 1488, 1603, 1718, 1834, 1950, 2065, 2181, 2297, 2413, 2529, 2644, 2760, 2876, 2991, 3107, 3223, 3339, 3453, 3569, 3686, 3802, 3918, 4033, 4149, 4265, 4381, 4495, 4611, 4727, 4844, 4959, 5075, 5191, 5307, 5421, 5537, 5653, 5769, 5886, 6001, 6117, 6232, 6348, 6463, 6579, 6695, 6811, 6925, 7043, 7158, 7274, 7389, 7505, 7621, 7737, 7851, 7967]]
    攻击次数 = 5
    data1 = [int(i*1.0) for i in [0, 2443, 2691, 2940, 3187, 3435, 3684, 3932, 4179, 4428, 4676, 4925, 5171, 5419, 5668, 5915, 6163, 6412, 6659, 6907, 7156, 7404, 7651, 7900, 8148, 8396, 8643, 8891, 9140, 9387, 9635, 9884, 10132, 10379, 10628, 10876, 11123, 11372, 11619, 11868, 12115, 12363, 12612, 12860, 13107, 13356, 13604, 13851, 14100, 14348, 14596, 14843, 15091, 15340, 15587, 15835, 16084, 16332, 16579, 16828, 17076]]
    攻击次数2 = 1
    CD = 20
    TP成长 = 0.10
    TP上限 = 5
...
class 技能13(职业主动技能):
    ...
    # 多段攻击力：<data0>%
    data0 = [int(i*1.0) for i in [0,766, 842, 922, 999, 1077, 1155, 1233, 1310, 1388, 1466, 1543, 1622, 1699, 1777, 1855, 1932, 2011, 2090, 2166, 2245, 2321, 2400, 2478, 2555, 2633, 2711, 2789, 2867, 2946, 3023, 3102, 3178, 3257, 3334, 3412, 3489, 3568, 3644, 3723, 3799, 3878, 3958, 4034, 4113, 4191, 4268, 4346, 4425, 4501, 4580, 4656, 4735, 4812, 4890, 4967, 5047, 5125, 5202, 5280, 5358]]
    攻击次数 = 8
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.0) for i in [0, 2163, 2384, 2602, 2821, 3040, 3260, 3480, 3700, 3919, 4139, 4359, 4578, 4798, 5017, 5236, 5457, 5677, 5897, 6115, 6335, 6555, 6776, 6993, 7213, 7433, 7652, 7872, 8091, 8310, 8531, 8751, 8971, 9189, 9409, 9629, 9850, 10069, 10288, 10508, 10727, 10947, 11167, 11384, 11605, 11825, 12044, 12263, 12483, 12702, 12922, 13143, 13362, 13581, 13801, 14021, 14241, 14459, 14680, 14900, 15119]]
    攻击次数2 = 1
...
class 技能16(职业主动技能):
    ...
    基础等级 = 12
    # 能量多段攻击力：<data0>%
    data0 = [int(i*1.0) for i in [0, 765, 942, 1120, 1296, 1474, 1653, 1830, 2009, 2183, 2362, 2540, 2718, 2896, 3075, 3250, 3428, 3605, 3784, 3962, 4140, 4316, 4493, 4672, 4850, 5028, 5206, 5381, 5559, 5738, 5915, 6094, 6272, 6448, 6626, 6803, 6981, 7160, 7337, 7515, 7691]]
    # 秒C的段数
    攻击次数 = 14
    # 能量爆炸攻击力：<data1>%
    data1 = [int(i*1.0) for i in [0, 38996, 48039, 57081, 66124, 75168, 84211, 93255, 102298, 122473, 132423, 142370, 152317, 162264, 172212, 182159, 192106, 202053, 212002, 221949, 231896, 241842, 251789, 261736, 271684, 281631, 291578, 301525, 311475, 321422, 331369, 341316, 351263, 361211, 371158, 381105, 391053, 401001, 410948, 420895, 430842]]
    攻击次数2 = 1
    CD = 145
...
class 技能17(职业主动技能):
    ...
    #多段攻击力：<data0>%
    data0 = [int(i*1.0) for i in [0, 1072, 1181, 1293, 1401, 1509, 1619, 1727, 1836, 1945, 2055, 2164, 2273, 2381, 2491, 2599, 2707, 2817, 2926, 3036, 3144, 3253, 3362, 3471, 3579, 3689, 3798, 3908, 4016, 4124, 4234, 4344, 4454, 4563, 4671, 4781, 4889, 4997, 5107, 5215, 5326, 5434, 5543, 5652, 5761, 5870, 5979, 6087, 6198, 6306, 6414, 6524, 6632, 6742, 6850, 6959, 7069, 7178, 7286, 7397, 7505]]
    攻击次数 = 10
    data1 = [int(i*1.0) for i in [0, 4605, 5071, 5538, 6006, 6472, 6941, 7408, 7874, 8342, 8809, 9276, 9743, 10211, 10678, 11145, 11612, 12079, 12548, 13014, 13482, 13948, 14415, 14883, 15349, 15818, 16285, 16751, 17219, 17686, 18153, 18621, 19088, 19555, 20023, 20489, 20956, 21425, 21891, 22359, 22826, 23292, 23760, 24226, 24695, 25162, 25629, 26096, 26563, 27031, 27499, 27967, 28433, 28902, 29369, 29836, 30303, 30769, 31237, 31704, 32172]]
    攻击次数2 = 1
    ###
...
class 技能23(职业主动技能):
    ...
    等级上限 = 40
    基础等级 = 2
    data0 = [0, 369810, 455564, 541317, 627071, 712824, 798578, 884331, 970084, 1055838, 1141590, 1227345, 1313097, 1398851, 1484604, 1570358, 1656111, 1741864, 1827618, 1913372, 1999125, 2084878, 2170632, 2256385, 2342139, 2427891, 2513645, 2599398, 2685152, 2770905, 2856658, 2942412, 3028165, 3113919, 3199672, 3285426, 3371179, 3456933, 3542686, 3628440, 3714192, 3799946, 3885699, 3971452, 4057206, 4142959, 4228713, 4314466, 4400219, 4485973, 4571726, 4657480, 4743234, 4828987, 4914739, 5000493, 5086247, 5172000, 5257753, 5343507, 5429260]
    攻击次数 = 1
    CD = 290
    关联技能 = ['无']
