...
class 神启·驱魔师技能6(被动技能):
    ...
    空斩打剑气 = [0, 100, 104, 110, 114, 120, 124, 130, 134, 140, 144, 150, 154, 160, 164, 170, 174, 180, 184, 190, 194, 200, 204, 210, 214, 220, 224, 230, 234, 240, 244, 250, 254, 260, 264,
...
class 神启·驱魔师技能11(主动技能):
    ...
    等级上限 = 60
    基础等级 = 41
    数据1 = [0, 263, 290, 316, 343, 370, 397, 423, 450, 477, 504, 531, 557, 584, 611, 638, 664, 691, 718, 745, 771, 798, 825, 852, 878, 905, 932, 959, 985, 1012, 1039, 1066, 1092,
           1119, 1146, 1174, 1200, 1225, 1252, 1278, 1305, 1332, 1359, 1387, 1413, 1440, 1467, 1494, 1520, 1547, 1574, 1601, 1627, 1654, 1681, 1708, 1734, 1761, 1788, 1815, 1841]
    攻击次数1 = 10
    倍率 = 1.14  # 三觉
    CD = 6.5
    TP成长 = 0.10
...
class 神启·驱魔师技能14(被动技能):
    ...
    关联技能 = ['真龙焚天', '式神封灵阵', '逆龙七杀', '逆鳞震', '灭魂符', '苍龙逐日', '式神：殇', '疾空旋风破', '落雷符',
            '狂乱锤击', '疾风打', '朱雀符', '黑暗切割', '升天阵', '落凤锤', '破魔符', '式神合击：灭', '五行返虚：开天辟地']
