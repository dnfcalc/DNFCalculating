...
class 技能11(职业主动技能):
    ...
    攻击次数 = 6
    data1 = [int(i*1.251)for i in [0, 8, 5571, 6084, 6598, 7111, 7624, 8137, 8650, 9164, 9677, 10190, 10703, 11216, 11729, 12243, 12756, 13269, 13782, 14295, 14809, 15322, 15835, 16348, 16861, 17374, 17888, 18401, 18914, 19427,
