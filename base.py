...
class 角色窗口(QWidget):
    ...
    def 界面(self):
        ...
        self.觉醒选择.setPixmap(QPixmap(self.角色属性A.职业名称 + "/技能/觉醒选择.png"))
        self.觉醒选择.resize(120,100)
        self.觉醒选择.move(x,y-20)
        
        self.BUFF=QLabel(self.main_frame2)
        self.BUFF.setPixmap(QPixmap(self.角色属性A.职业名称 + "/技能/BUFF.png"))
    ...
    def 载入配置(self):
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/attr.ini', 'r', encoding='utf-8').readlines()
            for i in range(0, 17):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ.ini', 'r', encoding='utf-8').readlines()
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ1.ini', 'r', encoding='utf-8').readlines()
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ2.ini', 'r', encoding='utf-8').readlines()
            for i in range(0,len(self.装备条件选择)):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ3.ini', 'r', encoding='utf-8').readlines()
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/skill1.ini', 'r', encoding='utf-8').readlines()
            num = 0
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/skill2.ini', 'r', encoding='utf-8').readlines()
            num = 0
            for i in self.角色属性A.技能栏:
                序号 = self.角色属性A.技能序号[i.名称]
    ...
    def 保存配置(self):
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/attr.ini', 'w', encoding='utf-8')
            for i in range(0, 17):
                for j in range(0, len(self.属性设置输入[i])):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ.ini', 'w', encoding='utf-8')
            for i in range(0, len(装备列表)):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ1.ini', 'w', encoding='utf-8')
            for i in range(0,len(self.装备打造选项)):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ2.ini', 'w', encoding='utf-8')
            for i in range(0,len(self.装备条件选择)):
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/equ3.ini', 'w', encoding='utf-8')
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/skill1.ini', 'w', encoding='utf-8')
        ...
        try:
            setfile = open(self.角色属性A.职业名称 + '/set/skill2.ini', 'w', encoding='utf-8')
            for i in self.角色属性A.技能栏:
                序号 = self.角色属性A.技能序号[i.名称]
