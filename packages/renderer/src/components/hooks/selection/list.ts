...
import { computed, provide, ref, SetupContext, ComponentPropsOptions, Ref, PropType } from "vue"
import { AciveClassSymbol, AciveSymbol, InitSymbol, ItemClassSymbol, ModelValueSymbol, Option, UnactiveSymbol } from "./constants"

const valuePropType = [String, Number, Object, Boolean, null] as PropType<BaseType>
